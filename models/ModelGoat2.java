// Date: 20/03/2020 12:23:02
// Template version 1.1
// Java generated by Techne
// Keep in mind that you still need to fill in some blanks
// - ZeuX

public static class ModelGoat2 extends ModelBase {
	// fields
	ModelRenderer body1;
	...
	public ModelGoat2() {
		...
		left_ear.setRotationPoint(1F, 10F, -10F);
		...
		right_ear.addBox(0F, 0F, 0F, 1, 3, 1);
		right_ear.setRotationPoint(-1F, 10F, -9F);
		right_ear.setTextureSize(64, 64);
		right_ear.mirror = true;
		setRotation(right_ear, -0.0366519F, 3.141593F, -0.445059F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.goaty.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.goaty.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.right_horn.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.right_horn.rotateAngleX = f4 / (180F / (float) Math.PI);
		...
		this.neck2.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.neck1.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.neck1.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.left_ear.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.left_ear.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.head.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.head.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.br_leg.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * f1;
		this.left_horn.rotateAngleY = f3 / (180F / (float) Math.PI);
		this.left_horn.rotateAngleX = f4 / (180F / (float) Math.PI);
		this.fl_leg.rotateAngleX = MathHelper.cos(f * 0.6662F) * f1;
