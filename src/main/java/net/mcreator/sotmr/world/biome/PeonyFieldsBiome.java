...
public class PeonyFieldsBiome extends SotmModElements.ModElement {
	public static Biome biome;
	public PeonyFieldsBiome(SotmModElements instance) {
		super(instance, 1795);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("sotm:peony_fields"));
			}
		}
	}
	@Override
