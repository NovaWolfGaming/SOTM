...
import net.mcreator.sotmr.block.VoidbrambleFruitBlock;
import net.mcreator.sotmr.block.FieryShnylliumBlock;
import net.mcreator.sotmr.block.BloodElderLeavesBlock;
import net.mcreator.sotmr.block.BloodElderBlock;
import net.mcreator.sotmr.block.BauxiteBlock;
...
public class BloodElderForestBiome extends SotmModElements.ModElement {
	public static Biome biome;
	public BloodElderForestBiome(SotmModElements instance) {
		super(instance, 1009);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3394816).setWaterColor(-3407872).setWaterFogColor(-3407872)
						.withSkyColor(-3394816).withFoliageColor(-65536).withGrassColor(-65536)
						.setParticle(new ParticleEffectAmbience(OrangeGlowingOrbParticle.particle, 0.003f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BloodElderBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(BloodElderLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("sotm:blood_elder_forest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("blood_elder_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("blood_elder_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("blood_elder_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = VoidbrambleFruitBlock.block.getDefaultState();
