		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(LoneGrassBlockItem.block.getDefaultState(),
								LoneDirtItem.block.getDefaultState(), LoneDirtItem.block.getDefaultState())));
								...
								Feature.DISK
										.withConfiguration(
												new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
														ImmutableList.of(LoneGrassBlockItem.block.getDefaultState(),
																LoneDirtItem.block.getDefaultState())))
