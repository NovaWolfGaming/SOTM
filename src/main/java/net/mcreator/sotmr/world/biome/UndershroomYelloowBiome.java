...
import net.mcreator.sotmr.block.YellowMushroomShellBlock;
...
public class UndershroomYelloowBiome extends SotmModElements.ModElement {
	public static Biome biome;
	public UndershroomYelloowBiome(SotmModElements instance) {
		super(instance, 1034);
			...
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.MUSHROOM_STEM.getDefaultState()),
								new SimpleBlockStateProvider(YellowMushroomShellBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("sotm:undershroom_yellow"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("undershroom_yellow_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("undershroom_yellow_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("undershroom_yellow_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
