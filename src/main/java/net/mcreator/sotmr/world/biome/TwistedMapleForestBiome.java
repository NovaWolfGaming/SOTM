...
import net.mcreator.sotmr.block.TwistedMapleWoodBlock;
import net.mcreator.sotmr.block.TwistedMapleLeavesBlock;
...
public class TwistedMapleForestBiome extends SotmModElements.ModElement {
	public static Biome biome;
	public TwistedMapleForestBiome(SotmModElements instance) {
		super(instance, 1069);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-65383).setWaterColor(-65536).setWaterFogColor(-65536)
						.withSkyColor(-65383).withFoliageColor(-16751053).withGrassColor(-16751053).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TwistedMapleWoodBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(TwistedMapleLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("sotm:twisted_maple_forest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("twisted_maple_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("twisted_maple_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("twisted_maple_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
