...
import net.mcreator.sotmr.block.AshBlock;
...
public class BoundlandBiome extends SotmModElements.ModElement {
	public static Biome biome;
	public BoundlandBiome(SotmModElements instance) {
		super(instance, 2133);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-39424).setWaterColor(-16777165).setWaterFogColor(-16777165)
						.withSkyColor(-39424).withFoliageColor(-16777216).withGrassColor(-16777216)
						.setMoodSound(
						...
						.setParticle(new ParticleEffectAmbience(AshDustParticle.particle, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(AshBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("sotm:boundland"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("boundland_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("boundland_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("boundland_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
