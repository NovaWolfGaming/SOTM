...
public class LavenderFieldsBiome extends SotmModElements.ModElement {
	public static Biome biome;
	public LavenderFieldsBiome(SotmModElements instance) {
		super(instance, 1794);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-16751104).withGrassColor(-16751104).build();
				...
				event.getRegistry().register(biome.setRegistryName("sotm:lavender_fields"));
			}
		}
	}
	@Override
