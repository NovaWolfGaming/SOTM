...
@OnlyIn(Dist.CLIENT)
public class LeatherWorkTableGUIGuiWindow extends ContainerScreen<LeatherWorkTableGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public LeatherWorkTableGUIGuiWindow(LeatherWorkTableGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
