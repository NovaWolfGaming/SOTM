...
public class LeatherWorkTableGUIGui extends SotmModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public LeatherWorkTableGUIGui(SotmModElements instance) {
		super(instance, 2121);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("leather_work_table_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("sotm:textures/leather_work_table_gui.png");
		@Override
