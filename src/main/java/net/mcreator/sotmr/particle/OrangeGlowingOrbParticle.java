...
public class OrangeGlowingOrbParticle extends SotmModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public OrangeGlowingOrbParticle(SotmModElements instance) {
		super(instance, 1342);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("orange_glowing_orb"));
	}
