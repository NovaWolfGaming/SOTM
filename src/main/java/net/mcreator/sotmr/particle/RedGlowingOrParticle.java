...
public class RedGlowingOrParticle extends SotmModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public RedGlowingOrParticle(SotmModElements instance) {
		super(instance, 1341);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("red_glowing_or"));
	}
