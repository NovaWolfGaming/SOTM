...
public class SugaredPopcornItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sugared_popcorn")
	public static final Item block = null;
	public SugaredPopcornItem(SotmModElements instance) {
		super(instance, 1586);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("sugared_popcorn");
		}
