...
public class BillonShovelItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:billon_shovel")
	public static final Item block = null;
	public BillonShovelItem(SotmModElements instance) {
		super(instance, 1969);
	}
