...
public class SodeobacoItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sodeobaco")
	public static final Item block = null;
	public SodeobacoItem(SotmModElements instance) {
		super(instance, 613);
	}
