...
public class CactusPadCookedItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cactus_pad_cooked")
	public static final Item block = null;
	public CactusPadCookedItem(SotmModElements instance) {
		super(instance, 1407);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("cactus_pad_cooked");
		}
