...
public class DragonstoneArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragonstone_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:dragonstone_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:dragonstone_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:dragonstone_armor_boots")
	public static final Item boots = null;
	public DragonstoneArmorItem(SotmModElements instance) {
		super(instance, 641);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/dragonstone_armour_redone_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
