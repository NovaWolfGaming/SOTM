...
public class ShoarmaItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:shoarma")
	public static final Item block = null;
	public ShoarmaItem(SotmModElements instance) {
		super(instance, 1399);
	}
