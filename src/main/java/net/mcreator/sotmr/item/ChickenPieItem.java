...
public class ChickenPieItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chicken_pie")
	public static final Item block = null;
	public ChickenPieItem(SotmModElements instance) {
		super(instance, 1837);
	}
