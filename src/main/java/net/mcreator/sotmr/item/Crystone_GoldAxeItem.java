...
public class Crystone_GoldAxeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystone_gold_axe")
	public static final Item block = null;
	public Crystone_GoldAxeItem(SotmModElements instance) {
		super(instance, 2068);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("crystone_gold_axe"));
	}
}
