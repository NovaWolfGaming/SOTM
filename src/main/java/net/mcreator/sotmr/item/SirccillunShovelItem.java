...
public class SirccillunShovelItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sirccillun_shovel")
	public static final Item block = null;
	public SirccillunShovelItem(SotmModElements instance) {
		super(instance, 1720);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("sirccillun_shovel"));
	}
}
