...
public class RubyArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rubyarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:rubyarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:rubyarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:rubyarmor_boots")
	public static final Item boots = null;
	public RubyArmorItem(SotmModElements instance) {
		super(instance, 400);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/ruby__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
