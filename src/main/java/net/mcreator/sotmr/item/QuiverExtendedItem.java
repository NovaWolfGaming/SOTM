...
import net.mcreator.sotmr.gui.QuiverGUI2GuiWindow;
import net.mcreator.sotmr.gui.QuiverGUI2Gui;
...
public class QuiverExtendedItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:quiver_extended")
	public static final Item block = null;
	public QuiverExtendedItem(SotmModElements instance) {
		super(instance, 1991);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof QuiverGUI2GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ToolsAndWeaponsItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("quiver_extended");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Traveller's Quiver");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new QuiverGUI2Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
