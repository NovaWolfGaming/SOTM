...
public class CookedPufferfishItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cookedpufferfish")
	public static final Item block = null;
	public CookedPufferfishItem(SotmModElements instance) {
		super(instance, 595);
	}
