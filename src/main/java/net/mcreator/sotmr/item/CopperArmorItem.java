...
public class CopperArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:copperarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:copperarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:copperarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:copperarmor_boots")
	public static final Item boots = null;
	public CopperArmorItem(SotmModElements instance) {
		super(instance, 393);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/copper_armour_new_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
