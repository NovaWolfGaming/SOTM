...
public class ScrapMetalArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:scrap_metal_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:scrap_metal_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:scrap_metal_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:scrap_metal_armor_boots")
	public static final Item boots = null;
	public ScrapMetalArmorItem(SotmModElements instance) {
		super(instance, 2099);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/nether_scrap__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("scrap_metal_armor_helmet"));
		...
		}.setRegistryName("scrap_metal_armor_chestplate"));
		...
		}.setRegistryName("scrap_metal_armor_leggings"));
		...
		}.setRegistryName("scrap_metal_armor_boots"));
	}
}
