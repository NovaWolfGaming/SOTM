...
public class PineapplePieItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pineapple_pie")
	public static final Item block = null;
	public PineapplePieItem(SotmModElements instance) {
		super(instance, 1908);
	}
