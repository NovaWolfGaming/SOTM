...
public class MossyQuiverItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_quiver")
	public static final Item block = null;
	public MossyQuiverItem(SotmModElements instance) {
		super(instance, 1889);
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mossy Quiver");
					}
