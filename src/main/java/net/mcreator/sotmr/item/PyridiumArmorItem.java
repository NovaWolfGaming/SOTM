...
public class PyridiumArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pyridium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:pyridium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:pyridium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:pyridium_armor_boots")
	public static final Item boots = null;
	public PyridiumArmorItem(SotmModElements instance) {
		super(instance, 639);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/pyridium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("pyridium_armor_helmet"));
		...
		}.setRegistryName("pyridium_armor_chestplate"));
		...
		}.setRegistryName("pyridium_armor_leggings"));
		...
		}.setRegistryName("pyridium_armor_boots"));
	}
}
