...
public class VenomiteOreArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venomite_ore_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:venomite_ore_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:venomite_ore_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:venomite_ore_armor_boots")
	public static final Item boots = null;
	public VenomiteOreArmorItem(SotmModElements instance) {
		super(instance, 450);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/venomite_armour_redone_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("venomite_ore_armor_helmet"));
		...
		}.setRegistryName("venomite_ore_armor_chestplate"));
		...
		}.setRegistryName("venomite_ore_armor_leggings"));
		...
		}.setRegistryName("venomite_ore_armor_boots"));
	}
}
