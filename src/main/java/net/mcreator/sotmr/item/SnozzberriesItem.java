...
public class SnozzberriesItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:snozzberries")
	public static final Item block = null;
	public SnozzberriesItem(SotmModElements instance) {
		super(instance, 601);
	}
