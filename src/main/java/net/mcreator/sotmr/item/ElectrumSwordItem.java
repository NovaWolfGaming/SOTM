...
public class ElectrumSwordItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:electrum_sword")
	public static final Item block = null;
	public ElectrumSwordItem(SotmModElements instance) {
		super(instance, 1946);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("electrum_sword"));
	}
}
