...
public class RaspberriesItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:raspberries")
	public static final Item block = null;
	public RaspberriesItem(SotmModElements instance) {
		super(instance, 600);
	}
