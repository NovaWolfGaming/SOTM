...
public class SirccillunAxeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sirccillun_axe")
	public static final Item block = null;
	public SirccillunAxeItem(SotmModElements instance) {
		super(instance, 1718);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("sirccillun_axe"));
	}
}
