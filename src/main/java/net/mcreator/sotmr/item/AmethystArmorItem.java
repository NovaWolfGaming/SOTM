...
public class AmethystArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amethyst_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:amethyst_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:amethyst_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:amethyst_armor_boots")
	public static final Item boots = null;
	public AmethystArmorItem(SotmModElements instance) {
		super(instance, 465);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{5, 20, 15, 7}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/amethyst__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
