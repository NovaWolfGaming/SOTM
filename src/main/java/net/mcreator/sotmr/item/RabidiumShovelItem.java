...
public class RabidiumShovelItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rabidiumshovel")
	public static final Item block = null;
	public RabidiumShovelItem(SotmModElements instance) {
		super(instance, 421);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("rabidiumshovel"));
	}
}
