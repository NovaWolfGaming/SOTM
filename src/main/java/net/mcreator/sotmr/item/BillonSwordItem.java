...
public class BillonSwordItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:billon_sword")
	public static final Item block = null;
	public BillonSwordItem(SotmModElements instance) {
		super(instance, 1968);
	}
