...
public class SapphirePickaxeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sapphire_pickaxe")
	public static final Item block = null;
	public SapphirePickaxeItem(SotmModElements instance) {
		super(instance, 1546);
	}
