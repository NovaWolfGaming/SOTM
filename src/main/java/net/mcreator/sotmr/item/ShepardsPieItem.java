...
public class ShepardsPieItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:shepards_pie")
	public static final Item block = null;
	public ShepardsPieItem(SotmModElements instance) {
		super(instance, 1615);
	}
