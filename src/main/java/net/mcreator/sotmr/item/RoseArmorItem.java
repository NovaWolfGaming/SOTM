...
public class RoseArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:rose_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:rose_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:rose_armor_boots")
	public static final Item boots = null;
	public RoseArmorItem(SotmModElements instance) {
		super(instance, 1924);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/rose_gold__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("rose_armor_helmet"));
		...
		}.setRegistryName("rose_armor_chestplate"));
		...
		}.setRegistryName("rose_armor_leggings"));
		...
		}.setRegistryName("rose_armor_boots"));
	}
}
