...
public class Nether_SteelArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nether_steel_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:nether_steel_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:nether_steel_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:nether_steel_armor_boots")
	public static final Item boots = null;
	public Nether_SteelArmorItem(SotmModElements instance) {
		super(instance, 449);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/crystone_iron__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("nether_steel_armor_helmet"));
		...
		}.setRegistryName("nether_steel_armor_chestplate"));
		...
		}.setRegistryName("nether_steel_armor_leggings"));
		...
		}.setRegistryName("nether_steel_armor_boots"));
	}
}
