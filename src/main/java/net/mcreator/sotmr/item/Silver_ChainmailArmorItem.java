...
public class Silver_ChainmailArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:silver_chainmail_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:silver_chainmail_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:silver_chainmail_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:silver_chainmail_armor_boots")
	public static final Item boots = null;
	public Silver_ChainmailArmorItem(SotmModElements instance) {
		super(instance, 448);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/silver_chainmail_new_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("silver_chainmail_armor_helmet"));
		...
		}.setRegistryName("silver_chainmail_armor_chestplate"));
		...
		}.setRegistryName("silver_chainmail_armor_leggings"));
		...
		}.setRegistryName("silver_chainmail_armor_boots"));
	}
}
