...
public class AmberSickleItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:ambersickle")
	public static final Item block = null;
	public AmberSickleItem(SotmModElements instance) {
		super(instance, 408);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ambersickle"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ToolsAndWeaponsItemGroup.tab).maxDamage(2380));
		}
