...
public class ElectrumPickaxeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:electrum_pickaxe")
	public static final Item block = null;
	public ElectrumPickaxeItem(SotmModElements instance) {
		super(instance, 1944);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("electrum_pickaxe"));
	}
}
