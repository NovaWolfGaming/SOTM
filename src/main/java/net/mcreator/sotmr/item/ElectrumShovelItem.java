...
public class ElectrumShovelItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:electrum_shovel")
	public static final Item block = null;
	public ElectrumShovelItem(SotmModElements instance) {
		super(instance, 1947);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("electrum_shovel"));
	}
}
