...
public class ActiniumSwordItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:actiniumsword")
	public static final Item block = null;
	public ActiniumSwordItem(SotmModElements instance) {
		super(instance, 427);
	}
