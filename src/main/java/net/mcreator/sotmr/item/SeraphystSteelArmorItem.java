...
public class SeraphystSteelArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:seraphyst_steel_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:seraphyst_steel_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:seraphyst_steel_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:seraphyst_steel_armor_boots")
	public static final Item boots = null;
	public SeraphystSteelArmorItem(SotmModElements instance) {
		super(instance, 2151);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/seraphyst_steel_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("seraphyst_steel_armor_helmet"));
		...
		}.setRegistryName("seraphyst_steel_armor_chestplate"));
		...
		}.setRegistryName("seraphyst_steel_armor_leggings"));
		...
		}.setRegistryName("seraphyst_steel_armor_boots"));
	}
}
