...
public class ElectrumAxeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:electrum_axe")
	public static final Item block = null;
	public ElectrumAxeItem(SotmModElements instance) {
		super(instance, 1945);
	}
