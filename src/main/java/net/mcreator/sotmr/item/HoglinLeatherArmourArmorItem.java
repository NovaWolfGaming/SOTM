...
public class HoglinLeatherArmourArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:hoglin_leather_armour_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:hoglin_leather_armour_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:hoglin_leather_armour_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:hoglin_leather_armour_armor_boots")
	public static final Item boots = null;
	public HoglinLeatherArmourArmorItem(SotmModElements instance) {
		super(instance, 2116);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(HoglinLeatherItem.block, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "hoglin_leather_armour_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/hoglin_leather__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("hoglin_leather_armour_armor_helmet"));
		...
		}.setRegistryName("hoglin_leather_armour_armor_chestplate"));
		...
		}.setRegistryName("hoglin_leather_armour_armor_leggings"));
		...
		}.setRegistryName("hoglin_leather_armour_armor_boots"));
	}
}
