...
public class SunberryItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sunberry")
	public static final Item block = null;
	public SunberryItem(SotmModElements instance) {
		super(instance, 599);
	}
