...
public class EurolaBerryItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:eurola_berry")
	public static final Item block = null;
	public EurolaBerryItem(SotmModElements instance) {
		super(instance, 612);
	}
