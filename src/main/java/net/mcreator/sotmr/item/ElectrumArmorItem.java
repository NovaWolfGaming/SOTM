...
public class ElectrumArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:electrum_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:electrum_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:electrum_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:electrum_armor_boots")
	public static final Item boots = null;
	public ElectrumArmorItem(SotmModElements instance) {
		super(instance, 1954);
	}
