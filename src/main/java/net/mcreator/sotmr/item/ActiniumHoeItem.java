...
public class ActiniumHoeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:actiniumhoe")
	public static final Item block = null;
	public ActiniumHoeItem(SotmModElements instance) {
		super(instance, 429);
	}
