...
public class RabidiumAxeItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rabidiumaxe")
	public static final Item block = null;
	public RabidiumAxeItem(SotmModElements instance) {
		super(instance, 419);
	}
