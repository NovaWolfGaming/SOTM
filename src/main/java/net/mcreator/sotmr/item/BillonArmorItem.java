...
public class BillonArmorItem extends SotmModElements.ModElement {
	@ObjectHolder("sotm:billon_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sotm:billon_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sotm:billon_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sotm:billon_armor_boots")
	public static final Item boots = null;
	public BillonArmorItem(SotmModElements instance) {
		super(instance, 1976);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ToolsAndWeaponsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sotm:textures/models/armor/billon__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("billon_armor_helmet"));
		...
		}.setRegistryName("billon_armor_chestplate"));
		...
		}.setRegistryName("billon_armor_leggings"));
		...
		}.setRegistryName("billon_armor_boots"));
	}
}
