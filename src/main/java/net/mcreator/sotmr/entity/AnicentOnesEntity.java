...
import net.mcreator.sotmr.item.AncientSwordItem;
import net.mcreator.sotmr.entity.renderer.AnicentOnesRenderer;
...
public class AnicentOnesEntity extends SotmModElements.ModElement {
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(AncientSwordItem.block, (int) (1)));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, CorruptedOnesEntity.CustomEntity.class, false, false));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("sotm:ancient_ones_hurt"));
		}
