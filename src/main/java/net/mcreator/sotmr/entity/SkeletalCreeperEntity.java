...
import net.mcreator.sotmr.procedures.SkeletalCreeperPlayerCollidesWithThisEntityProcedure;
import net.mcreator.sotmr.itemgroup.SOTMMobsItemGroup;
import net.mcreator.sotmr.entity.renderer.SkeletalCreeperRenderer;
...
public class SkeletalCreeperEntity extends SotmModElements.ModElement {
	...
	public static class CustomEntity extends CreeperEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, ScorpionEntity.CustomEntity.class, false, false));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				SkeletalCreeperPlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
