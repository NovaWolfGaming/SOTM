...
import net.mcreator.sotmr.item.RawFleshItem;
import net.mcreator.sotmr.item.RapierItem;
import net.mcreator.sotmr.entity.renderer.NetherSettlerRenderer;
...
public class NetherSettlerEntity extends SotmModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 12, 1, 4));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(RapierItem.block, (int) (1)));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RawFleshItem.block, (int) (1)));
		}
