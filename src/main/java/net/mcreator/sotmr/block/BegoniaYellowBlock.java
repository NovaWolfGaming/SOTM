...
public class BegoniaYellowBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia_yellow")
	public static final Block block = null;
	public BegoniaYellowBlock(SotmModElements instance) {
		super(instance, 1853);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia_yellow"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia_yellow"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("begonia_yellow");
		}
