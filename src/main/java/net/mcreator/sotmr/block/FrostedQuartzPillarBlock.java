...
public class FrostedQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_quartz_pillar")
	public static final Block block = null;
	public FrostedQuartzPillarBlock(SotmModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_quartz_pillar");
		}
