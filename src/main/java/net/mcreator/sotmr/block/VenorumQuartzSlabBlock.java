...
public class VenorumQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_quartz_slab")
	public static final Block block = null;
	public VenorumQuartzSlabBlock(SotmModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("venorum_quartz_slab");
		}
