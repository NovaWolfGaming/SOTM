...
public class BlackberryBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackberry")
	public static final Block block = null;
	public BlackberryBlock(SotmModElements instance) {
		super(instance, 1435);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blackberry"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blackberry"), configuredFeature);
		}
	}
	@SubscribeEvent
