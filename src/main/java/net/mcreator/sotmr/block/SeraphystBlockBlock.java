...
public class SeraphystBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:seraphyst_block")
	public static final Block block = null;
	public SeraphystBlockBlock(SotmModElements instance) {
		super(instance, 154);
	}
