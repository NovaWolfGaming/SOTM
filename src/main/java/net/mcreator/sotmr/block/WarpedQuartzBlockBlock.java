...
public class WarpedQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warped_quartz_block")
	public static final Block block = null;
	public WarpedQuartzBlockBlock(SotmModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("warped_quartz_block");
		}
