...
public class BasaltBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basaltbrick")
	public static final Block block = null;
	public BasaltBrickBlock(SotmModElements instance) {
		super(instance, 492);
	}
