...
public class CherryWoodFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_wood_fence")
	public static final Block block = null;
	public CherryWoodFenceBlock(SotmModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("cherry_wood_fence");
		}
