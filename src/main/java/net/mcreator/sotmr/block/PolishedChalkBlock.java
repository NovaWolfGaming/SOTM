...
public class PolishedChalkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polished_chalk")
	public static final Block block = null;
	public PolishedChalkBlock(SotmModElements instance) {
		super(instance, 591);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_chalk");
		}
