...
public class ForestGreenMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble_brick")
	public static final Block block = null;
	public ForestGreenMarbleBrickBlock(SotmModElements instance) {
		super(instance, 2560);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble_brick");
		}
