...
public class MarbleLightBlueSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue_smooth")
	public static final Block block = null;
	public MarbleLightBlueSmoothBlock(SotmModElements instance) {
		super(instance, 2433);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue_smooth");
		}
