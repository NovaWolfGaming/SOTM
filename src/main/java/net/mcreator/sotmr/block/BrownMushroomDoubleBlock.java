...
public class BrownMushroomDoubleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:brown_mushroom_double")
	public static final Block block = null;
	public BrownMushroomDoubleBlock(SotmModElements instance) {
		super(instance, 1791);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("brown_mushroom_double"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:brown_mushroom_double"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.BAMBOO).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("brown_mushroom_double");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blocks.BROWN_MUSHROOM, (int) (3)));
		}
