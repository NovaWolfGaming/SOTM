...
public class MarblePinkyRedSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red_smooth")
	public static final Block block = null;
	public MarblePinkyRedSmoothBlock(SotmModElements instance) {
		super(instance, 2419);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red_smooth");
		}
