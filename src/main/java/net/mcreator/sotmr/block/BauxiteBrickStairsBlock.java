...
public class BauxiteBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bauxite_brick_stairs")
	public static final Block block = null;
	public BauxiteBrickStairsBlock(SotmModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bauxite_brick_stairs");
		}
