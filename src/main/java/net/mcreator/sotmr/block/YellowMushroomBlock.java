...
import net.mcreator.sotmr.item.MushroomyellowitemItem;
...
public class YellowMushroomBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom")
	public static final Block block = null;
	public YellowMushroomBlock(SotmModElements instance) {
		super(instance, 271);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yellow_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:yellow_mushroom"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MushroomyellowitemItem.block, (int) (1)));
		}
