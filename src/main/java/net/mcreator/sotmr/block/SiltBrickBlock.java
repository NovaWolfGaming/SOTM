...
public class SiltBrickBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:silt_brick")
	public static final Block block = null;

	public SiltBrickBlock(SotmModElements instance) {
		super(instance, 2358);
