...
public class RoseQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_quartz_stairs")
	public static final Block block = null;
	public RoseQuartzStairsBlock(SotmModElements instance) {
		super(instance, 251);
	}
