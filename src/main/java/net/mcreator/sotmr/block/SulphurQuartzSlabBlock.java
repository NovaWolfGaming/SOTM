...
public class SulphurQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphur_quartz_slab")
	public static final Block block = null;
	public SulphurQuartzSlabBlock(SotmModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sulphur_quartz_slab");
		}
