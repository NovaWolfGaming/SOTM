...
public class MonochromeWoodFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:monochrome_wood_fence")
	public static final Block block = null;
	public MonochromeWoodFenceBlock(SotmModElements instance) {
		super(instance, 2204);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("monochrome_wood_fence");
		}
