...
public class ChippedCrimsonPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_crimson_planks")
	public static final Block block = null;

	public ChippedCrimsonPlanksBlock(SotmModElements instance) {
		super(instance, 2615);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_crimson_planks");
		}
