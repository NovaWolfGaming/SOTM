...
public class LimestoneSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:limestone_smooth")
	public static final Block block = null;
	public LimestoneSmoothBlock(SotmModElements instance) {
		super(instance, 508);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("limestone_smooth");
		}
