...
public class BrownSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:brown_smooth_crolphin")
	public static final Block block = null;
	public BrownSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2289);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brown_smooth_crolphin");
		}
