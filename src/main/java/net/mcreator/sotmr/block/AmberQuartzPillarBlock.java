...
public class AmberQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amber_quartz_pillar")
	public static final Block block = null;
	public AmberQuartzPillarBlock(SotmModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amber_quartz_pillar");
		}
