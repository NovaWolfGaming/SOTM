...
public class DarkQuartzstoneBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dark_quartzstone_brick")
	public static final Block block = null;
	public DarkQuartzstoneBrickBlock(SotmModElements instance) {
		super(instance, 503);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_quartzstone_brick");
		}
