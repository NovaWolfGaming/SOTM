...
public class CrystalinePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystalinepillar")
	public static final Block block = null;
	public CrystalinePillarBlock(SotmModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystalinepillar");
		}
