...
public class MarbleYellowPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow_polished")
	public static final Block block = null;
	public MarbleYellowPolishedBlock(SotmModElements instance) {
		super(instance, 2376);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_yellow_polished");
		}
