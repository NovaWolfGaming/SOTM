...
public class YellowMushroomStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_stairs")
	public static final Block block = null;
	public YellowMushroomStairsBlock(SotmModElements instance) {
		super(instance, 246);
	}
