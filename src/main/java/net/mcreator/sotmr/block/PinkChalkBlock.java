...
public class PinkChalkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_chalk")
	public static final Block block = null;
	public PinkChalkBlock(SotmModElements instance) {
		super(instance, 1813);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:pink_chalk_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("pink_chalk"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pink_chalk"), configuredFeature);
		}
	}
	@SubscribeEvent
