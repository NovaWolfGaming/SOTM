...
public class CharredRockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:charred_rock")
	public static final Block block = null;
	public CharredRockBlock(SotmModElements instance) {
		super(instance, 523);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:charred_rock_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("charred_rock"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:charred_rock"), configuredFeature);
		}
	}
	@SubscribeEvent
