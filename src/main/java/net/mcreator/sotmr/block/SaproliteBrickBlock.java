...
public class SaproliteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:saprolite_brick")
	public static final Block block = null;
	public SaproliteBrickBlock(SotmModElements instance) {
		super(instance, 1694);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("saprolite_brick");
		}
