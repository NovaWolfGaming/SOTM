...
public class BegoniaPurpleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia_purple")
	public static final Block block = null;
	public BegoniaPurpleBlock(SotmModElements instance) {
		super(instance, 1855);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia_purple"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia_purple"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("begonia_purple");
		}
