...
import net.mcreator.sotmr.procedures.TaraxacumDandelionPlantRightClickedProcedure;
...
public class TaraxacumDandelionBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:taraxacum_dandelion")
	public static final Block block = null;
	public TaraxacumDandelionBlock(SotmModElements instance) {
		super(instance, 326);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("taraxacum_dandelion"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:taraxacum_dandelion"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("taraxacum_dandelion");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				TaraxacumDandelionPlantRightClickedProcedure.executeProcedure($_dependencies);
			}
