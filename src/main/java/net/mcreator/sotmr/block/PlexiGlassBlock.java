...
public class PlexiGlassBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:plexi_glass")
	public static final Block block = null;
	public PlexiGlassBlock(SotmModElements instance) {
		super(instance, 1532);
	}
