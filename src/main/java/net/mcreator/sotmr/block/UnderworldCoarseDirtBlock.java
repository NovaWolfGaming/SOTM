...
public class UnderworldCoarseDirtBlock extends SotmModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(UnderworldDirtBlock.block.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 27)).range(255).square().func_242731_b(21));
	}
}
