...
public class BurningFuriteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:burningfuriteslab")
	public static final Block block = null;
	public BurningFuriteSlabBlock(SotmModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("burningfuriteslab");
		}
