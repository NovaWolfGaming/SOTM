...
public class CrimsonQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crimson_quartz_bricks")
	public static final Block block = null;
	public CrimsonQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2006);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crimson_quartz_bricks");
		}
