...
public class BegoniaGrayBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia_gray")
	public static final Block block = null;
	public BegoniaGrayBlock(SotmModElements instance) {
		super(instance, 1858);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia_gray"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia_gray"), configuredFeature);
		}
	}
	@SubscribeEvent
