...
public class AmethystOreBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amethyst_ore_block")
	public static final Block block = null;
	public AmethystOreBlockBlock(SotmModElements instance) {
		super(instance, 124);
	}
