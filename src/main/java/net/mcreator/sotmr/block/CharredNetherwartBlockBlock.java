...
public class CharredNetherwartBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:charred_netherwart_block")
	public static final Block block = null;
	public CharredNetherwartBlockBlock(SotmModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("charred_netherwart_block");
		}
