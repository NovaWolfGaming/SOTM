...
public class MarbleYellowSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow_slab")
	public static final Block block = null;
	public MarbleYellowSlabBlock(SotmModElements instance) {
		super(instance, 2381);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_yellow_slab");
		}
