...
public class WalnutWoodDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_door")
	public static final Block block = null;
	public WalnutWoodDoorBlock(SotmModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("walnut_wood_door");
		}
