...
public class MarbleGrayPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_gray_pillar")
	public static final Block block = null;
	public MarbleGrayPillarBlock(SotmModElements instance) {
		super(instance, 2449);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_gray_pillar");
		}
