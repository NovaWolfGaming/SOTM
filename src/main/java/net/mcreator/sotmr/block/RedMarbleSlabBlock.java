...
public class RedMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_marble_slab")
	public static final Block block = null;
	public RedMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1484);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("red_marble_slab");
		}
