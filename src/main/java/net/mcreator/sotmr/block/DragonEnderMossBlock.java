...
public class DragonEnderMossBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_ender_moss")
	public static final Block block = null;
	public DragonEnderMossBlock(SotmModElements instance) {
		super(instance, 153);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dragon_ender_moss");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:dragon_ender_moss_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dragon_ender_moss"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:dragon_ender_moss"), configuredFeature);
		}
	}
	@SubscribeEvent
