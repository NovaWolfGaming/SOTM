...
public class ForgetMeNotsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forget_me_nots")
	public static final Block block = null;
	public ForgetMeNotsBlock(SotmModElements instance) {
		super(instance, 319);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("forget_me_nots"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:forget_me_nots"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("forget_me_nots");
		}
