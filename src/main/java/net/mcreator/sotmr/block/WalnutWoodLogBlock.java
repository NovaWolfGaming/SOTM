...
public class WalnutWoodLogBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_log")
	public static final Block block = null;
	public WalnutWoodLogBlock(SotmModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("walnut_wood_log");
		}
