...
public class DarkQuartzstoneSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dark_quartzstone_smooth")
	public static final Block block = null;
	public DarkQuartzstoneSmoothBlock(SotmModElements instance) {
		super(instance, 468);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_quartzstone_smooth");
		}
