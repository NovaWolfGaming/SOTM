...
public class ChippedAshwoodPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_ashwood_planks")
	public static final Block block = null;
	public ChippedAshwoodPlanksBlock(SotmModElements instance) {
		super(instance, 2655);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_ashwood_planks");
		}
