...
public class AssidiumTrapdoorRecipeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:assidium_trapdoor_recipe")
	public static final Block block = null;
	public AssidiumTrapdoorRecipeBlock(SotmModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("assidium_trapdoor_recipe");
		}
