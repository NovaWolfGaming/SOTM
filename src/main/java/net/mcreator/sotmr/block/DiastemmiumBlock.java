...
public class DiastemmiumBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:diastemmium")
	public static final Block block = null;
	public DiastemmiumBlock(SotmModElements instance) {
		super(instance, 1800);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("diastemmium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:diastemmium"), configuredFeature);
		}
	}
	@SubscribeEvent
