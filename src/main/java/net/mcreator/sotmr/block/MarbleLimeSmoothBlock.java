...
public class MarbleLimeSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime_smooth")
	public static final Block block = null;
	public MarbleLimeSmoothBlock(SotmModElements instance) {
		super(instance, 2475);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_lime_smooth");
		}
