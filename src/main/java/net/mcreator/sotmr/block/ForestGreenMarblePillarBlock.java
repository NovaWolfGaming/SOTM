...
public class ForestGreenMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble_pillar")
	public static final Block block = null;
	public ForestGreenMarblePillarBlock(SotmModElements instance) {
		super(instance, 2561);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble_pillar");
		}
