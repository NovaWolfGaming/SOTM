...
public class BlueMistystSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst_slab")
	public static final Block block = null;
	public BlueMistystSlabBlock(SotmModElements instance) {
		super(instance, 531);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_mistyst_slab");
		}
