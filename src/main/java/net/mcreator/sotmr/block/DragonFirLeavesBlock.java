...
import net.mcreator.sotmr.procedures.DragonFirLeavesBlockDestroyedByPlayerProcedure;
...
public class DragonFirLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_leaves")
	public static final Block block = null;
	public DragonFirLeavesBlock(SotmModElements instance) {
		super(instance, 211);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_leaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				DragonFirLeavesBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
