...
public class PinkCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:pink_crolphin_bricks")
	public static final Block block = null;

	public PinkCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2301);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pink_crolphin_bricks");
		}
