...
public class RedMistystBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst")
	public static final Block block = null;
	public RedMistystBlock(SotmModElements instance) {
		super(instance, 2693);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:red_mistyst_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("red_mistyst"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:red_mistyst"), configuredFeature);
		}
	}
	@SubscribeEvent
