...
public class QuasichoraBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:quasichora")
	public static final Block block = null;
	public QuasichoraBlock(SotmModElements instance) {
		super(instance, 1830);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("quasichora"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:quasichora"), configuredFeature);
		}
	}
	@SubscribeEvent
