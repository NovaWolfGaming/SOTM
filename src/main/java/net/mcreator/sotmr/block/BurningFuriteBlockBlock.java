...
public class BurningFuriteBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:burningfuriteblock")
	public static final Block block = null;
	public BurningFuriteBlockBlock(SotmModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("burningfuriteblock");
		}
