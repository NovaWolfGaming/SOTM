...
public class FreesiaPinkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:freesia_pink")
	public static final Block block = null;
	public FreesiaPinkBlock(SotmModElements instance) {
		super(instance, 1778);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("freesia_pink"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:freesia_pink"), configuredFeature);
		}
	}
	@SubscribeEvent
