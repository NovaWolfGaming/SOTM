...
public class AmberOreBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amberoreblock")
	public static final Block block = null;
	public AmberOreBlockBlock(SotmModElements instance) {
		super(instance, 43);
	}
