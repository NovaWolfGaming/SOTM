...
public class MarbleLimeBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime_brick")
	public static final Block block = null;
	public MarbleLimeBrickBlock(SotmModElements instance) {
		super(instance, 2476);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_lime_brick");
		}
