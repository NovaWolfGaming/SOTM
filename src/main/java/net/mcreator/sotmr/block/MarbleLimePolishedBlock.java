...
public class MarbleLimePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime_polished")
	public static final Block block = null;
	public MarbleLimePolishedBlock(SotmModElements instance) {
		super(instance, 2474);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_lime_polished");
		}
