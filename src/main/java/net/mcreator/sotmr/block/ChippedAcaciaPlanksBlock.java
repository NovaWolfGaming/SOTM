...
public class ChippedAcaciaPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_acacia_planks")
	public static final Block block = null;
	public ChippedAcaciaPlanksBlock(SotmModElements instance) {
		super(instance, 2611);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_acacia_planks");
		}
