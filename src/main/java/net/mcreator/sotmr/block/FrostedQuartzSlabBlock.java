...
public class FrostedQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_quartz_slab")
	public static final Block block = null;
	public FrostedQuartzSlabBlock(SotmModElements instance) {
		super(instance, 256);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("frosted_quartz_slab");
		}
