...
public class ChorusStoneTilesNewBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone_tiles_new")
	public static final Block block = null;
	public ChorusStoneTilesNewBlock(SotmModElements instance) {
		super(instance, 1388);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chorus_stone_tiles_new");
		}
