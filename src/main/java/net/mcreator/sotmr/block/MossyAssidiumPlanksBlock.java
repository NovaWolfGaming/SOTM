...
public class MossyAssidiumPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_assidium_planks")
	public static final Block block = null;

	public MossyAssidiumPlanksBlock(SotmModElements instance) {
		super(instance, 2661);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mossy_assidium_planks");
		}
