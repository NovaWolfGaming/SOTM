...
public class DeepBlueSmoothMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_smooth_marble")
	public static final Block block = null;
	public DeepBlueSmoothMarbleBlock(SotmModElements instance) {
		super(instance, 2545);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_smooth_marble");
		}
