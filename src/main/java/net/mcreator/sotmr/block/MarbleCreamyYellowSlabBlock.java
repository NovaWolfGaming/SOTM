...
public class MarbleCreamyYellowSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow_slab")
	public static final Block block = null;
	public MarbleCreamyYellowSlabBlock(SotmModElements instance) {
		super(instance, 2507);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow_slab");
		}
