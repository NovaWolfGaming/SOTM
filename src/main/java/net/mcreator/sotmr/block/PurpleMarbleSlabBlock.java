...
public class PurpleMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_marble_slab")
	public static final Block block = null;
	public PurpleMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1486);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_marble_slab");
		}
