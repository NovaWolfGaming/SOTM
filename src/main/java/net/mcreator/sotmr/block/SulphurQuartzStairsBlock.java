...
public class SulphurQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphur_quartz_stairs")
	public static final Block block = null;
	public SulphurQuartzStairsBlock(SotmModElements instance) {
		super(instance, 253);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sulphur_quartz_stairs");
		}
