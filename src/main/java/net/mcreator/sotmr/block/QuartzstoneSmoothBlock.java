...
public class QuartzstoneSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:quartzstonesmooth")
	public static final Block block = null;
	public QuartzstoneSmoothBlock(SotmModElements instance) {
		super(instance, 500);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("quartzstonesmooth");
		}
