...
public class MarblePinkPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pink_pillar")
	public static final Block block = null;
	public MarblePinkPillarBlock(SotmModElements instance) {
		super(instance, 2365);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_pink_pillar");
		}
