...
public class EnderGrassBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:endergrass")
	public static final Block block = null;
	public EnderGrassBlock(SotmModElements instance) {
		super(instance, 64);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:endergrass_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("endergrass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:endergrass"), configuredFeature);
		}
	}
	@SubscribeEvent
