...
public class OrangeCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_crolphin")
	public static final Block block = null;
	public OrangeCrolphinBlock(SotmModElements instance) {
		super(instance, 2255);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_crolphin");
		}
