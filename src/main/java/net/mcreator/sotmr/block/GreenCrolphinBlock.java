...
public class GreenCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_crolphin")
	public static final Block block = null;
	public GreenCrolphinBlock(SotmModElements instance) {
		super(instance, 2251);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_crolphin");
		}
