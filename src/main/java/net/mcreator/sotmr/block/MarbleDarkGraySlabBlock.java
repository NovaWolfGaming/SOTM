...
public class MarbleDarkGraySlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dark_gray_slab")
	public static final Block block = null;
	public MarbleDarkGraySlabBlock(SotmModElements instance) {
		super(instance, 2493);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_dark_gray_slab");
		}
