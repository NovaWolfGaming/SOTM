...
public class BlackstoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstone")
	public static final Block block = null;
	public BlackstoneBlock(SotmModElements instance) {
		super(instance, 495);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:blackstone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("blackstone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blackstone"), configuredFeature);
		}
	}
	@SubscribeEvent
