...
public class CotswoldBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cotswold_bricks")
	public static final Block block = null;
	public CotswoldBricksBlock(SotmModElements instance) {
		super(instance, 1803);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cotswold_bricks");
		}
