...
public class EuAphreliaslabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:euaphreliaslab")
	public static final Block block = null;
	public EuAphreliaslabBlock(SotmModElements instance) {
		super(instance, 222);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("euaphreliaslab");
		}
