...
public class SulphuredCharredWeedsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphured_charred_weeds")
	public static final Block block = null;
	public SulphuredCharredWeedsBlock(SotmModElements instance) {
		super(instance, 260);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sulphured_charred_weeds"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sulphured_charred_weeds"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("sulphured_charred_weeds");
		}
