...
public class SulphurOre2Block extends SotmModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(CharredRockBlock.block.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 6)).range(64).square().func_242731_b(10));
	}
}
