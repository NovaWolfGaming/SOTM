...
import net.mcreator.sotmr.item.RaspberriesItem;
...
public class RaspberryBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:raspberrybush")
	public static final Block block = null;
	public RaspberryBushBlock(SotmModElements instance) {
		super(instance, 277);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("raspberrybush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:raspberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(RaspberriesItem.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RaspberriesItem.block, (int) (3)));
		}
