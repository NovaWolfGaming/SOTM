...
public class CarboriteBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carboritebrickslab")
	public static final Block block = null;
	public CarboriteBrickSlabBlock(SotmModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("carboritebrickslab");
		}
