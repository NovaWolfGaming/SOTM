...
public class YellowMushroomDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_door")
	public static final Block block = null;
	public YellowMushroomDoorBlock(SotmModElements instance) {
		super(instance, 250);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom_door");
		}
