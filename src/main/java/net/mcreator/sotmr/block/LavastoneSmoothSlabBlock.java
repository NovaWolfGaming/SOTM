...
public class LavastoneSmoothSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lavastone_smooth_slab")
	public static final Block block = null;
	public LavastoneSmoothSlabBlock(SotmModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lavastone_smooth_slab");
		}
