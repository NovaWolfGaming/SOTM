...
public class UnderworldSweetberryBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:underworldsweetberrybush")
	public static final Block block = null;
	public UnderworldSweetberryBushBlock(SotmModElements instance) {
		super(instance, 276);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("underworldsweetberrybush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:underworldsweetberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("underworldsweetberrybush");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(Items.SWEET_BERRIES, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.SWEET_BERRIES, (int) (3)));
		}
