...
public class DewYellowMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble_slab")
	public static final Block block = null;
	public DewYellowMarbleSlabBlock(SotmModElements instance) {
		super(instance, 2521);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble_slab");
		}
