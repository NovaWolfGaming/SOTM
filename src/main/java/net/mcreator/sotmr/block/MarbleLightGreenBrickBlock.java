...
public class MarbleLightGreenBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green_brick")
	public static final Block block = null;
	public MarbleLightGreenBrickBlock(SotmModElements instance) {
		super(instance, 2462);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_green_brick");
		}
