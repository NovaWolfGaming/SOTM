...
public class WalnutWoodPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_planks")
	public static final Block block = null;
	public WalnutWoodPlanksBlock(SotmModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("walnut_wood_planks");
		}
