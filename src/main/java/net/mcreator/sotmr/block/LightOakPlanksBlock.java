...
public class LightOakPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lightoakplanks")
	public static final Block block = null;
	public LightOakPlanksBlock(SotmModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightoakplanks");
		}
