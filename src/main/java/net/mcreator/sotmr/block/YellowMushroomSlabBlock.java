...
public class YellowMushroomSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_slab")
	public static final Block block = null;
	public YellowMushroomSlabBlock(SotmModElements instance) {
		super(instance, 247);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom_slab");
		}
