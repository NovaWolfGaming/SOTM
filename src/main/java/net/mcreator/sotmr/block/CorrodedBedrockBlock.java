...
import net.mcreator.sotmr.item.BedrockShardItem;
...
public class CorrodedBedrockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:corroded_bedrock")
	public static final Block block = null;
	public CorrodedBedrockBlock(SotmModElements instance) {
		super(instance, 1591);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.05f, 13f).setLightLevel(s -> 0));
			setRegistryName("corroded_bedrock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BedrockShardItem.block, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:corroded_bedrock_match"), () -> CustomRuleTest.codec);
