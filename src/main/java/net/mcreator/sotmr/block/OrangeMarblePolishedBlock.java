...
public class OrangeMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_polished")
	public static final Block block = null;
	public OrangeMarblePolishedBlock(SotmModElements instance) {
		super(instance, 561);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_polished");
		}
