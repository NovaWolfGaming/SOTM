...
public class BegoniaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia")
	public static final Block block = null;
	public BegoniaBlock(SotmModElements instance) {
		super(instance, 281);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia"), configuredFeature);
		}
	}
	@SubscribeEvent
