...
public class WalnutWoodTrapdoorRecipeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_trapdoor_recipe")
	public static final Block block = null;
	public WalnutWoodTrapdoorRecipeBlock(SotmModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("walnut_wood_trapdoor_recipe");
		}
