...
public class VenorumSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_smooth")
	public static final Block block = null;
	public VenorumSmoothBlock(SotmModElements instance) {
		super(instance, 521);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("venorum_smooth");
		}
