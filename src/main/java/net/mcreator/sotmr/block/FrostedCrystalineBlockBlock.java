...
public class FrostedCrystalineBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_crystaline_block")
	public static final Block block = null;
	public FrostedCrystalineBlockBlock(SotmModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_crystaline_block");
		}
