...
public class BasaltBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basalt")
	public static final Block block = null;
	public BasaltBlock(SotmModElements instance) {
		super(instance, 490);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:basalt_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("basalt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:basalt"), configuredFeature);
		}
	}
	@SubscribeEvent
