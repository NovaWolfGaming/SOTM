...
public class IronOreUnderworldBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:ironoreunderworld")
	public static final Block block = null;
	public IronOreUnderworldBlock(SotmModElements instance) {
		super(instance, 30);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ironoreunderworld");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:ironoreunderworld_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ironoreunderworld"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:ironoreunderworld"), configuredFeature);
		}
	}
	@SubscribeEvent
