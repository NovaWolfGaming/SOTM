...
public class MossyPhantomLocustPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_phantom_locust_planks")
	public static final Block block = null;
	public MossyPhantomLocustPlanksBlock(SotmModElements instance) {
		super(instance, 2637);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_phantom_locust_planks");
		}
