...
import net.mcreator.sotmr.item.SunberryItem;
...
public class SunberryBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sunberrybush")
	public static final Block block = null;
	public SunberryBushBlock(SotmModElements instance) {
		super(instance, 275);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sunberrybush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sunberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("sunberrybush");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SunberryItem.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SunberryItem.block, (int) (3)));
		}
