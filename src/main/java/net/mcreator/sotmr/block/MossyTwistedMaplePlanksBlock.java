...
public class MossyTwistedMaplePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_twisted_maple_planks")
	public static final Block block = null;
	public MossyTwistedMaplePlanksBlock(SotmModElements instance) {
		super(instance, 2633);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_twisted_maple_planks");
		}
