...
public class ChippedSprucePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_spruce_planks")
	public static final Block block = null;
	public ChippedSprucePlanksBlock(SotmModElements instance) {
		super(instance, 2603);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_spruce_planks");
		}
