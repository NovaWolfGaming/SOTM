...
public class FuriteBlockStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:furiteblockstairs")
	public static final Block block = null;
	public FuriteBlockStairsBlock(SotmModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("furiteblockstairs");
		}
