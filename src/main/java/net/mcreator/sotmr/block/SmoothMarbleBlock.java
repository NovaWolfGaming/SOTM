...
public class SmoothMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_marble")
	public static final Block block = null;
	public SmoothMarbleBlock(SotmModElements instance) {
		super(instance, 505);
	}
