...
public class ShulkeriteStairsRecipeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_shulkerite_stairs")
	public static final Block block = null;
	public ShulkeriteStairsRecipeBlock(SotmModElements instance) {
		super(instance, 198);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_shulkerite_stairs");
		}
