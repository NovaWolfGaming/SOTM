...
public class CarbonSandstoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carbonsandstone")
	public static final Block block = null;
	public CarbonSandstoneBlock(SotmModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carbonsandstone");
		}
