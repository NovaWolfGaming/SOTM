...
public class RubyOreNetherBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rubyorenether")
	public static final Block block = null;
	public RubyOreNetherBlock(SotmModElements instance) {
		super(instance, 6);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:rubyorenether_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("rubyorenether"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:rubyorenether"), configuredFeature);
		}
	}
	@SubscribeEvent
