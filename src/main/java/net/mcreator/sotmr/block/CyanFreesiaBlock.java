...
public class CyanFreesiaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cyan_freesia")
	public static final Block block = null;
	public CyanFreesiaBlock(SotmModElements instance) {
		super(instance, 1776);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cyan_freesia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:cyan_freesia"), configuredFeature);
		}
	}
	@SubscribeEvent
