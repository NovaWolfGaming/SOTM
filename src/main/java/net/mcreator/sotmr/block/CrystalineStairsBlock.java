...
public class CrystalineStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystalinestairs")
	public static final Block block = null;
	public CrystalineStairsBlock(SotmModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("crystalinestairs");
		}
