...
import net.mcreator.sotmr.item.ChiliItem;
...
public class ChiliPlantBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chili_plant")
	public static final Block block = null;
	public ChiliPlantBlock(SotmModElements instance) {
		super(instance, 263);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("chili_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:chili_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ChiliItem.block, (int) (2)));
		}
