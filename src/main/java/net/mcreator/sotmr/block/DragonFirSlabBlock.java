...
public class DragonFirSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_slab")
	public static final Block block = null;
	public DragonFirSlabBlock(SotmModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_slab");
		}
