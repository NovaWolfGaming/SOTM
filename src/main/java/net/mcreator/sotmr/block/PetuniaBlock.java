...
public class PetuniaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:petunia")
	public static final Block block = null;
	public PetuniaBlock(SotmModElements instance) {
		super(instance, 324);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("petunia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:petunia"), configuredFeature);
		}
	}
	@SubscribeEvent
