...
public class ChiseledRoseQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_rose_quartz")
	public static final Block block = null;
	public ChiseledRoseQuartzBlock(SotmModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_rose_quartz");
		}
