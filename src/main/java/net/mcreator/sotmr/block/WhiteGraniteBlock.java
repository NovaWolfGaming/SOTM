...
public class WhiteGraniteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:whitegranite")
	public static final Block block = null;
	public WhiteGraniteBlock(SotmModElements instance) {
		super(instance, 481);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:whitegranite_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("whitegranite"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:whitegranite"), configuredFeature);
		}
	}
	@SubscribeEvent
