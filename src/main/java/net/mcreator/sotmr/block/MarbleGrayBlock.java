...
public class MarbleGrayBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_gray")
	public static final Block block = null;
	public MarbleGrayBlock(SotmModElements instance) {
		super(instance, 2445);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_gray_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_gray"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_gray"), configuredFeature);
		}
	}
	@SubscribeEvent
