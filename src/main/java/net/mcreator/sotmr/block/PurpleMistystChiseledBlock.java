...
public class PurpleMistystChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_chiseled")
	public static final Block block = null;
	public PurpleMistystChiseledBlock(SotmModElements instance) {
		super(instance, 542);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_chiseled");
		}
