...
public class Spotted_AshwoodWoodBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_wood")
	public static final Block block = null;
	public Spotted_AshwoodWoodBlock(SotmModElements instance) {
		super(instance, 1412);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_wood");
		}
