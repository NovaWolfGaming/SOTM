...
public class BukraltBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bukralt")
	public static final Block block = null;
	public BukraltBlock(SotmModElements instance) {
		super(instance, 526);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:bukralt_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("bukralt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:bukralt"), configuredFeature);
		}
	}
	@SubscribeEvent
