...
public class MossyAshwoodPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_ashwood_planks")
	public static final Block block = null;
	public MossyAshwoodPlanksBlock(SotmModElements instance) {
		super(instance, 2653);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_ashwood_planks");
		}
