...
public class CyanRosesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cyan_roses")
	public static final Block block = null;
	public CyanRosesBlock(SotmModElements instance) {
		super(instance, 1851);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cyan_roses"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:cyan_roses"), configuredFeature);
		}
	}
	@SubscribeEvent
