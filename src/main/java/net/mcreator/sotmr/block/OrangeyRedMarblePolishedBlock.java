...
public class OrangeyRedMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble_polished")
	public static final Block block = null;
	public OrangeyRedMarblePolishedBlock(SotmModElements instance) {
		super(instance, 2530);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble_polished");
		}
