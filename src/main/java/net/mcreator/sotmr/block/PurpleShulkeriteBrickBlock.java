...
public class PurpleShulkeriteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_shulkerite_brick")
	public static final Block block = null;
	public PurpleShulkeriteBrickBlock(SotmModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_shulkerite_brick");
		}
