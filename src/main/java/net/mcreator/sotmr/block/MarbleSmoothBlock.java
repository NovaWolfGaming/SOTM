...
public class MarbleSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_smooth")
	public static final Block block = null;
	public MarbleSmoothBlock(SotmModElements instance) {
		super(instance, 506);
	}
