...
public class GrayCrolphinBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:gray_crolphin_bricks")
	public static final Block block = null;
	public GrayCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2295);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gray_crolphin_bricks");
		}
