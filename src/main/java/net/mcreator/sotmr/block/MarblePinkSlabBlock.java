...
public class MarblePinkSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pink_slab")
	public static final Block block = null;
	public MarblePinkSlabBlock(SotmModElements instance) {
		super(instance, 2367);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_pink_slab");
		}
