...
public class PinkMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_marble_slab")
	public static final Block block = null;
	public PinkMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1482);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pink_marble_slab");
		}
