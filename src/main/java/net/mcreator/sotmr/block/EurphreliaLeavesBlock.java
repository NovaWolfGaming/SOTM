...
public class EurphreliaLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:eurphrelialeaves")
	public static final Block block = null;
	public EurphreliaLeavesBlock(SotmModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("eurphrelialeaves");
		}
