...
public class CharredrockashpileBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:charredrockashpile")
	public static final Block block = null;
	public CharredrockashpileBlock(SotmModElements instance) {
		super(instance, 545);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("charredrockashpile");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:charredrockashpile_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("charredrockashpile"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:charredrockashpile"), configuredFeature);
		}
	}
	@SubscribeEvent
