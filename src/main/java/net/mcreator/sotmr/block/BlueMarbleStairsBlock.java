...
public class BlueMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_marble_stairs")
	public static final Block block = null;
	public BlueMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1477);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_marble_stairs");
		}
