...
public class DewYellowMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble_stairs")
	public static final Block block = null;
	public DewYellowMarbleStairsBlock(SotmModElements instance) {
		super(instance, 2520);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble_stairs");
		}
