...
public class PinkSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_smooth_crolphin")
	public static final Block block = null;
	public PinkSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2269);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_smooth_crolphin");
		}
