...
public class BlueSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_smooth_crolphin")
	public static final Block block = null;
	public BlueSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2275);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_smooth_crolphin");
		}
