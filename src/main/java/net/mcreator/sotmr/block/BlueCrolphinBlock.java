...
public class BlueCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_crolphin")
	public static final Block block = null;
	public BlueCrolphinBlock(SotmModElements instance) {
		super(instance, 2243);
	}
