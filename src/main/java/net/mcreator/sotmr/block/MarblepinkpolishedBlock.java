...
public class MarblepinkpolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marblepinkpolished")
	public static final Block block = null;
	public MarblepinkpolishedBlock(SotmModElements instance) {
		super(instance, 2362);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblepinkpolished");
		}
