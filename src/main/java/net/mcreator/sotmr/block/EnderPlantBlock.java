...
public class EnderPlantBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:enderplant")
	public static final Block block = null;
	public EnderPlantBlock(SotmModElements instance) {
		super(instance, 284);
