...
public class DeepyellowbellflowersBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deepyellowbellflowers")
	public static final Block block = null;
	public DeepyellowbellflowersBlock(SotmModElements instance) {
		super(instance, 1756);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("deepyellowbellflowers"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:deepyellowbellflowers"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("deepyellowbellflowers");
		}
