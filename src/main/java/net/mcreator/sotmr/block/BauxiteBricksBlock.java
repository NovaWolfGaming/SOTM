...
public class BauxiteBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bauxite_bricks")
	public static final Block block = null;
	public BauxiteBricksBlock(SotmModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bauxite_bricks");
		}
