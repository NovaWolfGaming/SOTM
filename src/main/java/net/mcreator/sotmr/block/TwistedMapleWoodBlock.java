...
public class TwistedMapleWoodBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_wood")
	public static final Block block = null;
	public TwistedMapleWoodBlock(SotmModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_wood");
		}
