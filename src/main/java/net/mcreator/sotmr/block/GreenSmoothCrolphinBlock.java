...
public class GreenSmoothCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:green_smooth_crolphin")
	public static final Block block = null;

	public GreenSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2283);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("green_smooth_crolphin");
		}
