...
public class BloodElderBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder")
	public static final Block block = null;
	public BloodElderBlock(SotmModElements instance) {
		super(instance, 101);
	}
