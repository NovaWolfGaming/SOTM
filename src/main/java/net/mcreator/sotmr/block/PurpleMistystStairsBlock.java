...
public class PurpleMistystStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_stairs")
	public static final Block block = null;
	public PurpleMistystStairsBlock(SotmModElements instance) {
		super(instance, 538);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_stairs");
		}
