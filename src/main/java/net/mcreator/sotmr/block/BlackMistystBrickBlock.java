...
public class BlackMistystBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst_brick")
	public static final Block block = null;
	public BlackMistystBrickBlock(SotmModElements instance) {
		super(instance, 2713);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_mistyst_brick");
		}
