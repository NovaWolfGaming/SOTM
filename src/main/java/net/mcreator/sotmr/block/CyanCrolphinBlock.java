...
public class CyanCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:cyan_crolphin")
	public static final Block block = null;

	public CyanCrolphinBlock(SotmModElements instance) {
		super(instance, 2247);
