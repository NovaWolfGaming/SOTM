...
public class WhiteMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_marble_stairs")
	public static final Block block = null;
	public WhiteMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1475);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("white_marble_stairs");
		}
