...
public class MossyOakPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_oak_planks")
	public static final Block block = null;

	public MossyOakPlanksBlock(SotmModElements instance) {
		super(instance, 2588);
