...
public class UnderworldweedsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:underworldweeds")
	public static final Block block = null;
	public UnderworldweedsBlock(SotmModElements instance) {
		super(instance, 280);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("underworldweeds"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:underworldweeds"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("underworldweeds");
		}
