...
public class BlackMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_marble_pillar")
	public static final Block block = null;
	public BlackMarblePillarBlock(SotmModElements instance) {
		super(instance, 1465);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_marble_pillar");
		}
