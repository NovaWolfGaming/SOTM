...
public class LightGrayCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_gray_crolphin")
	public static final Block block = null;
	public LightGrayCrolphinBlock(SotmModElements instance) {
		super(instance, 2229);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_gray_crolphin");
		}
