...
public class OrangeyRedMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble")
	public static final Block block = null;
	public OrangeyRedMarbleBlock(SotmModElements instance) {
		super(instance, 2529);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:orangey_red_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("orangey_red_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:orangey_red_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
