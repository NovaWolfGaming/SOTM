...
public class PurpleCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:purple_crolphin")
	public static final Block block = null;

	public PurpleCrolphinBlock(SotmModElements instance) {
		super(instance, 2241);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("purple_crolphin");
		}
