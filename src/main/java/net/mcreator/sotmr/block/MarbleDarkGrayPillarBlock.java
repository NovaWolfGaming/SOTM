...
public class MarbleDarkGrayPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dark_gray_pillar")
	public static final Block block = null;
	public MarbleDarkGrayPillarBlock(SotmModElements instance) {
		super(instance, 2491);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_dark_gray_pillar");
		}
