...
public class RedRosesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_roses")
	public static final Block block = null;
	public RedRosesBlock(SotmModElements instance) {
		super(instance, 1852);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_roses"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:red_roses"), configuredFeature);
		}
	}
	@SubscribeEvent
