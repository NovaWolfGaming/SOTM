...
public class AmberQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amber_quartz_stairs")
	public static final Block block = null;
	public AmberQuartzStairsBlock(SotmModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("amber_quartz_stairs");
		}
