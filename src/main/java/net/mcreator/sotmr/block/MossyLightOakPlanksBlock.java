...
public class MossyLightOakPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_light_oak_planks")
	public static final Block block = null;
	public MossyLightOakPlanksBlock(SotmModElements instance) {
		super(instance, 2676);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_light_oak_planks");
		}
