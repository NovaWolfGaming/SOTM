...
public class UnderworldGrassFloweredBlock extends SotmModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:underworldgrassflowered_match"),
			...
			event.getRegistry().register(feature.setRegistryName("underworldgrassflowered"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:underworldgrassflowered"), configuredFeature);
		}
	}
	@SubscribeEvent
