...
public class WhiteSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_smooth_crolphin")
	public static final Block block = null;
	public WhiteSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2259);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_smooth_crolphin");
		}
