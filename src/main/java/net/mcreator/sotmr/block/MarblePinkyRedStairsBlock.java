...
public class MarblePinkyRedStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red_stairs")
	public static final Block block = null;
	public MarblePinkyRedStairsBlock(SotmModElements instance) {
		super(instance, 2422);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red_stairs");
		}
