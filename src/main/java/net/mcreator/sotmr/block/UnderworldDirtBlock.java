...
public class UnderworldDirtBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:underworlddirt")
	public static final Block block = null;
	public UnderworldDirtBlock(SotmModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("underworlddirt");
		}
