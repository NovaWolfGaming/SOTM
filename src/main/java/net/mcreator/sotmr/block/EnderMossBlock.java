...
public class EnderMossBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:ender_moss")
	public static final Block block = null;
	public EnderMossBlock(SotmModElements instance) {
		super(instance, 1058);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ender_moss"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:ender_moss"), configuredFeature);
		}
	}
	@SubscribeEvent
