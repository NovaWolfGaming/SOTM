...
public class PurpleMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_marble_brick")
	public static final Block block = null;
	public PurpleMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1458);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_marble_brick");
		}
