...
import net.mcreator.sotmr.procedures.SoulOreBlockDestroyedByPlayerProcedure;
...
public class SoulOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:soul_ore")
	public static final Block block = null;
	public SoulOreBlock(SotmModElements instance) {
		super(instance, 2574);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:soul_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("soul_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:soul_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
