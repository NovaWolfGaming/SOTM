...
public class PolishedWhiteGraniteStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedwhitegranitestairs")
	public static final Block block = null;
	public PolishedWhiteGraniteStairsBlock(SotmModElements instance) {
		super(instance, 162);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedwhitegranitestairs");
		}
