...
public class EnderWartBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:ender_wart_block")
	public static final Block block = null;
	public EnderWartBlockBlock(SotmModElements instance) {
		super(instance, 1832);
	}
