...
public class BlackMistystBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst_brick_slab")
	public static final Block block = null;
	public BlackMistystBrickSlabBlock(SotmModElements instance) {
		super(instance, 2715);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mistyst_brick_slab");
		}
