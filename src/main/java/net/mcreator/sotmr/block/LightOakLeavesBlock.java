...
import net.mcreator.sotmr.procedures.LightOakLeavesBlockDestroyedByPlayerProcedure;
...
public class LightOakLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lightoakleaves")
	public static final Block block = null;
	public LightOakLeavesBlock(SotmModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightoakleaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				LightOakLeavesBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
