...
public class PinkChalkBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_chalk_bricks")
	public static final Block block = null;
	public PinkChalkBricksBlock(SotmModElements instance) {
		super(instance, 1814);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_chalk_bricks");
		}
