...
public class MarbleDirtyWhiteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dirty_white_brick")
	public static final Block block = null;
	public MarbleDirtyWhiteBrickBlock(SotmModElements instance) {
		super(instance, 2406);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_dirty_white_brick");
		}
