...
public class WalnutWoodFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_fence")
	public static final Block block = null;
	public WalnutWoodFenceBlock(SotmModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("walnut_wood_fence");
		}
