...
public class OrangeCrolphinBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_crolphin_bricks")
	public static final Block block = null;
	public OrangeCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2319);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_crolphin_bricks");
		}
