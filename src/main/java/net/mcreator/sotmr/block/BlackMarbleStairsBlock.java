...
public class BlackMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_marble_stairs")
	public static final Block block = null;
	public BlackMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1473);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_marble_stairs");
		}
