...
public class AssidiumWoodStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:assidium_wood_stairs")
	public static final Block block = null;
	public AssidiumWoodStairsBlock(SotmModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("assidium_wood_stairs");
		}
