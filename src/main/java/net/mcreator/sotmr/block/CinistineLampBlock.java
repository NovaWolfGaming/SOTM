...
public class CinistineLampBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cinistinelamp")
	public static final Block block = null;
	public CinistineLampBlock(SotmModElements instance) {
		super(instance, 45);
	}
