...
public class NetherGoldOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nethergoldore")
	public static final Block block = null;
	public NetherGoldOreBlock(SotmModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:nethergoldore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("nethergoldore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:nethergoldore"), configuredFeature);
		}
	}
	@SubscribeEvent
