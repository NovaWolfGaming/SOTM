...
public class BlueMistystBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst_brick_slab")
	public static final Block block = null;
	public BlueMistystBrickSlabBlock(SotmModElements instance) {
		super(instance, 2685);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_mistyst_brick_slab");
		}
