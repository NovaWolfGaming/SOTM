...
public class MossyJunglePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_jungle_planks")
	public static final Block block = null;
	public MossyJunglePlanksBlock(SotmModElements instance) {
		super(instance, 2605);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_jungle_planks");
		}
