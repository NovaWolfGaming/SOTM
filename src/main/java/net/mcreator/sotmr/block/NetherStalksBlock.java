...
public class NetherStalksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nether_stalks")
	public static final Block block = null;
	public NetherStalksBlock(SotmModElements instance) {
		super(instance, 1764);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("nether_stalks"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:nether_stalks"), configuredFeature);
		}
	}
	@SubscribeEvent
