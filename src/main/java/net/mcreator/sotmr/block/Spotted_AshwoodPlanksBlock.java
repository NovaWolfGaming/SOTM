...
public class Spotted_AshwoodPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_planks")
	public static final Block block = null;
	public Spotted_AshwoodPlanksBlock(SotmModElements instance) {
		super(instance, 1414);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_planks");
		}
