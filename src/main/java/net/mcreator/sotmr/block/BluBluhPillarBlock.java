...
public class BluBluhPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blu_bluh_pillar")
	public static final Block block = null;
	public BluBluhPillarBlock(SotmModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blu_bluh_pillar");
		}
