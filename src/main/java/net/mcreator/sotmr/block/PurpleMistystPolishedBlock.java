...
public class PurpleMistystPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_polished")
	public static final Block block = null;
	public PurpleMistystPolishedBlock(SotmModElements instance) {
		super(instance, 2719);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_polished");
		}
