...
public class BauxtieChiseledBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bauxtie_chiseled_brick")
	public static final Block block = null;
	public BauxtieChiseledBrickBlock(SotmModElements instance) {
		super(instance, 511);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bauxtie_chiseled_brick");
		}
