...
public class VenorumQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_quartz_stairs")
	public static final Block block = null;
	public VenorumQuartzStairsBlock(SotmModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("venorum_quartz_stairs");
		}
