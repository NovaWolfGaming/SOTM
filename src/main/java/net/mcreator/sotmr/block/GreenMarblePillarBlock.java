...
public class GreenMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_marble_pillar")
	public static final Block block = null;
	public GreenMarblePillarBlock(SotmModElements instance) {
		super(instance, 1468);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_marble_pillar");
		}
