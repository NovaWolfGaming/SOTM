...
public class MarbleDirtyWhiteSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dirty_white_smooth")
	public static final Block block = null;
	public MarbleDirtyWhiteSmoothBlock(SotmModElements instance) {
		super(instance, 2405);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_dirty_white_smooth");
		}
