...
public class YellowCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_crolphin")
	public static final Block block = null;
	public YellowCrolphinBlock(SotmModElements instance) {
		super(instance, 2253);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_crolphin");
		}
