...
public class BlackGraniteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackgranite")
	public static final Block block = null;
	public BlackGraniteBlock(SotmModElements instance) {
		super(instance, 479);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:blackgranite_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("blackgranite"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blackgranite"), configuredFeature);
		}
	}
	@SubscribeEvent
