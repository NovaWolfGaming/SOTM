...
public class MossyCherryWoodPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_cherry_wood_planks")
	public static final Block block = null;
	public MossyCherryWoodPlanksBlock(SotmModElements instance) {
		super(instance, 2649);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_cherry_wood_planks");
		}
