...
public class PurpleSmoothCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:purple_smooth_crolphin")
	public static final Block block = null;

	public PurpleSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2273);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("purple_smooth_crolphin");
		}
