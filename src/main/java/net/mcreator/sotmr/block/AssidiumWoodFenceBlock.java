...
public class AssidiumWoodFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:assidium_wood_fence")
	public static final Block block = null;
	public AssidiumWoodFenceBlock(SotmModElements instance) {
		super(instance, 330);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("assidium_wood_fence");
		}
