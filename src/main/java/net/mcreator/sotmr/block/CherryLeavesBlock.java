...
import net.mcreator.sotmr.procedures.CherryLeavesBlockDestroyedByPlayerProcedure;
...
public class CherryLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_leaves")
	public static final Block block = null;
	public CherryLeavesBlock(SotmModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CherryLeavesBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
