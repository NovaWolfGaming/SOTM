...
public class SilverOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:silverore")
	public static final Block block = null;
	public SilverOreBlock(SotmModElements instance) {
		super(instance, 32);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:silverore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:silverore"), configuredFeature);
		}
	}
	@SubscribeEvent
