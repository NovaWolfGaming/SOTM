...
public class PolishedWhiteGraniteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedwhitegraniteslab")
	public static final Block block = null;
	public PolishedWhiteGraniteSlabBlock(SotmModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedwhitegraniteslab");
		}
