...
public class DarkQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:darkquartzstairs")
	public static final Block block = null;
	public DarkQuartzStairsBlock(SotmModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("darkquartzstairs");
		}
