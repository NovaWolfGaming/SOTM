...
public class PolishedWhiteGraniteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedwhitegranite")
	public static final Block block = null;
	public PolishedWhiteGraniteBlock(SotmModElements instance) {
		super(instance, 482);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedwhitegranite");
		}
