...
public class MarbleYellowBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow")
	public static final Block block = null;
	public MarbleYellowBlock(SotmModElements instance) {
		super(instance, 2375);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_yellow_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_yellow"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_yellow"), configuredFeature);
		}
	}
	@SubscribeEvent
