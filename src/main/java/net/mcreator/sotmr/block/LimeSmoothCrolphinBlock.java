...
public class LimeSmoothCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:lime_smooth_crolphin")
	public static final Block block = null;

	public LimeSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2281);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("lime_smooth_crolphin");
		}
