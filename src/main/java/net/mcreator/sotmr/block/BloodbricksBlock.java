...
public class BloodbricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bloodbricks")
	public static final Block block = null;
	public BloodbricksBlock(SotmModElements instance) {
		super(instance, 573);
	}
