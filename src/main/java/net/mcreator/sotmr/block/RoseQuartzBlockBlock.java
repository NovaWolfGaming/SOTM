...
public class RoseQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_quartz_block")
	public static final Block block = null;
	public RoseQuartzBlockBlock(SotmModElements instance) {
		super(instance, 81);
	}
