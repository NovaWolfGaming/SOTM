...
public class MarbleCyanSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_cyan_slab")
	public static final Block block = null;
	public MarbleCyanSlabBlock(SotmModElements instance) {
		super(instance, 2395);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_cyan_slab");
		}
