...
public class MarbleLightGreenStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green_stairs")
	public static final Block block = null;
	public MarbleLightGreenStairsBlock(SotmModElements instance) {
		super(instance, 2464);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_light_green_stairs");
		}
