...
public class RedMushroomDoubleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mushroom_double")
	public static final Block block = null;
	public RedMushroomDoubleBlock(SotmModElements instance) {
		super(instance, 1790);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_mushroom_double"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:red_mushroom_double"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.BAMBOO).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("red_mushroom_double");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blocks.RED_MUSHROOM, (int) (3)));
		}
