...
public class HardenedCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:hardened_crolphin")
	public static final Block block = null;
	public HardenedCrolphinBlock(SotmModElements instance) {
		super(instance, 2225);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardened_crolphin");
		}
