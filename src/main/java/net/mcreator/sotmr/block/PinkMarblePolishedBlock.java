...
public class PinkMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_marble_polished")
	public static final Block block = null;
	public PinkMarblePolishedBlock(SotmModElements instance) {
		super(instance, 558);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_marble_polished");
		}
