...
public class ChippedBloodAlderPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_blood_alder_planks")
	public static final Block block = null;

	public ChippedBloodAlderPlanksBlock(SotmModElements instance) {
		super(instance, 2667);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_blood_alder_planks");
		}
