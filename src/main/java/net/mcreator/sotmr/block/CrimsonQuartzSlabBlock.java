...
public class CrimsonQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crimson_quartz_slab")
	public static final Block block = null;
	public CrimsonQuartzSlabBlock(SotmModElements instance) {
		super(instance, 294);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_quartz_slab");
		}
