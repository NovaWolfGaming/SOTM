...
public class SirccillunBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sirccillun_block")
	public static final Block block = null;
	public SirccillunBlockBlock(SotmModElements instance) {
		super(instance, 1713);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sirccillun_block");
		}
