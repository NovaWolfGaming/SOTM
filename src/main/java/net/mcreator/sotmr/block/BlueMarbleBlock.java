...
public class BlueMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_marble")
	public static final Block block = null;
	public BlueMarbleBlock(SotmModElements instance) {
		super(instance, 551);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:blue_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("blue_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blue_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
