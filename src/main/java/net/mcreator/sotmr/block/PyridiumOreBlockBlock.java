...
public class PyridiumOreBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pyridium_ore_block")
	public static final Block block = null;
	public PyridiumOreBlockBlock(SotmModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pyridium_ore_block");
		}
