...
import net.mcreator.sotmr.item.BoneShardItem;
...
public class BoneStemsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bone_stems")
	public static final Block block = null;
	public BoneStemsBlock(SotmModElements instance) {
		super(instance, 1907);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bone_stems"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:bone_stems"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.BONE)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("bone_stems");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BoneShardItem.block, (int) (4)));
		}
