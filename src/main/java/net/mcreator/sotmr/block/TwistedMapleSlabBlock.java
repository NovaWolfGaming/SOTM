...
public class TwistedMapleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_slab")
	public static final Block block = null;
	public TwistedMapleSlabBlock(SotmModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_slab");
		}
