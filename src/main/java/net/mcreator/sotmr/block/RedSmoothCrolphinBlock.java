...
public class RedSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_smooth_crolphin")
	public static final Block block = null;
	public RedSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2267);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_smooth_crolphin");
		}
