...
public class BlueChalkBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_chalk_bricks")
	public static final Block block = null;
	public BlueChalkBricksBlock(SotmModElements instance) {
		super(instance, 1810);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_chalk_bricks");
		}
