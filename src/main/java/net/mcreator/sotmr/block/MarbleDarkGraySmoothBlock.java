...
public class MarbleDarkGraySmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dark_gray_smooth")
	public static final Block block = null;
	public MarbleDarkGraySmoothBlock(SotmModElements instance) {
		super(instance, 2489);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_dark_gray_smooth");
		}
