...
public class BambooThatchSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bamboo_thatch_slab")
	public static final Block block = null;
	public BambooThatchSlabBlock(SotmModElements instance) {
		super(instance, 1670);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_thatch_slab");
		}
