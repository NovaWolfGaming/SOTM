...
public class BloodAlderDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_alder_door")
	public static final Block block = null;
	public BloodAlderDoorBlock(SotmModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_alder_door");
		}
