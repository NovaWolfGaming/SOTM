...
public class BurningFuriteChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:burningfuritechiseled")
	public static final Block block = null;
	public BurningFuriteChiseledBlock(SotmModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("burningfuritechiseled");
		}
