...
public class EnderStemsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:ender_stems")
	public static final Block block = null;
	public EnderStemsBlock(SotmModElements instance) {
		super(instance, 301);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ender_stems"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:ender_stems"), configuredFeature);
		}
	}
	@SubscribeEvent
