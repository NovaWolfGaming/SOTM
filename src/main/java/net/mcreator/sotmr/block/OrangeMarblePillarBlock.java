...
public class OrangeMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_pillar")
	public static final Block block = null;
	public OrangeMarblePillarBlock(SotmModElements instance) {
		super(instance, 1472);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_pillar");
		}
