...
public class BlackMistystStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst_stairs")
	public static final Block block = null;
	public BlackMistystStairsBlock(SotmModElements instance) {
		super(instance, 2709);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mistyst_stairs");
		}
