...
public class OrangeyRedMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble_brick")
	public static final Block block = null;
	public OrangeyRedMarbleBrickBlock(SotmModElements instance) {
		super(instance, 2532);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble_brick");
		}
