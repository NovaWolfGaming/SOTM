...
public class ChorusStoneBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone_brick_stairs")
	public static final Block block = null;
	public ChorusStoneBrickStairsBlock(SotmModElements instance) {
		super(instance, 1382);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("chorus_stone_brick_stairs");
		}
