...
import net.mcreator.sotmr.procedures.TwistedMapleLeavesBlockDestroyedByPlayerProcedure;
...
public class TwistedMapleLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_leaves")
	public static final Block block = null;
	public TwistedMapleLeavesBlock(SotmModElements instance) {
		super(instance, 216);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_leaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				TwistedMapleLeavesBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
