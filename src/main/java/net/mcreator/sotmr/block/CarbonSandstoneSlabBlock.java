...
public class CarbonSandstoneSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carbonsandstoneslab")
	public static final Block block = null;
	public CarbonSandstoneSlabBlock(SotmModElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("carbonsandstoneslab");
		}
