...
public class ChippedBambooPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_bamboo_planks")
	public static final Block block = null;

	public ChippedBambooPlanksBlock(SotmModElements instance) {
		super(instance, 2659);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_bamboo_planks");
		}
