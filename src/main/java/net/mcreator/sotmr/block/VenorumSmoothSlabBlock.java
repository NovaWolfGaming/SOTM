...
public class VenorumSmoothSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_smooth_slab")
	public static final Block block = null;
	public VenorumSmoothSlabBlock(SotmModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("venorum_smooth_slab");
		}
