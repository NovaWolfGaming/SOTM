...
public class BambooThatchStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bamboo_thatch_stairs")
	public static final Block block = null;
	public BambooThatchStairsBlock(SotmModElements instance) {
		super(instance, 1668);
	}
