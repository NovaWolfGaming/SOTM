...
public class CobblestoneTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cobblestone_trapdoor")
	public static final Block block = null;
	public CobblestoneTrapdoorBlock(SotmModElements instance) {
		super(instance, 544);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(0)
