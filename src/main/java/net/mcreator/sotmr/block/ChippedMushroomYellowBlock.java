...
public class ChippedMushroomYellowBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_mushroom_yellow")
	public static final Block block = null;

	public ChippedMushroomYellowBlock(SotmModElements instance) {
		super(instance, 2631);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_mushroom_yellow");
		}
