...
public class ChippedTwistedMaplePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_twisted_maple_planks")
	public static final Block block = null;
	public ChippedTwistedMaplePlanksBlock(SotmModElements instance) {
		super(instance, 2635);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_twisted_maple_planks");
		}
