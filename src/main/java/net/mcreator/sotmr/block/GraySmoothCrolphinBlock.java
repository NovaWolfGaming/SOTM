...
public class GraySmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:gray_smooth_crolphin")
	public static final Block block = null;
	public GraySmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2263);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gray_smooth_crolphin");
		}
