...
public class OrangeyRedMarbleSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble_smooth")
	public static final Block block = null;
	public OrangeyRedMarbleSmoothBlock(SotmModElements instance) {
		super(instance, 2531);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble_smooth");
		}
