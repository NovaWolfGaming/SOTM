...
public class GreenMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_marble_stairs")
	public static final Block block = null;
	public GreenMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1479);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_marble_stairs");
		}
