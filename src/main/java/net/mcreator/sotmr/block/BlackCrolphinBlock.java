...
public class BlackCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_crolphin")
	public static final Block block = null;
	public BlackCrolphinBlock(SotmModElements instance) {
		super(instance, 2233);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_crolphin");
		}
