...
public class PumiceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pumice")
	public static final Block block = null;
	public PumiceBlock(SotmModElements instance) {
		super(instance, 512);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:pumice_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 26)).range(70)
					.square().func_242731_b(26);
			event.getRegistry().register(feature.setRegistryName("pumice"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pumice"), configuredFeature);
		}
	}
	@SubscribeEvent
