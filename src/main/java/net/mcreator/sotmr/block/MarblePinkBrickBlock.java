...
public class MarblePinkBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pink_brick")
	public static final Block block = null;
	public MarblePinkBrickBlock(SotmModElements instance) {
		super(instance, 2364);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_pink_brick");
		}
