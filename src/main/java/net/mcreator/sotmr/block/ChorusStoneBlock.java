...
public class ChorusStoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone")
	public static final Block block = null;
	public ChorusStoneBlock(SotmModElements instance) {
		super(instance, 588);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:chorus_stone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("chorus_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:chorus_stone"), configuredFeature);
		}
	}
	@SubscribeEvent
