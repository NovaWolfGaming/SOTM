...
public class ChippedJunglePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_jungle_planks")
	public static final Block block = null;
	public ChippedJunglePlanksBlock(SotmModElements instance) {
		super(instance, 2607);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_jungle_planks");
		}
