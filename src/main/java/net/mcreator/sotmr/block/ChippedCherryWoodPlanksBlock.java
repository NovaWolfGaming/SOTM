...
public class ChippedCherryWoodPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_cherry_wood_planks")
	public static final Block block = null;

	public ChippedCherryWoodPlanksBlock(SotmModElements instance) {
		super(instance, 2651);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_cherry_wood_planks");
		}
