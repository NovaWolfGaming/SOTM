...
public class ChippedMushroomBlackPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_mushroom_black_planks")
	public static final Block block = null;
	public ChippedMushroomBlackPlanksBlock(SotmModElements instance) {
		super(instance, 2647);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_mushroom_black_planks");
		}
