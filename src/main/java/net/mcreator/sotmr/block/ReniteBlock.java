...
public class ReniteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:renite")
	public static final Block block = null;
	public ReniteBlock(SotmModElements instance) {
		super(instance, 586);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:renite_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:renite"), configuredFeature);
		}
	}
	@SubscribeEvent
