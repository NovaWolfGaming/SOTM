...
public class MarbleGraySlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_gray_slab")
	public static final Block block = null;
	public MarbleGraySlabBlock(SotmModElements instance) {
		super(instance, 2451);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_gray_slab");
		}
