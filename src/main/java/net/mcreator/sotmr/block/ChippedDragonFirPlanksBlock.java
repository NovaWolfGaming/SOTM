...
public class ChippedDragonFirPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_dragon_fir_planks")
	public static final Block block = null;

	public ChippedDragonFirPlanksBlock(SotmModElements instance) {
		super(instance, 2643);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_dragon_fir_planks");
		}
