...
public class LisianthusBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lisianthus")
	public static final Block block = null;
	public LisianthusBlock(SotmModElements instance) {
		super(instance, 322);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lisianthus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:lisianthus"), configuredFeature);
		}
	}
	@SubscribeEvent
