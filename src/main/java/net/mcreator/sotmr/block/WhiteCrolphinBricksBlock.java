...
public class WhiteCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:white_crolphin_bricks")
	public static final Block block = null;

	public WhiteCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2291);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("white_crolphin_bricks");
		}
