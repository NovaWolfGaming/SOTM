...
public class ChippedLightOakPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_light_oak_planks")
	public static final Block block = null;

	public ChippedLightOakPlanksBlock(SotmModElements instance) {
		super(instance, 2678);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_light_oak_planks");
		}
