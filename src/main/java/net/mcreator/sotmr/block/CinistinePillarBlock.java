...
public class CinistinePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cinistinepillar")
	public static final Block block = null;
	public CinistinePillarBlock(SotmModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cinistinepillar");
		}
