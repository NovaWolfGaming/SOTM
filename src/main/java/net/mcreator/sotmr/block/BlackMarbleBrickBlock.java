...
public class BlackMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_marble_brick")
	public static final Block block = null;
	public BlackMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1446);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_marble_brick");
		}
