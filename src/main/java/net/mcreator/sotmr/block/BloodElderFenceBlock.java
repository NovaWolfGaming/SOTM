...
public class BloodElderFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder_fence")
	public static final Block block = null;
	public BloodElderFenceBlock(SotmModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_elder_fence");
		}
