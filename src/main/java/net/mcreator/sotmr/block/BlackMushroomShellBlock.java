...
public class BlackMushroomShellBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_shell")
	public static final Block block = null;
	public BlackMushroomShellBlock(SotmModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_shell");
		}
