...
public class TwistedMapleTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_trapdoor")
	public static final Block block = null;
	public TwistedMapleTrapdoorBlock(SotmModElements instance) {
		super(instance, 220);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_trapdoor");
		}
