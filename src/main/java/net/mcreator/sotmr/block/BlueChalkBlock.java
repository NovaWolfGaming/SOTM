...
public class BlueChalkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_chalk")
	public static final Block block = null;
	public BlueChalkBlock(SotmModElements instance) {
		super(instance, 1809);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:blue_chalk_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("blue_chalk"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blue_chalk"), configuredFeature);
		}
	}
	@SubscribeEvent
