...
public class DewYellowMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble")
	public static final Block block = null;
	public DewYellowMarbleBlock(SotmModElements instance) {
		super(instance, 2515);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:dew_yellow_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dew_yellow_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:dew_yellow_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
