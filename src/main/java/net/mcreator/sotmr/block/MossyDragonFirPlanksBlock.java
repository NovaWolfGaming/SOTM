...
public class MossyDragonFirPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_dragon_fir_planks")
	public static final Block block = null;

	public MossyDragonFirPlanksBlock(SotmModElements instance) {
		super(instance, 2641);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mossy_dragon_fir_planks");
		}
