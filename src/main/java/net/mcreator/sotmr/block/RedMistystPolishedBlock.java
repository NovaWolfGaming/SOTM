...
public class RedMistystPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst_polished")
	public static final Block block = null;
	public RedMistystPolishedBlock(SotmModElements instance) {
		super(instance, 2694);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_mistyst_polished");
		}
