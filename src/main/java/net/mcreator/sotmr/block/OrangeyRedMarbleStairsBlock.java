...
public class OrangeyRedMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble_stairs")
	public static final Block block = null;
	public OrangeyRedMarbleStairsBlock(SotmModElements instance) {
		super(instance, 2534);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble_stairs");
		}
