...
public class BlueberryBush2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blueberry_bush_2")
	public static final Block block = null;
	public BlueberryBush2Block(SotmModElements instance) {
		super(instance, 1434);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blueberry_bush_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blueberry_bush_2"), configuredFeature);
		}
	}
	@SubscribeEvent
