...
public class MarbleLightBlueBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue")
	public static final Block block = null;
	public MarbleLightBlueBlock(SotmModElements instance) {
		super(instance, 2431);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_light_blue_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_light_blue"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_light_blue"), configuredFeature);
		}
	}
	@SubscribeEvent
