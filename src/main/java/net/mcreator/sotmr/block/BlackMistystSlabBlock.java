...
public class BlackMistystSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst_slab")
	public static final Block block = null;
	public BlackMistystSlabBlock(SotmModElements instance) {
		super(instance, 2711);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mistyst_slab");
		}
