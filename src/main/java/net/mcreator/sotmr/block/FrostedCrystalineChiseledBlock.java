...
public class FrostedCrystalineChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_crystaline_chiseled")
	public static final Block block = null;
	public FrostedCrystalineChiseledBlock(SotmModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_crystaline_chiseled");
		}
