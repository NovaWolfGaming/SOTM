...
public class CherryWoodLogBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_wood_log")
	public static final Block block = null;
	public CherryWoodLogBlock(SotmModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cherry_wood_log");
		}
