...
public class RhyoliteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rhyolite_brick")
	public static final Block block = null;
	public RhyoliteBrickBlock(SotmModElements instance) {
		super(instance, 1697);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rhyolite_brick");
		}
