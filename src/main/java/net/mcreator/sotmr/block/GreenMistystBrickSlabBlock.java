...
public class GreenMistystBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_mistyst_brick_slab")
	public static final Block block = null;
	public GreenMistystBrickSlabBlock(SotmModElements instance) {
		super(instance, 2689);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("green_mistyst_brick_slab");
		}
