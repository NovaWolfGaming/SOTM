...
public class EuphreliaTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:euphreliatrapdoor")
	public static final Block block = null;
	public EuphreliaTrapdoorBlock(SotmModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("euphreliatrapdoor");
		}
