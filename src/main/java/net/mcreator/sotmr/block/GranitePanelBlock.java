...
public class GranitePanelBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:granite_panel")
	public static final Block block = null;
	public GranitePanelBlock(SotmModElements instance) {
		super(instance, 2576);
	}
