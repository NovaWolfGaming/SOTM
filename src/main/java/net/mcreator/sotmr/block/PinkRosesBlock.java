...
public class PinkRosesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_roses")
	public static final Block block = null;
	public PinkRosesBlock(SotmModElements instance) {
		super(instance, 1781);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pink_roses"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pink_roses"), configuredFeature);
		}
	}
	@SubscribeEvent
