...
public class JungleShrubBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:jungle_shrub")
	public static final Block block = null;
	public JungleShrubBlock(SotmModElements instance) {
		super(instance, 1882);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("jungle_shrub"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:jungle_shrub"), configuredFeature);
		}
	}
	@SubscribeEvent
