...
public class BurningFuritePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:burningfuritepillar")
	public static final Block block = null;
	public BurningFuritePillarBlock(SotmModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("burningfuritepillar");
		}
