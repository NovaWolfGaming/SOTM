...
public class SkarnBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:skarn_brick")
	public static final Block block = null;
	public SkarnBrickBlock(SotmModElements instance) {
		super(instance, 1685);
	}
