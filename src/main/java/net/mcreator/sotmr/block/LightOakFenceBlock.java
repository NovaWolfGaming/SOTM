...
public class LightOakFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_oak_fence")
	public static final Block block = null;
	public LightOakFenceBlock(SotmModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("light_oak_fence");
		}
