...
public class GreenMistystBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_mistyst_brick")
	public static final Block block = null;
	public GreenMistystBrickBlock(SotmModElements instance) {
		super(instance, 533);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_mistyst_brick");
		}
