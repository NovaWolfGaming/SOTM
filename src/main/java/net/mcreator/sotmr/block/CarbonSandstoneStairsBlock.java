...
public class CarbonSandstoneStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carbonsandstonestairs")
	public static final Block block = null;
	public CarbonSandstoneStairsBlock(SotmModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("carbonsandstonestairs");
		}
