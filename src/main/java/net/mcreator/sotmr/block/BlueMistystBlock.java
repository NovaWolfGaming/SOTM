...
public class BlueMistystBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst")
	public static final Block block = null;
	public BlueMistystBlock(SotmModElements instance) {
		super(instance, 528);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:blue_mistyst_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("blue_mistyst"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blue_mistyst"), configuredFeature);
		}
	}
	@SubscribeEvent
