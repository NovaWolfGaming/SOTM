...
public class ShortGrassBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:short_grass")
	public static final Block block = null;
	public ShortGrassBlock(SotmModElements instance) {
		super(instance, 1881);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("short_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:short_grass"), configuredFeature);
		}
	}
	@SubscribeEvent
