...
public class BlackMushroomDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_door")
	public static final Block block = null;
	public BlackMushroomDoorBlock(SotmModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_door");
		}
