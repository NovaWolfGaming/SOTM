...
public class MarbleCyanBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_cyan")
	public static final Block block = null;
	public MarbleCyanBlock(SotmModElements instance) {
		super(instance, 2389);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_cyan_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_cyan"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_cyan"), configuredFeature);
		}
	}
	@SubscribeEvent
