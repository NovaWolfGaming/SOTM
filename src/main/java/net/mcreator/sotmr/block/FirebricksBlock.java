...
public class FirebricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:firebricks")
	public static final Block block = null;
	public FirebricksBlock(SotmModElements instance) {
		super(instance, 579);
	}
