...
public class RoseWhiteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_white")
	public static final Block block = null;
	public RoseWhiteBlock(SotmModElements instance) {
		super(instance, 1873);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rose_white"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:rose_white"), configuredFeature);
		}
	}
	@SubscribeEvent
