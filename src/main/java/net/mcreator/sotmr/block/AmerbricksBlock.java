...
public class AmerbricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amerbricks")
	public static final Block block = null;
	public AmerbricksBlock(SotmModElements instance) {
		super(instance, 571);
	}
