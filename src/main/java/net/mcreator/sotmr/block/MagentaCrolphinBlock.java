...
public class MagentaCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:magenta_crolphin")
	public static final Block block = null;
	public MagentaCrolphinBlock(SotmModElements instance) {
		super(instance, 2239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magenta_crolphin");
		}
