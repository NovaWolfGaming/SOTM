...
public class BasaltBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basaltbrickslab")
	public static final Block block = null;
	public BasaltBrickSlabBlock(SotmModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("basaltbrickslab");
		}
