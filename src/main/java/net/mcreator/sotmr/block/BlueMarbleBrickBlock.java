...
public class BlueMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_marble_brick")
	public static final Block block = null;
	public BlueMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1450);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_marble_brick");
		}
