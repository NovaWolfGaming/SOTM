...
public class UnderworldGoldOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:underworldgoldore")
	public static final Block block = null;
	public UnderworldGoldOreBlock(SotmModElements instance) {
		super(instance, 31);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("underworldgoldore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:underworldgoldore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("underworldgoldore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:underworldgoldore"), configuredFeature);
		}
	}
	@SubscribeEvent
