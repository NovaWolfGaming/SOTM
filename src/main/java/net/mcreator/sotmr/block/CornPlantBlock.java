...
import net.mcreator.sotmr.item.CornItem;
...
public class CornPlantBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:corn_plant")
	public static final Block block = null;
	public CornPlantBlock(SotmModElements instance) {
		super(instance, 272);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("corn_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:corn_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CornItem.block, (int) (4)));
		}
