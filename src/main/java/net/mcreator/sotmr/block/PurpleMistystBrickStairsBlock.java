...
public class PurpleMistystBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_brick_stairs")
	public static final Block block = null;
	public PurpleMistystBrickStairsBlock(SotmModElements instance) {
		super(instance, 2682);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_brick_stairs");
		}
