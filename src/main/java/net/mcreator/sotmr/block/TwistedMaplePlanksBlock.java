...
public class TwistedMaplePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_planks")
	public static final Block block = null;
	public TwistedMaplePlanksBlock(SotmModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_planks");
		}
