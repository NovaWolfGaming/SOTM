...
public class BasaltSmoothStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basaltsmoothstairs")
	public static final Block block = null;
	public BasaltSmoothStairsBlock(SotmModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("basaltsmoothstairs");
		}
