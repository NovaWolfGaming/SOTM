...
public class VibrantGreenMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:vibrant_green_marble")
	public static final Block block = null;
	public VibrantGreenMarbleBlock(SotmModElements instance) {
		super(instance, 563);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vibrant_green_marble");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:vibrant_green_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("vibrant_green_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:vibrant_green_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
