...
public class BlackMushroomTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_trapdoor")
	public static final Block block = null;
	public BlackMushroomTrapdoorBlock(SotmModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_trapdoor");
		}
