...
public class VenorumChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_chiseled")
	public static final Block block = null;
	public VenorumChiseledBlock(SotmModElements instance) {
		super(instance, 522);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("venorum_chiseled");
		}
