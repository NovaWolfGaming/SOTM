...
public class PolishedBlackGrabiteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedblackgrabite")
	public static final Block block = null;
	public PolishedBlackGrabiteBlock(SotmModElements instance) {
		super(instance, 480);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedblackgrabite");
		}
