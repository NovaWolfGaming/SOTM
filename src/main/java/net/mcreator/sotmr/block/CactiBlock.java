...
import net.mcreator.sotmr.item.CactusFruitItem;
...
public class CactiBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cacti")
	public static final Block block = null;
	public CactiBlock(SotmModElements instance) {
		super(instance, 1332);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cacti"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:cacti"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("cacti");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CactusFruitItem.block, (int) (1)));
		}
