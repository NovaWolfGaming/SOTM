...
public class ChorusStoneTilesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone_tiles")
	public static final Block block = null;
	public ChorusStoneTilesBlock(SotmModElements instance) {
		super(instance, 589);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chorus_stone_tiles");
		}
