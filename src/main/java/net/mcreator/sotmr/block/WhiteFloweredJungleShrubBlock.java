...
public class WhiteFloweredJungleShrubBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_flowered_jungle_shrub")
	public static final Block block = null;
	public WhiteFloweredJungleShrubBlock(SotmModElements instance) {
		super(instance, 1786);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("white_flowered_jungle_shrub"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:white_flowered_jungle_shrub"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("white_flowered_jungle_shrub");
		}
