...
public class MarbleCreamyYellowBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow")
	public static final Block block = null;
	public MarbleCreamyYellowBlock(SotmModElements instance) {
		super(instance, 2501);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_creamy_yellow_match"), () -> CustomRuleTest.codec);
