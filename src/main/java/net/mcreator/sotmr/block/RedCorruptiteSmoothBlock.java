...
public class RedCorruptiteSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_corruptite_smooth")
	public static final Block block = null;
	public RedCorruptiteSmoothBlock(SotmModElements instance) {
		super(instance, 2730);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_corruptite_smooth");
		}
