...
public class BloodElderTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder_trapdoor")
	public static final Block block = null;
	public BloodElderTrapdoorBlock(SotmModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_elder_trapdoor");
		}
