...
public class RedMistystSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst_slab")
	public static final Block block = null;
	public RedMistystSlabBlock(SotmModElements instance) {
		super(instance, 2698);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("red_mistyst_slab");
		}
