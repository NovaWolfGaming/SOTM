...
public class BlubluhSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blubluh_slab")
	public static final Block block = null;
	public BlubluhSlabBlock(SotmModElements instance) {
		super(instance, 151);
	}
