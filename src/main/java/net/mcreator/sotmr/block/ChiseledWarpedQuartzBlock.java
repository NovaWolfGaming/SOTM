...
public class ChiseledWarpedQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_warped_quartz")
	public static final Block block = null;
	public ChiseledWarpedQuartzBlock(SotmModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_warped_quartz");
		}
