...
public class NetherLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nether_leaves")
	public static final Block block = null;
	public NetherLeavesBlock(SotmModElements instance) {
		super(instance, 1780);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("nether_leaves"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:nether_leaves"), configuredFeature);
		}
	}
	@SubscribeEvent
