...
public class MarbleCreamyYellowPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow_pillar")
	public static final Block block = null;
	public MarbleCreamyYellowPillarBlock(SotmModElements instance) {
		super(instance, 2505);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow_pillar");
		}
