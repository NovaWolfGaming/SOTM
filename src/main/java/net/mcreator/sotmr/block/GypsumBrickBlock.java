...
public class GypsumBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:gypsum_brick")
	public static final Block block = null;
	public GypsumBrickBlock(SotmModElements instance) {
		super(instance, 1709);
	}
