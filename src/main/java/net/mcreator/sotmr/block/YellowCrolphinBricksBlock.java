...
public class YellowCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:yellow_crolphin_bricks")
	public static final Block block = null;

	public YellowCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2317);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("yellow_crolphin_bricks");
		}
