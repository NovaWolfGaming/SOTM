...
public class EuphreliaStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:euphreliastairs")
	public static final Block block = null;
	public EuphreliaStairsBlock(SotmModElements instance) {
		super(instance, 221);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("euphreliastairs");
		}
