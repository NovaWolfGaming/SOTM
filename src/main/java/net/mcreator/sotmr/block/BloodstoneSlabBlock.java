...
public class BloodstoneSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bloodstoneslab")
	public static final Block block = null;
	public BloodstoneSlabBlock(SotmModElements instance) {
		super(instance, 164);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodstoneslab");
		}
