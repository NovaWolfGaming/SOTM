...
public class LightBlueCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_blue_crolphin")
	public static final Block block = null;
	public LightBlueCrolphinBlock(SotmModElements instance) {
		super(instance, 2245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_blue_crolphin");
		}
