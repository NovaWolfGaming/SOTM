...
public class SmoothedPolishedGraniteBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:smoothed_polished_granite")
	public static final Block block = null;

	public SmoothedPolishedGraniteBlock(SotmModElements instance) {
		super(instance, 2671);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("smoothed_polished_granite");
		}
