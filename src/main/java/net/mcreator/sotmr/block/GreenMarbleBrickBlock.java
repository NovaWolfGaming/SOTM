...
public class GreenMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_marble_brick")
	public static final Block block = null;
	public GreenMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1452);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_marble_brick");
		}
