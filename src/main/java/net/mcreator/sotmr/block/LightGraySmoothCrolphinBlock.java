...
public class LightGraySmoothCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:light_gray_smooth_crolphin")
	public static final Block block = null;

	public LightGraySmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2261);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_gray_smooth_crolphin");
		}
