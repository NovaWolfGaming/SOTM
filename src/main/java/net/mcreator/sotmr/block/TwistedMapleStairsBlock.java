...
public class TwistedMapleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_stairs")
	public static final Block block = null;
	public TwistedMapleStairsBlock(SotmModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_stairs");
		}
