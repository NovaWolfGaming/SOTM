...
public class CharredWeedsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:charred_weeds")
	public static final Block block = null;
	public CharredWeedsBlock(SotmModElements instance) {
		super(instance, 259);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("charred_weeds"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:charred_weeds"), configuredFeature);
		}
	}
	@SubscribeEvent
