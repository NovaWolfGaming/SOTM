...
public class CopperBarsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:copper_bars")
	public static final Block block = null;
	public CopperBarsBlock(SotmModElements instance) {
		super(instance, 2721);
	}
