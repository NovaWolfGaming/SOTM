...
public class MossyBirchPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_birch_planks")
	public static final Block block = null;

	public MossyBirchPlanksBlock(SotmModElements instance) {
		super(instance, 2592);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mossy_birch_planks");
		}
