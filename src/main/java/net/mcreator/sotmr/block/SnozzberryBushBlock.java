...
import net.mcreator.sotmr.item.SnozzberriesItem;
...
public class SnozzberryBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:snozzberrybush")
	public static final Block block = null;
	public SnozzberryBushBlock(SotmModElements instance) {
		super(instance, 278);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("snozzberrybush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:snozzberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("snozzberrybush");
		}

		@Override
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SnozzberriesItem.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SnozzberriesItem.block, (int) (3)));
		}
