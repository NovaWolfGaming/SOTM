...
public class FreesiaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:freesia")
	public static final Block block = null;
	public FreesiaBlock(SotmModElements instance) {
		super(instance, 1770);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("freesia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:freesia"), configuredFeature);
		}
	}
	@SubscribeEvent
