...
public class PurpleTulipBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_tulip")
	public static final Block block = null;
	public PurpleTulipBlock(SotmModElements instance) {
		super(instance, 268);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("purple_tulip"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:purple_tulip"), configuredFeature);
		}
	}
	@SubscribeEvent
