...
public class LimeCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lime_crolphin")
	public static final Block block = null;
	public LimeCrolphinBlock(SotmModElements instance) {
		super(instance, 2249);
	}
