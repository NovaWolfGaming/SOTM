...
public class DeepBlueMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_marble_stairs")
	public static final Block block = null;
	public DeepBlueMarbleStairsBlock(SotmModElements instance) {
		super(instance, 2548);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_marble_stairs");
		}
