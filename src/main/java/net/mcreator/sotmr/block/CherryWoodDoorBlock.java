...
public class CherryWoodDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_wood_door")
	public static final Block block = null;
	public CherryWoodDoorBlock(SotmModElements instance) {
		super(instance, 305);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("cherry_wood_door");
		}
