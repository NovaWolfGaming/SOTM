...
public class ChippedDarkOakPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_dark_oak_planks")
	public static final Block block = null;

	public ChippedDarkOakPlanksBlock(SotmModElements instance) {
		super(instance, 2599);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_dark_oak_planks");
		}
