...
public class WarpedQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warped_quartz_bricks")
	public static final Block block = null;
	public WarpedQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2014);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("warped_quartz_bricks");
		}
