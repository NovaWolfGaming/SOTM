...
import net.mcreator.sotmr.item.EyeItem;
...
public class NetherEyeStalksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nether_eye_stalks")
	public static final Block block = null;
	public NetherEyeStalksBlock(SotmModElements instance) {
		super(instance, 1767);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("nether_eye_stalks"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:nether_eye_stalks"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("nether_eye_stalks");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EyeItem.block, (int) (3)));
		}
