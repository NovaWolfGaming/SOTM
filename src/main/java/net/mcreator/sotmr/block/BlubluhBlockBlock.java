...
public class BlubluhBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blubluh_block")
	public static final Block block = null;
	public BlubluhBlockBlock(SotmModElements instance) {
		super(instance, 149);
	}
