...
public class WalnutWoodSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_slab")
	public static final Block block = null;
	public WalnutWoodSlabBlock(SotmModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("walnut_wood_slab");
		}
