...
public class MossySkarnBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_skarn_brick")
	public static final Block block = null;
	public MossySkarnBrickBlock(SotmModElements instance) {
		super(instance, 1689);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_skarn_brick");
		}
