...
public class MarbleCreamyYellowBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow_brick")
	public static final Block block = null;
	public MarbleCreamyYellowBrickBlock(SotmModElements instance) {
		super(instance, 2504);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow_brick");
		}
