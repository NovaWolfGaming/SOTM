...
public class WalnutWoodStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_wood_stairs")
	public static final Block block = null;
	public WalnutWoodStairsBlock(SotmModElements instance) {
		super(instance, 311);
	}
