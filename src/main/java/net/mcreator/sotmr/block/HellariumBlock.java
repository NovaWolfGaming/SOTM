...
public class HellariumBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:hellarium")
	public static final Block block = null;
	public HellariumBlock(SotmModElements instance) {
		super(instance, 1801);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("hellarium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:hellarium"), configuredFeature);
		}
	}
	@SubscribeEvent
