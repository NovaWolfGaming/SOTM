...
public class MossedStoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossed_stone")
	public static final Block block = null;
	public MossedStoneBlock(SotmModElements instance) {
		super(instance, 584);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:mossed_stone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("mossed_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:mossed_stone"), configuredFeature);
		}
	}
	@SubscribeEvent
