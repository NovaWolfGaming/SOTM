...
public class PurpleMistystBricksSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_bricks_slab")
	public static final Block block = null;
	public PurpleMistystBricksSlabBlock(SotmModElements instance) {
		super(instance, 2681);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_bricks_slab");
		}
