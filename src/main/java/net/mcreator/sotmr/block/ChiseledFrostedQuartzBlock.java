...
public class ChiseledFrostedQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_frosted_quartz")
	public static final Block block = null;
	public ChiseledFrostedQuartzBlock(SotmModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_frosted_quartz");
		}
