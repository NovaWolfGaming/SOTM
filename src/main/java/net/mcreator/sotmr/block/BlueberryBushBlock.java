...
import net.mcreator.sotmr.item.BlueberriesItem;
...
public class BlueberryBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blueberrybush")
	public static final Block block = null;
	public BlueberryBushBlock(SotmModElements instance) {
		super(instance, 274);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blueberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BlueberriesItem.block, (int) (1));
		}
