...
public class AssidiumWoodSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:assidium_wood_slab")
	public static final Block block = null;
	public AssidiumWoodSlabBlock(SotmModElements instance) {
		super(instance, 329);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("assidium_wood_slab");
		}
