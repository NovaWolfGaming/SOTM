...
public class UnderworldMudBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:underworld_mud")
	public static final Block block = null;
	public UnderworldMudBlock(SotmModElements instance) {
		super(instance, 66);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("underworld_mud");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:underworld_mud_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("underworld_mud"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:underworld_mud"), configuredFeature);
		}
	}
	@SubscribeEvent
