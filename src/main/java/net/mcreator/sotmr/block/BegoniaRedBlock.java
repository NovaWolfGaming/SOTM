...
public class BegoniaRedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia_red")
	public static final Block block = null;
	public BegoniaRedBlock(SotmModElements instance) {
		super(instance, 1854);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia_red"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia_red"), configuredFeature);
		}
	}
	@SubscribeEvent
