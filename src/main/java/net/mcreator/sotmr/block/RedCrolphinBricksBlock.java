...
public class RedCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:red_crolphin_bricks")
	public static final Block block = null;

	public RedCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2299);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("red_crolphin_bricks");
		}
