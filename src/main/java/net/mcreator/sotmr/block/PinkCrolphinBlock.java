...
public class PinkCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_crolphin")
	public static final Block block = null;
	public PinkCrolphinBlock(SotmModElements instance) {
		super(instance, 2237);
	}
