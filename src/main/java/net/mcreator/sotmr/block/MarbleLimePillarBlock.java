...
public class MarbleLimePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime_pillar")
	public static final Block block = null;
	public MarbleLimePillarBlock(SotmModElements instance) {
		super(instance, 2477);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_lime_pillar");
		}
