...
public class PinkMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_marble_pillar")
	public static final Block block = null;
	public PinkMarblePillarBlock(SotmModElements instance) {
		super(instance, 1469);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_marble_pillar");
		}
