...
public class GreenMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_marble")
	public static final Block block = null;
	public GreenMarbleBlock(SotmModElements instance) {
		super(instance, 554);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:green_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("green_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:green_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
