...
public class FieryShnylliumLeavesBlock extends SotmModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:fiery_shnyllium_leaves_match"),
			...
			event.getRegistry().register(feature.setRegistryName("fiery_shnyllium_leaves"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:fiery_shnyllium_leaves"), configuredFeature);
		}
	}
	@SubscribeEvent
