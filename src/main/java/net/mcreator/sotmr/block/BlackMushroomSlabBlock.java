...
public class BlackMushroomSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_slab")
	public static final Block block = null;
	public BlackMushroomSlabBlock(SotmModElements instance) {
		super(instance, 241);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_slab");
		}
