...
public class CrystalineSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystalineslab")
	public static final Block block = null;
	public CrystalineSlabBlock(SotmModElements instance) {
		super(instance, 167);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("crystalineslab");
		}
