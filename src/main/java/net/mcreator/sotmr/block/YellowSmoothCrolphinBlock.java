...
public class YellowSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_smooth_crolphin")
	public static final Block block = null;
	public YellowSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2285);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_smooth_crolphin");
		}
