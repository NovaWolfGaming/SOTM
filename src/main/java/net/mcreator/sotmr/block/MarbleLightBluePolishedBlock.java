...
public class MarbleLightBluePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue_polished")
	public static final Block block = null;
	public MarbleLightBluePolishedBlock(SotmModElements instance) {
		super(instance, 2432);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue_polished");
		}
