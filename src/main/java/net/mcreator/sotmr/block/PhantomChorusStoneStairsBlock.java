...
public class PhantomChorusStoneStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:phantom_chorus_stone_stairs")
	public static final Block block = null;
	public PhantomChorusStoneStairsBlock(SotmModElements instance) {
		super(instance, 1746);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("phantom_chorus_stone_stairs");
		}
