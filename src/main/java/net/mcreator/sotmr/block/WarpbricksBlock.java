...
public class WarpbricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warpbricks")
	public static final Block block = null;
	public WarpbricksBlock(SotmModElements instance) {
		super(instance, 581);
	}
