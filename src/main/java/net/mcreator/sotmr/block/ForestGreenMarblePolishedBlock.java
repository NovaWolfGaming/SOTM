...
public class ForestGreenMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble_polished")
	public static final Block block = null;
	public ForestGreenMarblePolishedBlock(SotmModElements instance) {
		super(instance, 2558);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble_polished");
		}
