...
public class DewYellowMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble_brick")
	public static final Block block = null;
	public DewYellowMarbleBrickBlock(SotmModElements instance) {
		super(instance, 2518);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble_brick");
		}
