...
public class BlackGranitePanelBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:black_granite_panel")
	public static final Block block = null;

	public BlackGranitePanelBlock(SotmModElements instance) {
		super(instance, 2578);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_granite_panel");
		}
