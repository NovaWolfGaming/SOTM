...
public class BambooThatchBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bamboo_thatch")
	public static final Block block = null;
	public BambooThatchBlock(SotmModElements instance) {
		super(instance, 1666);
	}
