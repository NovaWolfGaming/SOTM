...
public class BlackMistystBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst")
	public static final Block block = null;
	public BlackMistystBlock(SotmModElements instance) {
		super(instance, 2706);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:black_mistyst_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("black_mistyst"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:black_mistyst"), configuredFeature);
		}
	}
	@SubscribeEvent
