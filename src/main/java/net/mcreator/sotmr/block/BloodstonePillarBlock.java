...
public class BloodstonePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bloodstonepillar")
	public static final Block block = null;
	public BloodstonePillarBlock(SotmModElements instance) {
		super(instance, 485);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bloodstonepillar");
		}
