...
public class OrangeyRedMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble_slab")
	public static final Block block = null;
	public OrangeyRedMarbleSlabBlock(SotmModElements instance) {
		super(instance, 2535);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble_slab");
		}
