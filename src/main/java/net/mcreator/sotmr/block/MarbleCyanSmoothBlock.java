...
public class MarbleCyanSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_cyan_smooth")
	public static final Block block = null;
	public MarbleCyanSmoothBlock(SotmModElements instance) {
		super(instance, 2391);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_cyan_smooth");
		}
