...
public class CrystalineblockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystalineblock")
	public static final Block block = null;
	public CrystalineblockBlock(SotmModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystalineblock");
		}
