...
public class Spotted_AshwoodLogBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_log")
	public static final Block block = null;
	public Spotted_AshwoodLogBlock(SotmModElements instance) {
		super(instance, 1413);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_log");
		}
