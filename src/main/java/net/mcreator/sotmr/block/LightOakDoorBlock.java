...
public class LightOakDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_oak_door")
	public static final Block block = null;
	public LightOakDoorBlock(SotmModElements instance) {
		super(instance, 227);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("light_oak_door");
		}
