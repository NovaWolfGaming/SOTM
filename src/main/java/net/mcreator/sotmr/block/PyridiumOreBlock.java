...
import net.mcreator.sotmr.item.PyridiumGemItem;
...
public class PyridiumOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pyridium_ore")
	public static final Block block = null;
	public PyridiumOreBlock(SotmModElements instance) {
		super(instance, 26);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PyridiumGemItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:pyridium_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("pyridium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pyridium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
