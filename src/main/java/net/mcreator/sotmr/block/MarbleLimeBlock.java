...
public class MarbleLimeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime")
	public static final Block block = null;
	public MarbleLimeBlock(SotmModElements instance) {
		super(instance, 2473);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_lime_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_lime"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_lime"), configuredFeature);
		}
	}
	@SubscribeEvent
