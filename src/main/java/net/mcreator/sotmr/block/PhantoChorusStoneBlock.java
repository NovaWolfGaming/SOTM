...
public class PhantoChorusStoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:phanto_chorus_stone")
	public static final Block block = null;
	public PhantoChorusStoneBlock(SotmModElements instance) {
		super(instance, 1737);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("phanto_chorus_stone");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:phanto_chorus_stone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("phanto_chorus_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:phanto_chorus_stone"), configuredFeature);
		}
	}
	@SubscribeEvent
