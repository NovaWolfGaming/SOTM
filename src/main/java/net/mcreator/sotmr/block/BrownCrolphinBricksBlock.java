...
public class BrownCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:brown_crolphin_bricks")
	public static final Block block = null;

	public BrownCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2321);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("brown_crolphin_bricks");
		}
