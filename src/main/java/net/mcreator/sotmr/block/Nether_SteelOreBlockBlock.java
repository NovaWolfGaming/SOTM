...
public class Nether_SteelOreBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nether_steel_ore_block")
	public static final Block block = null;
	public Nether_SteelOreBlockBlock(SotmModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nether_steel_ore_block");
		}
