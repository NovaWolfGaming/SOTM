...
public class ForestGreenMarbleSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble_smooth")
	public static final Block block = null;
	public ForestGreenMarbleSmoothBlock(SotmModElements instance) {
		super(instance, 2559);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble_smooth");
		}
