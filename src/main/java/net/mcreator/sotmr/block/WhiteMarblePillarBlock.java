...
public class WhiteMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_marble_pillar")
	public static final Block block = null;
	public WhiteMarblePillarBlock(SotmModElements instance) {
		super(instance, 1466);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_marble_pillar");
		}
