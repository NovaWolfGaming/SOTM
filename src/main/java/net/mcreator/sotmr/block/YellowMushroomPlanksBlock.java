...
public class YellowMushroomPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_planks")
	public static final Block block = null;
	public YellowMushroomPlanksBlock(SotmModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom_planks");
		}
