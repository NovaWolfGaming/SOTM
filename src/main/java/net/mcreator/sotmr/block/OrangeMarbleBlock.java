...
public class OrangeMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble")
	public static final Block block = null;
	public OrangeMarbleBlock(SotmModElements instance) {
		super(instance, 560);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:orange_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("orange_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:orange_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
