...
public class WhiteGranitePanelBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_granite_panel")
	public static final Block block = null;
	public WhiteGranitePanelBlock(SotmModElements instance) {
		super(instance, 2580);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_granite_panel");
		}
