...
public class NetheShrubBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nethe_shrub")
	public static final Block block = null;
	public NetheShrubBlock(SotmModElements instance) {
		super(instance, 1785);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("nethe_shrub"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:nethe_shrub"), configuredFeature);
		}
	}
	@SubscribeEvent
