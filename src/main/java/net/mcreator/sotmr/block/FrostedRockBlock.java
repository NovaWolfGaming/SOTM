...
public class FrostedRockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_rock")
	public static final Block block = null;
	public FrostedRockBlock(SotmModElements instance) {
		super(instance, 549);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:frosted_rock_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("frosted_rock"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:frosted_rock"), configuredFeature);
		}
	}
	@SubscribeEvent
