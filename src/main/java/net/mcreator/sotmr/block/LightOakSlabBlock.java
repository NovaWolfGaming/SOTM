...
public class LightOakSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_oak_slab")
	public static final Block block = null;
	public LightOakSlabBlock(SotmModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("light_oak_slab");
		}
