...
public class Crystone_GoldBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystone_gold_block")
	public static final Block block = null;
	public Crystone_GoldBlockBlock(SotmModElements instance) {
		super(instance, 2063);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystone_gold_block");
		}
