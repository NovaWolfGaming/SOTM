...
public class LavastoneSmoothStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lavastone_smooth_stairs")
	public static final Block block = null;
	public LavastoneSmoothStairsBlock(SotmModElements instance) {
		super(instance, 195);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lavastone_smooth_stairs");
		}
