...
public class WarpedNetherbrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warped_netherbrick")
	public static final Block block = null;
	public WarpedNetherbrickBlock(SotmModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("warped_netherbrick");
		}
