...
public class BlueTulipBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_tulip")
	public static final Block block = null;
	public BlueTulipBlock(SotmModElements instance) {
		super(instance, 269);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blue_tulip"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blue_tulip"), configuredFeature);
		}
	}
	@SubscribeEvent
