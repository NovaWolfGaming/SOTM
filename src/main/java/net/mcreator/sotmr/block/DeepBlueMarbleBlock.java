...
public class DeepBlueMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_marble")
	public static final Block block = null;
	public DeepBlueMarbleBlock(SotmModElements instance) {
		super(instance, 2543);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_marble");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:deep_blue_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("deep_blue_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:deep_blue_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
