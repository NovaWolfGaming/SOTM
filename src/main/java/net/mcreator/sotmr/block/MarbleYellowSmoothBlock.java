...
public class MarbleYellowSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow_smooth")
	public static final Block block = null;
	public MarbleYellowSmoothBlock(SotmModElements instance) {
		super(instance, 2377);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_yellow_smooth");
		}
