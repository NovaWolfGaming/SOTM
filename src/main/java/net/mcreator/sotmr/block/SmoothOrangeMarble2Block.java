...
public class SmoothOrangeMarble2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_orange_marble_2")
	public static final Block block = null;
	public SmoothOrangeMarble2Block(SotmModElements instance) {
		super(instance, 1445);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_orange_marble_2");
		}
