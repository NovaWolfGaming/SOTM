...
public class OrangeMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_brick")
	public static final Block block = null;
	public OrangeMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1456);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_brick");
		}
