...
public class SproutingSyringaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sprouting_syringa")
	public static final Block block = null;
	public SproutingSyringaBlock(SotmModElements instance) {
		super(instance, 1768);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sprouting_syringa"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sprouting_syringa"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("sprouting_syringa");
		}
