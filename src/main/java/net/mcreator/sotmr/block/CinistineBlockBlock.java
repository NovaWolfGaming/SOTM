...
public class CinistineBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cinistineblock")
	public static final Block block = null;
	public CinistineBlockBlock(SotmModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cinistineblock");
		}
