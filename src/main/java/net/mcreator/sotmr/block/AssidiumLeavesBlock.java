...
public class AssidiumLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:assidium_leaves")
	public static final Block block = null;
	public AssidiumLeavesBlock(SotmModElements instance) {
		super(instance, 333);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("assidium_leaves");
		}
