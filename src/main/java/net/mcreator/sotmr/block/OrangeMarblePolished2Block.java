...
public class OrangeMarblePolished2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_polished_2")
	public static final Block block = null;
	public OrangeMarblePolished2Block(SotmModElements instance) {
		super(instance, 1444);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_polished_2");
		}
