...
public class DewYellowMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble_polished")
	public static final Block block = null;
	public DewYellowMarblePolishedBlock(SotmModElements instance) {
		super(instance, 2516);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble_polished");
		}
