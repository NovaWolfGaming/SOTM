...
public class MarbleLightBlueBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue_brick")
	public static final Block block = null;
	public MarbleLightBlueBrickBlock(SotmModElements instance) {
		super(instance, 2434);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue_brick");
		}
