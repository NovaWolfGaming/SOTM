...
public class TroddenFlowerBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:trodden_flower")
	public static final Block block = null;
	public TroddenFlowerBlock(SotmModElements instance) {
		super(instance, 317);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("trodden_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:trodden_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("trodden_flower");
		}
