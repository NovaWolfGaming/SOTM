...
public class BlackstoneBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstonebrickslab")
	public static final Block block = null;
	public BlackstoneBrickSlabBlock(SotmModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstonebrickslab");
		}
