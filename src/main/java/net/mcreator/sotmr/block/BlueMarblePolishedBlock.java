...
public class BlueMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_marble_polished")
	public static final Block block = null;
	public BlueMarblePolishedBlock(SotmModElements instance) {
		super(instance, 552);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_marble_polished");
		}
