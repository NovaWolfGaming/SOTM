...
public class CoesiteGlassBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:coesite_glass")
	public static final Block block = null;
	public CoesiteGlassBlock(SotmModElements instance) {
		super(instance, 287);
	}
