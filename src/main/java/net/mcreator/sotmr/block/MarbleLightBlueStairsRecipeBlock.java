...
public class MarbleLightBlueStairsRecipeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue_stairs_recipe")
	public static final Block block = null;
	public MarbleLightBlueStairsRecipeBlock(SotmModElements instance) {
		super(instance, 2436);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue_stairs_recipe");
		}
