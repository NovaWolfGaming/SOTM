...
public class NetherstoneSmoothStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:netherstone_smooth_stairs")
	public static final Block block = null;
	public NetherstoneSmoothStairsBlock(SotmModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("netherstone_smooth_stairs");
		}
