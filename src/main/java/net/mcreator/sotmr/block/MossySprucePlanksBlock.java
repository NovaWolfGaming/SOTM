...
public class MossySprucePlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_spruce_planks")
	public static final Block block = null;
	public MossySprucePlanksBlock(SotmModElements instance) {
		super(instance, 2601);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_spruce_planks");
		}
