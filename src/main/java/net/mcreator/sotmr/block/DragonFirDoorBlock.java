...
public class DragonFirDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_door")
	public static final Block block = null;
	public DragonFirDoorBlock(SotmModElements instance) {
		super(instance, 226);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_door");
		}
