...
public class BegoniaOrangeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia_orange")
	public static final Block block = null;
	public BegoniaOrangeBlock(SotmModElements instance) {
		super(instance, 1857);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia_orange"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia_orange"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("begonia_orange");
		}
