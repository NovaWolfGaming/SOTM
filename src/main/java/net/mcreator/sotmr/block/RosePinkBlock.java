...
public class RosePinkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_pink")
	public static final Block block = null;
	public RosePinkBlock(SotmModElements instance) {
		super(instance, 1869);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rose_pink"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:rose_pink"), configuredFeature);
		}
	}
	@SubscribeEvent
