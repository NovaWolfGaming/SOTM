...
public class BlackMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_marble_slab")
	public static final Block block = null;
	public BlackMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1474);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_marble_slab");
		}
