...
public class DarkQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:darkquartzblock")
	public static final Block block = null;
	public DarkQuartzBlockBlock(SotmModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkquartzblock");
		}
