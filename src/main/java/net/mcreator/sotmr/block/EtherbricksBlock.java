...
public class EtherbricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:etherbricks")
	public static final Block block = null;
	public EtherbricksBlock(SotmModElements instance) {
		super(instance, 577);
	}
