...
public class SulphurQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphur_quartz_bricks")
	public static final Block block = null;
	public SulphurQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2010);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sulphur_quartz_bricks");
		}
