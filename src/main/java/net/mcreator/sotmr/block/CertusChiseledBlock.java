...
public class CertusChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:certuschiseled")
	public static final Block block = null;
	public CertusChiseledBlock(SotmModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("certuschiseled");
		}
