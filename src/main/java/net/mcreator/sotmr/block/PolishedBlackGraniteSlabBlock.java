...
public class PolishedBlackGraniteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedblackgraniteslab")
	public static final Block block = null;
	public PolishedBlackGraniteSlabBlock(SotmModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedblackgraniteslab");
		}
