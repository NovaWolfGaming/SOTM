...
public class OrangeMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_stairs")
	public static final Block block = null;
	public OrangeMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1487);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_stairs");
		}
