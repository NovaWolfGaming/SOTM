...
public class CarboriteBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carboritebrickstairs")
	public static final Block block = null;
	public CarboriteBrickStairsBlock(SotmModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("carboritebrickstairs");
		}
