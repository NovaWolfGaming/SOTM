...
public class PinkPoppyBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_poppy")
	public static final Block block = null;
	public PinkPoppyBlock(SotmModElements instance) {
		super(instance, 325);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pink_poppy"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pink_poppy"), configuredFeature);
		}
	}
	@SubscribeEvent
