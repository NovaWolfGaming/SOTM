...
public class YellowMushroomTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_trapdoor")
	public static final Block block = null;
	public YellowMushroomTrapdoorBlock(SotmModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom_trapdoor");
		}
