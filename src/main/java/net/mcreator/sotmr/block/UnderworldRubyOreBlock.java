...
public class UnderworldRubyOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:underworldrubyore")
	public static final Block block = null;
	public UnderworldRubyOreBlock(SotmModElements instance) {
		super(instance, 37);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("underworldrubyore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:underworldrubyore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("underworldrubyore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:underworldrubyore"), configuredFeature);
		}
	}
	@SubscribeEvent
