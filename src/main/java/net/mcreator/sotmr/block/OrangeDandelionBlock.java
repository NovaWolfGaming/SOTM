...
public class OrangeDandelionBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_dandelion")
	public static final Block block = null;
	public OrangeDandelionBlock(SotmModElements instance) {
		super(instance, 264);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("orange_dandelion"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:orange_dandelion"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("orange_dandelion");
		}
