...
public class DarkQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:darkquartzpillar")
	public static final Block block = null;
	public DarkQuartzPillarBlock(SotmModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkquartzpillar");
		}
