...
import net.mcreator.sotmr.procedures.SOTMAdvancmentProcedure;
...
public class SpikesBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spikes_block")
	public static final Block block = null;
	public SpikesBlockBlock(SotmModElements instance) {
		super(instance, 1732);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				SOTMAdvancmentProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
