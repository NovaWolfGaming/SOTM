...
public class LightOakStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_oak_stairs")
	public static final Block block = null;
	public LightOakStairsBlock(SotmModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("light_oak_stairs");
		}
