...
public class CarbonSandBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carbonsand")
	public static final Block block = null;
	public CarbonSandBlock(SotmModElements instance) {
		super(instance, 108);
	}
