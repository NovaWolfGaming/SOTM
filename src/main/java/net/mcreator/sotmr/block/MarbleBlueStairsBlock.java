...
public class MarbleBlueStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_blue_stairs")
	public static final Block block = null;
	public MarbleBlueStairsBlock(SotmModElements instance) {
		super(instance, 2394);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_blue_stairs");
		}
