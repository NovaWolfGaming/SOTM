...
public class LightGrayCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:light_gray_crolphin_bricks")
	public static final Block block = null;

	public LightGrayCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2293);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_gray_crolphin_bricks");
		}
