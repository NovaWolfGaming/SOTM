...
public class CarbonSmoothSandstoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carbonsmoothsandstone")
	public static final Block block = null;
	public CarbonSmoothSandstoneBlock(SotmModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carbonsmoothsandstone");
		}
