...
public class RedMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_marble_pillar")
	public static final Block block = null;
	public RedMarblePillarBlock(SotmModElements instance) {
		super(instance, 1470);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("red_marble_pillar");
		}
