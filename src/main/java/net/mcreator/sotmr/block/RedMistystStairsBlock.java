...
public class RedMistystStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst_stairs")
	public static final Block block = null;
	public RedMistystStairsBlock(SotmModElements instance) {
		super(instance, 2696);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_mistyst_stairs");
		}
