...
public class VenorumSmoothStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_smooth_stairs")
	public static final Block block = null;
	public VenorumSmoothStairsBlock(SotmModElements instance) {
		super(instance, 197);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("venorum_smooth_stairs");
		}
