...
import net.mcreator.sotmr.item.ElderBerriesItem;
...
public class ElderBerryBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:elder_berry_bush")
	public static final Block block = null;
	public ElderBerryBushBlock(SotmModElements instance) {
		super(instance, 1523);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("elder_berry_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:elder_berry_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("elder_berry_bush");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ElderBerriesItem.block, (int) (2)));
		}
