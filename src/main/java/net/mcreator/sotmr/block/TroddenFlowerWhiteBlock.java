...
public class TroddenFlowerWhiteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:trodden_flower_white")
	public static final Block block = null;
	public TroddenFlowerWhiteBlock(SotmModElements instance) {
		super(instance, 1758);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("trodden_flower_white"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:trodden_flower_white"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("trodden_flower_white");
		}
