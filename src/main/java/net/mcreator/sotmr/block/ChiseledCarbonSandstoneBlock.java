...
public class ChiseledCarbonSandstoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseledcarbonsandstone")
	public static final Block block = null;
	public ChiseledCarbonSandstoneBlock(SotmModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseledcarbonsandstone");
		}
