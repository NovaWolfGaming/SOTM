...
public class RedStarClusterBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_star_cluster")
	public static final Block block = null;
	public RedStarClusterBlock(SotmModElements instance) {
		super(instance, 1875);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_star_cluster"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:red_star_cluster"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("red_star_cluster");
		}
