...
public class MarblePinkyRedSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red_slab")
	public static final Block block = null;
	public MarblePinkyRedSlabBlock(SotmModElements instance) {
		super(instance, 2423);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red_slab");
		}
