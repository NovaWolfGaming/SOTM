...
public class PurpleMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_marble_pillar")
	public static final Block block = null;
	public PurpleMarblePillarBlock(SotmModElements instance) {
		super(instance, 1471);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("purple_marble_pillar");
		}
