...
public class BlueMistystBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst_brick")
	public static final Block block = null;
	public BlueMistystBrickBlock(SotmModElements instance) {
		super(instance, 529);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_mistyst_brick");
		}
