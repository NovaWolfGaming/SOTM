...
public class PinkMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_marble_stairs")
	public static final Block block = null;
	public PinkMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1481);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pink_marble_stairs");
		}
