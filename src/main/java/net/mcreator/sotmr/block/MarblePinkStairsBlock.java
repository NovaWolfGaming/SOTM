...
public class MarblePinkStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pink_stairs")
	public static final Block block = null;
	public MarblePinkStairsBlock(SotmModElements instance) {
		super(instance, 2366);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_pink_stairs");
		}
