...
public class CherryWoodStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_wood_stairs")
	public static final Block block = null;
	public CherryWoodStairsBlock(SotmModElements instance) {
		super(instance, 302);
	}
