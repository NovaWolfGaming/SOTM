...
public class CopperOreBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:copperoreblock")
	public static final Block block = null;
	public CopperOreBlockBlock(SotmModElements instance) {
		super(instance, 41);
	}
