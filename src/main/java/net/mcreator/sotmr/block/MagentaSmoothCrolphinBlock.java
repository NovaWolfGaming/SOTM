...
public class MagentaSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:magenta_smooth_crolphin")
	public static final Block block = null;
	public MagentaSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2271);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magenta_smooth_crolphin");
		}
