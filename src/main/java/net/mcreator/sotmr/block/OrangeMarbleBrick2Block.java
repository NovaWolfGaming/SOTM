...
public class OrangeMarbleBrick2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_brick_2")
	public static final Block block = null;
	public OrangeMarbleBrick2Block(SotmModElements instance) {
		super(instance, 1460);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_brick_2");
		}
