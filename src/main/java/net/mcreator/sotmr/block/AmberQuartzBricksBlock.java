...
public class AmberQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amber_quartz_bricks")
	public static final Block block = null;
	public AmberQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2002);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amber_quartz_bricks");
		}
