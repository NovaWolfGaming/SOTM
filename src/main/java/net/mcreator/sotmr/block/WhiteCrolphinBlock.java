...
public class WhiteCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_crolphin")
	public static final Block block = null;
	public WhiteCrolphinBlock(SotmModElements instance) {
		super(instance, 2226);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_crolphin");
		}
