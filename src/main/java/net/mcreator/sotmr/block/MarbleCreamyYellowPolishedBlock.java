...
public class MarbleCreamyYellowPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow_polished")
	public static final Block block = null;
	public MarbleCreamyYellowPolishedBlock(SotmModElements instance) {
		super(instance, 2502);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow_polished");
		}
