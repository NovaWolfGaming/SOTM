...
public class MarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble")
	public static final Block block = null;
	public MarbleBlock(SotmModElements instance) {
		super(instance, 504);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble"), configuredFeature);
		}
	}
	@SubscribeEvent
