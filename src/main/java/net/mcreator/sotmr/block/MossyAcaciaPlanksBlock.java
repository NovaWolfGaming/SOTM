...
public class MossyAcaciaPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_acacia_planks")
	public static final Block block = null;

	public MossyAcaciaPlanksBlock(SotmModElements instance) {
		super(instance, 2609);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mossy_acacia_planks");
		}
