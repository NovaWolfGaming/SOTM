...
public class CobblestoneDoorRecipeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cobblestone_door_recipe")
	public static final Block block = null;
	public CobblestoneDoorRecipeBlock(SotmModElements instance) {
		super(instance, 471);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_door_recipe");
		}
