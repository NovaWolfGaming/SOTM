...
public class CryphiliumrockyBlock extends SotmModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:cryphiliumrocky_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 20)).range(124)
					.square().func_242731_b(20);
			event.getRegistry().register(feature.setRegistryName("cryphiliumrocky"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:cryphiliumrocky"), configuredFeature);
		}
	}
	@SubscribeEvent
