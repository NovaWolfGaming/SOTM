...
public class FrostedCrystalineStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_crystaline_stairs")
	public static final Block block = null;
	public FrostedCrystalineStairsBlock(SotmModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("frosted_crystaline_stairs");
		}
