...
public class SulphurQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphur_quartz_block")
	public static final Block block = null;
	public SulphurQuartzBlockBlock(SotmModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sulphur_quartz_block");
		}
