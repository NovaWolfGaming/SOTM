...
public class WarpedQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warped_quartz_pillar")
	public static final Block block = null;
	public WarpedQuartzPillarBlock(SotmModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("warped_quartz_pillar");
		}
