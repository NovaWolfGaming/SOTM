...
public class LightOakWoodBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lightoakwood")
	public static final Block block = null;
	public LightOakWoodBlock(SotmModElements instance) {
		super(instance, 94);
	}
