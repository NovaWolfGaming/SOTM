...
public class Spotted_AshwoodSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_slab")
	public static final Block block = null;
	public Spotted_AshwoodSlabBlock(SotmModElements instance) {
		super(instance, 1417);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_slab");
		}
