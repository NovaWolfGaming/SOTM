...
public class RedMistystBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst_brick")
	public static final Block block = null;
	public RedMistystBrickBlock(SotmModElements instance) {
		super(instance, 2700);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_mistyst_brick");
		}
