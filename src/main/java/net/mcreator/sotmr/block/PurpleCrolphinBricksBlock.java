...
public class PurpleCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:purple_crolphin_bricks")
	public static final Block block = null;

	public PurpleCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2305);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("purple_crolphin_bricks");
		}
