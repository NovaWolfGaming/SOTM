...
public class BlueMistystChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst_chiseled")
	public static final Block block = null;
	public BlueMistystChiseledBlock(SotmModElements instance) {
		super(instance, 540);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_mistyst_chiseled");
		}
