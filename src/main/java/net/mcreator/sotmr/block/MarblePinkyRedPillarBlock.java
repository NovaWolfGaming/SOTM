...
public class MarblePinkyRedPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red_pillar")
	public static final Block block = null;
	public MarblePinkyRedPillarBlock(SotmModElements instance) {
		super(instance, 2421);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red_pillar");
		}
