...
public class MarbleCreamyYellowSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow_smooth")
	public static final Block block = null;
	public MarbleCreamyYellowSmoothBlock(SotmModElements instance) {
		super(instance, 2503);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow_smooth");
		}
