...
public class CrackedSkarnBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cracked_skarn_brick")
	public static final Block block = null;
	public CrackedSkarnBrickBlock(SotmModElements instance) {
		super(instance, 1687);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cracked_skarn_brick");
		}
