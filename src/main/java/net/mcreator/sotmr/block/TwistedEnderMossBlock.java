...
public class TwistedEnderMossBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_ender_moss")
	public static final Block block = null;
	public TwistedEnderMossBlock(SotmModElements instance) {
		super(instance, 148);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("twisted_ender_moss");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:twisted_ender_moss_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("twisted_ender_moss"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:twisted_ender_moss"), configuredFeature);
		}
	}
	@SubscribeEvent
