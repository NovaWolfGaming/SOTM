...
public class DeepBlueMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_marble_brick")
	public static final Block block = null;
	public DeepBlueMarbleBrickBlock(SotmModElements instance) {
		super(instance, 2546);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_marble_brick");
		}
