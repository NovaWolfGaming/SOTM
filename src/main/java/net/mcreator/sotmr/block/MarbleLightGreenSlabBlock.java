...
public class MarbleLightGreenSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green_slab")
	public static final Block block = null;
	public MarbleLightGreenSlabBlock(SotmModElements instance) {
		super(instance, 2465);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_light_green_slab");
		}
