...
public class BlackMushroomPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_planks")
	public static final Block block = null;
	public BlackMushroomPlanksBlock(SotmModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_planks");
		}
