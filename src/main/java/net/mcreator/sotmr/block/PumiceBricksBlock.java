...
public class PumiceBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pumice_bricks")
	public static final Block block = null;
	public PumiceBricksBlock(SotmModElements instance) {
		super(instance, 513);
	}
