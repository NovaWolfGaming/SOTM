...
public class BlackMushroomFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_fence")
	public static final Block block = null;
	public BlackMushroomFenceBlock(SotmModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_fence");
		}
