...
public class RedMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_marble_stairs")
	public static final Block block = null;
	public RedMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1483);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_marble_stairs");
		}
