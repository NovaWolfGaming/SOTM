...
public class MonochromeWoodStairsBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:monochrome_wood_stairs")
	public static final Block block = null;

	public MonochromeWoodStairsBlock(SotmModElements instance) {
		super(instance, 2202);
	...
	public static class CustomBlock extends StairsBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("monochrome_wood_stairs");
		}
