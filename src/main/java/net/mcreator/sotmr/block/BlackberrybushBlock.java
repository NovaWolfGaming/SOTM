...
import net.mcreator.sotmr.item.BlackberriesItem;
...
public class BlackberrybushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackberrybush")
	public static final Block block = null;
	public BlackberrybushBlock(SotmModElements instance) {
		super(instance, 273);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blackberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BlackberriesItem.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BlackberriesItem.block, (int) (3)));
		}
