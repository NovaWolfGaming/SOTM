...
public class MableGrayPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mable_gray_polished")
	public static final Block block = null;
	public MableGrayPolishedBlock(SotmModElements instance) {
		super(instance, 2446);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mable_gray_polished");
		}
