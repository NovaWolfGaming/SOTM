...
public class ChalkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chalk")
	public static final Block block = null;
	public ChalkBlock(SotmModElements instance) {
		super(instance, 590);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:chalk_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("chalk"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:chalk"), configuredFeature);
		}
	}
	@SubscribeEvent
