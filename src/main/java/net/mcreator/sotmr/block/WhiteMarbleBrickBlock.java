...
public class WhiteMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_marble_brick")
	public static final Block block = null;
	public WhiteMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1448);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_marble_brick");
		}
