...
public class ChippedBirchPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_birch_planks")
	public static final Block block = null;

	public ChippedBirchPlanksBlock(SotmModElements instance) {
		super(instance, 2595);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_birch_planks");
		}
