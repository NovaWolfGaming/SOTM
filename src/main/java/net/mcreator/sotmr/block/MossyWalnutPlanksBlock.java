...
public class MossyWalnutPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_walnut_planks")
	public static final Block block = null;

	public MossyWalnutPlanksBlock(SotmModElements instance) {
		super(instance, 2625);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mossy_walnut_planks");
		}
