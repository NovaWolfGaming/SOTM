...
public class DragonFirFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_fence")
	public static final Block block = null;
	public DragonFirFenceBlock(SotmModElements instance) {
		super(instance, 214);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_fence");
		}
