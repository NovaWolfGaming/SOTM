...
public class SmoothBlueMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_blue_marble")
	public static final Block block = null;
	public SmoothBlueMarbleBlock(SotmModElements instance) {
		super(instance, 553);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_blue_marble");
		}
