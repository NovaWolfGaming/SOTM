...
public class BloodElderStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder_stairs")
	public static final Block block = null;
	public BloodElderStairsBlock(SotmModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_elder_stairs");
		}
