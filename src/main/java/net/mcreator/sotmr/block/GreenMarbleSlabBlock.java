...
public class GreenMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_marble_slab")
	public static final Block block = null;
	public GreenMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1480);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("green_marble_slab");
		}
