...
public class RedCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_crolphin")
	public static final Block block = null;
	public RedCrolphinBlock(SotmModElements instance) {
		super(instance, 2235);
	}
