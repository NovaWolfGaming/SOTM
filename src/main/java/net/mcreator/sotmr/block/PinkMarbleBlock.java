...
public class PinkMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_marble")
	public static final Block block = null;
	public PinkMarbleBlock(SotmModElements instance) {
		super(instance, 557);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:pink_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("pink_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pink_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
