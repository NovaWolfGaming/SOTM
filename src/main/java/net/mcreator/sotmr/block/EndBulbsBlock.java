...
import net.mcreator.sotmr.item.DrigorianFruitItem;
...
public class EndBulbsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:end_bulbs")
	public static final Block block = null;
	public EndBulbsBlock(SotmModElements instance) {
		super(instance, 1846);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("end_bulbs"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:end_bulbs"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DrigorianFruitItem.block, (int) (1)));
		}
