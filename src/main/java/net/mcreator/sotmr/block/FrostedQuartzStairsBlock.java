...
public class FrostedQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_quartz_stairs")
	public static final Block block = null;
	public FrostedQuartzStairsBlock(SotmModElements instance) {
		super(instance, 255);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("frosted_quartz_stairs");
		}
