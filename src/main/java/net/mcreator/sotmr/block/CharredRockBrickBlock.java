...
public class CharredRockBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:charred_rock_brick")
	public static final Block block = null;
	public CharredRockBrickBlock(SotmModElements instance) {
		super(instance, 524);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("charred_rock_brick");
		}
