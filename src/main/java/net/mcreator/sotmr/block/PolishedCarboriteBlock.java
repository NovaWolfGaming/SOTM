...
public class PolishedCarboriteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedcarborite")
	public static final Block block = null;
	public PolishedCarboriteBlock(SotmModElements instance) {
		super(instance, 488);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedcarborite");
		}
