...
public class MarbleLimeBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime_brick_stairs")
	public static final Block block = null;
	public MarbleLimeBrickStairsBlock(SotmModElements instance) {
		super(instance, 2478);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_lime_brick_stairs");
		}
