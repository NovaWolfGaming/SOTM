...
public class BillonBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:billon_block")
	public static final Block block = null;
	public BillonBlockBlock(SotmModElements instance) {
		super(instance, 1962);
	}
