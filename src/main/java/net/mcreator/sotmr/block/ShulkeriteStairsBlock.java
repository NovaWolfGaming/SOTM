...
public class ShulkeriteStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:shulkeritestairs")
	public static final Block block = null;
	public ShulkeriteStairsBlock(SotmModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("shulkeritestairs");
		}
