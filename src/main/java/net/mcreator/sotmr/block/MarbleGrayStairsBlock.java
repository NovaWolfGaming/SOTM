...
public class MarbleGrayStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_gray_stairs")
	public static final Block block = null;
	public MarbleGrayStairsBlock(SotmModElements instance) {
		super(instance, 2450);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_gray_stairs");
		}
