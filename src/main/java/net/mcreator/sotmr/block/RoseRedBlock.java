...
public class RoseRedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_red")
	public static final Block block = null;
	public RoseRedBlock(SotmModElements instance) {
		super(instance, 1871);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rose_red"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:rose_red"), configuredFeature);
		}
	}
	@SubscribeEvent
