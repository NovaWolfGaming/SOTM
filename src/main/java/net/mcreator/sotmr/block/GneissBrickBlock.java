...
public class GneissBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:gneiss_brick")
	public static final Block block = null;
	public GneissBrickBlock(SotmModElements instance) {
		super(instance, 1706);
	}
