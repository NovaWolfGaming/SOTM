...
public class CrimsonQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crimson_quartz_stairs")
	public static final Block block = null;
	public CrimsonQuartzStairsBlock(SotmModElements instance) {
		super(instance, 293);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_quartz_stairs");
		}
