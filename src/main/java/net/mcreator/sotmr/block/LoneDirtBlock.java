...
public class LoneDirtBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lone_dirt")
	public static final Block block = null;
	public LoneDirtBlock(SotmModElements instance) {
		super(instance, 2196);
	}
