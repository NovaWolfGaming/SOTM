...
public class TroddenFlowerRedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:trodden_flower_red")
	public static final Block block = null;
	public TroddenFlowerRedBlock(SotmModElements instance) {
		super(instance, 1760);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("trodden_flower_red"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:trodden_flower_red"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("trodden_flower_red");
		}
