...
public class AshwoodDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:ashwood_door")
	public static final Block block = null;
	public AshwoodDoorBlock(SotmModElements instance) {
		super(instance, 1430);
	}
