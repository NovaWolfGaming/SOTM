...
public class PumiceBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pumice_brick_stairs")
	public static final Block block = null;
	public PumiceBrickStairsBlock(SotmModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pumice_brick_stairs");
		}
