...
public class SpottedAshwoodTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_trapdoor")
	public static final Block block = null;
	public SpottedAshwoodTrapdoorBlock(SotmModElements instance) {
		super(instance, 1428);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_trapdoor");
		}
