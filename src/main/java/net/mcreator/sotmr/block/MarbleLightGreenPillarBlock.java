...
public class MarbleLightGreenPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green_pillar")
	public static final Block block = null;
	public MarbleLightGreenPillarBlock(SotmModElements instance) {
		super(instance, 2463);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_light_green_pillar");
		}
