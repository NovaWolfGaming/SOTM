...
public class PhantomChorusStoneSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:phantom_chorus_stone_slab")
	public static final Block block = null;
	public PhantomChorusStoneSlabBlock(SotmModElements instance) {
		super(instance, 1742);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("phantom_chorus_stone_slab");
		}
