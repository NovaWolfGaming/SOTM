...
public class CrimsonQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crimson_quartz_block")
	public static final Block block = null;
	public CrimsonQuartzBlockBlock(SotmModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crimson_quartz_block");
		}
