...
public class PhantomLocustDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:phantom_locust_door")
	public static final Block block = null;
	public PhantomLocustDoorBlock(SotmModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("phantom_locust_door");
		}
