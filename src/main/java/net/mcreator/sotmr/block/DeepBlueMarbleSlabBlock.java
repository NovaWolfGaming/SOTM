...
public class DeepBlueMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_marble_slab")
	public static final Block block = null;
	public DeepBlueMarbleSlabBlock(SotmModElements instance) {
		super(instance, 2549);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_marble_slab");
		}
