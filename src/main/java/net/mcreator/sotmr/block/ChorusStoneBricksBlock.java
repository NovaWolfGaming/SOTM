...
public class ChorusStoneBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone_bricks")
	public static final Block block = null;
	public ChorusStoneBricksBlock(SotmModElements instance) {
		super(instance, 1374);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chorus_stone_bricks");
		}
