...
public class WhiteRosesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_roses")
	public static final Block block = null;
	public WhiteRosesBlock(SotmModElements instance) {
		super(instance, 1783);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("white_roses"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:white_roses"), configuredFeature);
		}
	}
	@SubscribeEvent
