...
public class SmoothOrangeMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_orange_marble")
	public static final Block block = null;
	public SmoothOrangeMarbleBlock(SotmModElements instance) {
		super(instance, 562);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_orange_marble");
		}
