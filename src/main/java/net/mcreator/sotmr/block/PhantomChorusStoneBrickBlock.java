...
public class PhantomChorusStoneBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:phantom_chorus_stone_brick")
	public static final Block block = null;
	public PhantomChorusStoneBrickBlock(SotmModElements instance) {
		super(instance, 1738);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("phantom_chorus_stone_brick");
		}
