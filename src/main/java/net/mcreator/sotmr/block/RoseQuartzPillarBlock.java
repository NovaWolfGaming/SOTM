...
public class RoseQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_quartz_pillar")
	public static final Block block = null;
	public RoseQuartzPillarBlock(SotmModElements instance) {
		super(instance, 83);
	}
