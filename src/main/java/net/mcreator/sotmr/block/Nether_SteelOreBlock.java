...
public class Nether_SteelOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:nether_steel_ore")
	public static final Block block = null;
	public Nether_SteelOreBlock(SotmModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nether_steel_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:nether_steel_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("nether_steel_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:nether_steel_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
