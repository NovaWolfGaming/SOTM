...
public class BloodElderSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder_slab")
	public static final Block block = null;
	public BloodElderSlabBlock(SotmModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_elder_slab");
		}
