...
public class ChippedAssidiumPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:chipped_assidium_planks")
	public static final Block block = null;

	public ChippedAssidiumPlanksBlock(SotmModElements instance) {
		super(instance, 2663);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chipped_assidium_planks");
		}
