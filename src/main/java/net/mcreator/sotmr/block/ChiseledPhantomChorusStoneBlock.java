...
public class ChiseledPhantomChorusStoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_phantom_chorus_stone")
	public static final Block block = null;
	public ChiseledPhantomChorusStoneBlock(SotmModElements instance) {
		super(instance, 1741);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_phantom_chorus_stone");
		}
