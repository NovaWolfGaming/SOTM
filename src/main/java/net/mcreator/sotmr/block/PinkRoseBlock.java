...
public class PinkRoseBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_rose")
	public static final Block block = null;
	public PinkRoseBlock(SotmModElements instance) {
		super(instance, 267);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pink_rose"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pink_rose"), configuredFeature);
		}
	}
	@SubscribeEvent
