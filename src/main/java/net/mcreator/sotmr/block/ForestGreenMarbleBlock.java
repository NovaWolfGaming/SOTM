...
public class ForestGreenMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble")
	public static final Block block = null;
	public ForestGreenMarbleBlock(SotmModElements instance) {
		super(instance, 2557);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:forest_green_marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("forest_green_marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:forest_green_marble"), configuredFeature);
		}
	}
	@SubscribeEvent
