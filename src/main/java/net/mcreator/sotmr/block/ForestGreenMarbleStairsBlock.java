...
public class ForestGreenMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble_stairs")
	public static final Block block = null;
	public ForestGreenMarbleStairsBlock(SotmModElements instance) {
		super(instance, 2562);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble_stairs");
		}
