...
public class DeepBluePolishedMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_polished_marble")
	public static final Block block = null;
	public DeepBluePolishedMarbleBlock(SotmModElements instance) {
		super(instance, 2544);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_blue_polished_marble");
		}
