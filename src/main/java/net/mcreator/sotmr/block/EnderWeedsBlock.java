...
public class EnderWeedsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:enderweeds")
	public static final Block block = null;
	public EnderWeedsBlock(SotmModElements instance) {
		super(instance, 283);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("enderweeds"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:enderweeds"), configuredFeature);
		}
	}
	@SubscribeEvent
