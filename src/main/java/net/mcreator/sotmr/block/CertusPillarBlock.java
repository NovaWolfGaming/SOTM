...
public class CertusPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:certuspillar")
	public static final Block block = null;
	public CertusPillarBlock(SotmModElements instance) {
		super(instance, 58);
	}
