...
public class ForestGreenMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:forest_green_marble_slab")
	public static final Block block = null;
	public ForestGreenMarbleSlabBlock(SotmModElements instance) {
		super(instance, 2563);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("forest_green_marble_slab");
		}
