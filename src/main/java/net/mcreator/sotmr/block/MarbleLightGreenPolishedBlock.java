...
public class MarbleLightGreenPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green_polished")
	public static final Block block = null;
	public MarbleLightGreenPolishedBlock(SotmModElements instance) {
		super(instance, 2460);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_green_polished");
		}
