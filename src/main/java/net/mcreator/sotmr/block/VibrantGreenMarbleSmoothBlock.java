...
public class VibrantGreenMarbleSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:vibrant_green_marble_smooth")
	public static final Block block = null;
	public VibrantGreenMarbleSmoothBlock(SotmModElements instance) {
		super(instance, 565);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vibrant_green_marble_smooth");
		}
