...
public class SmoothPinkMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_pink_marble")
	public static final Block block = null;
	public SmoothPinkMarbleBlock(SotmModElements instance) {
		super(instance, 559);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_pink_marble");
		}
