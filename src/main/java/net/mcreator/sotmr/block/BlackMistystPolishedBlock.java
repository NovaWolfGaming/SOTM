...
public class BlackMistystPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst_polished")
	public static final Block block = null;
	public BlackMistystPolishedBlock(SotmModElements instance) {
		super(instance, 2707);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_mistyst_polished");
		}
