...
public class WhiteMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_marble_slab")
	public static final Block block = null;
	public WhiteMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1476);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("white_marble_slab");
		}
