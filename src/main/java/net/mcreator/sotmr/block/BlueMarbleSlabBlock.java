...
public class BlueMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_marble_slab")
	public static final Block block = null;
	public BlueMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1478);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_marble_slab");
		}
