...
public class SulphurOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphur_ore")
	public static final Block block = null;
	public SulphurOreBlock(SotmModElements instance) {
		super(instance, 11);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:sulphur_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sulphur_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
