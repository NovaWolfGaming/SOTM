...
public class MarbleDirtyWhitePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dirty_white_polished")
	public static final Block block = null;
	public MarbleDirtyWhitePolishedBlock(SotmModElements instance) {
		super(instance, 2404);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_dirty_white_polished");
		}
