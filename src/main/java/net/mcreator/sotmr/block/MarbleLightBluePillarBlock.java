...
public class MarbleLightBluePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue_pillar")
	public static final Block block = null;
	public MarbleLightBluePillarBlock(SotmModElements instance) {
		super(instance, 2435);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue_pillar");
		}
