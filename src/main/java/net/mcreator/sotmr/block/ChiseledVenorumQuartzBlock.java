...
public class ChiseledVenorumQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_venorum_quartz")
	public static final Block block = null;
	public ChiseledVenorumQuartzBlock(SotmModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_venorum_quartz");
		}
