...
public class RoseQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_quartz_slab")
	public static final Block block = null;
	public RoseQuartzSlabBlock(SotmModElements instance) {
		super(instance, 252);
	}
