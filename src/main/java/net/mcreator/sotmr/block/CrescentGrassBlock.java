...
public class CrescentGrassBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crescent_grass")
	public static final Block block = null;
	public CrescentGrassBlock(SotmModElements instance) {
		super(instance, 146);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crescent_grass");
		}
