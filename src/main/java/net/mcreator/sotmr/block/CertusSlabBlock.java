...
public class CertusSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:certusslab")
	public static final Block block = null;
	public CertusSlabBlock(SotmModElements instance) {
		super(instance, 168);
	}
