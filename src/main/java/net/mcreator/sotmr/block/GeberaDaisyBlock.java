...
public class GeberaDaisyBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:gebera_daisy")
	public static final Block block = null;
	public GeberaDaisyBlock(SotmModElements instance) {
		super(instance, 320);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("gebera_daisy"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:gebera_daisy"), configuredFeature);
		}
	}
	@SubscribeEvent
