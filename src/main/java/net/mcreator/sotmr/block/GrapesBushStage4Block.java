...
import net.mcreator.sotmr.item.GrapesItem;
...
public class GrapesBushStage4Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:grapes_bush_stage_4")
	public static final Block block = null;
	public GrapesBushStage4Block(SotmModElements instance) {
		super(instance, 308);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("grapes_bush_stage_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:grapes_bush_stage_4"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("grapes_bush_stage_4");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GrapesItem.block, (int) (3)));
		}
