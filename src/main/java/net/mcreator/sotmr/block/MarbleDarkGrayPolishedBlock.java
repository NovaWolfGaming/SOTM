...
public class MarbleDarkGrayPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dark_gray_polished")
	public static final Block block = null;
	public MarbleDarkGrayPolishedBlock(SotmModElements instance) {
		super(instance, 2488);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_dark_gray_polished");
		}
