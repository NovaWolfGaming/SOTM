...
public class MarbleCreamyYellowStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_creamy_yellow_stairs")
	public static final Block block = null;
	public MarbleCreamyYellowStairsBlock(SotmModElements instance) {
		super(instance, 2506);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_creamy_yellow_stairs");
		}
