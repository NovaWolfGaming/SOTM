...
public class SmoothBlackMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_black_marble")
	public static final Block block = null;
	public SmoothBlackMarbleBlock(SotmModElements instance) {
		super(instance, 548);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_black_marble");
		}
