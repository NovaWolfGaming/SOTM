...
public class BlueCrolphinBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_crolphin_bricks")
	public static final Block block = null;
	public BlueCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2307);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_crolphin_bricks");
		}
