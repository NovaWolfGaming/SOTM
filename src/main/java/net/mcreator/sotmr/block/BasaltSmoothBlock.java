...
public class BasaltSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basaltsmooth")
	public static final Block block = null;
	public BasaltSmoothBlock(SotmModElements instance) {
		super(instance, 491);
	}
