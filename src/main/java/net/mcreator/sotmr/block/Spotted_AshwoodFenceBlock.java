...
public class Spotted_AshwoodFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_fence")
	public static final Block block = null;
	public Spotted_AshwoodFenceBlock(SotmModElements instance) {
		super(instance, 1418);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_fence");
		}
