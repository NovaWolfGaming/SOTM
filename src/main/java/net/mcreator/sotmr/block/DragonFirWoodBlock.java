...
public class DragonFirWoodBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_wood")
	public static final Block block = null;
	public DragonFirWoodBlock(SotmModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_wood");
		}
