...
public class ArchplantBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:archplant")
	public static final Block block = null;
	public ArchplantBlock(SotmModElements instance) {
		super(instance, 1820);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("archplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:archplant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.ROOT)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("archplant");
		}
