...
public class DeepBlueMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:deep_blue_marble_pillar")
	public static final Block block = null;
	public DeepBlueMarblePillarBlock(SotmModElements instance) {
		super(instance, 2547);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("deep_blue_marble_pillar");
		}
