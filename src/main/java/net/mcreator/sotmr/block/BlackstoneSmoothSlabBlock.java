...
public class BlackstoneSmoothSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstonesmoothslab")
	public static final Block block = null;
	public BlackstoneSmoothSlabBlock(SotmModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstonesmoothslab");
		}
