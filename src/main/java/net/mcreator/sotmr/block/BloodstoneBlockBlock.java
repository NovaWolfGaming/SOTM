...
public class BloodstoneBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bloodstoneblock")
	public static final Block block = null;
	public BloodstoneBlockBlock(SotmModElements instance) {
		super(instance, 483);
	}
