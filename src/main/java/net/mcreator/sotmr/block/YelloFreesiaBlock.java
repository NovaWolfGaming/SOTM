...
public class YelloFreesiaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yello_freesia")
	public static final Block block = null;
	public YelloFreesiaBlock(SotmModElements instance) {
		super(instance, 1772);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yello_freesia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:yello_freesia"), configuredFeature);
		}
	}
	@SubscribeEvent
