...
public class MossyCrimsonPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_crimson_planks")
	public static final Block block = null;
	public MossyCrimsonPlanksBlock(SotmModElements instance) {
		super(instance, 2613);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_crimson_planks");
		}
