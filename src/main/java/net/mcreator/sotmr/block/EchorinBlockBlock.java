...
public class EchorinBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:echorinblock")
	public static final Block block = null;
	public EchorinBlockBlock(SotmModElements instance) {
		super(instance, 52);
	}
