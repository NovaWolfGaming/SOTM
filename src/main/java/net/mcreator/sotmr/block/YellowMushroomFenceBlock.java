...
public class YellowMushroomFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_fence")
	public static final Block block = null;
	public YellowMushroomFenceBlock(SotmModElements instance) {
		super(instance, 248);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom_fence");
		}
