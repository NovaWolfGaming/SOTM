...
public class MarbleYellowPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow_pillar")
	public static final Block block = null;
	public MarbleYellowPillarBlock(SotmModElements instance) {
		super(instance, 2379);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_yellow_pillar");
		}
