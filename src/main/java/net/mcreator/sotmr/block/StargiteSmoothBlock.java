...
public class StargiteSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:stargite_smooth")
	public static final Block block = null;
	public StargiteSmoothBlock(SotmModElements instance) {
		super(instance, 2050);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stargite_smooth");
		}
