...
public class PolishedCobblestoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polished_cobblestone")
	public static final Block block = null;
	public PolishedCobblestoneBlock(SotmModElements instance) {
		super(instance, 543);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_cobblestone");
		}
