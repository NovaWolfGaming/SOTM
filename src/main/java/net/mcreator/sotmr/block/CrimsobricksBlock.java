...
public class CrimsobricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crimsobricks")
	public static final Block block = null;
	public CrimsobricksBlock(SotmModElements instance) {
		super(instance, 583);
	}
