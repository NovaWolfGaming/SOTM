...
public class PegmatiteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pegmatite_brick")
	public static final Block block = null;
	public PegmatiteBrickBlock(SotmModElements instance) {
		super(instance, 1700);
	}
