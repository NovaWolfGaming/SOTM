...
public class PinkStargiteSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_stargite_smooth")
	public static final Block block = null;
	public PinkStargiteSmoothBlock(SotmModElements instance) {
		super(instance, 2053);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_stargite_smooth");
		}
