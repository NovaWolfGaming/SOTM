...
public class MonochromeWoodPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:monochrome_wood_planks")
	public static final Block block = null;
	public MonochromeWoodPlanksBlock(SotmModElements instance) {
		super(instance, 2200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("monochrome_wood_planks");
		}
