...
public class MarblePinkyRedPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red_polished")
	public static final Block block = null;
	public MarblePinkyRedPolishedBlock(SotmModElements instance) {
		super(instance, 2418);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red_polished");
		}
