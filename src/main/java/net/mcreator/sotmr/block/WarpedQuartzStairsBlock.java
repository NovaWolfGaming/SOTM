...
public class WarpedQuartzStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warped_quartz_stairs")
	public static final Block block = null;
	public WarpedQuartzStairsBlock(SotmModElements instance) {
		super(instance, 297);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_quartz_stairs");
		}
