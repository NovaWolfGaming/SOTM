...
public class ShulkeriteBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:shulkeritebricks")
	public static final Block block = null;
	public ShulkeriteBricksBlock(SotmModElements instance) {
		super(instance, 114);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shulkeritebricks");
		}
