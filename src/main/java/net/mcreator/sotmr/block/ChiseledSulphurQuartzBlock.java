...
public class ChiseledSulphurQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_sulphur_quartz")
	public static final Block block = null;
	public ChiseledSulphurQuartzBlock(SotmModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_sulphur_quartz");
		}
