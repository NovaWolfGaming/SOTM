...
public class FrostedCrystalineSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_crystaline_slab")
	public static final Block block = null;
	public FrostedCrystalineSlabBlock(SotmModElements instance) {
		super(instance, 300);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("frosted_crystaline_slab");
		}
