...
public class ChippedWalnutPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_walnut_planks")
	public static final Block block = null;
	public ChippedWalnutPlanksBlock(SotmModElements instance) {
		super(instance, 2627);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_walnut_planks");
		}
