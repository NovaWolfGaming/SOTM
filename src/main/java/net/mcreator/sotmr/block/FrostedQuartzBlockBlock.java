...
public class FrostedQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_quartz_block")
	public static final Block block = null;
	public FrostedQuartzBlockBlock(SotmModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_quartz_block");
		}
