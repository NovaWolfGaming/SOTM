...
public class BegoniaPinkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:begonia_pink")
	public static final Block block = null;
	public BegoniaPinkBlock(SotmModElements instance) {
		super(instance, 1856);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("begonia_pink"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:begonia_pink"), configuredFeature);
		}
	}
	@SubscribeEvent
