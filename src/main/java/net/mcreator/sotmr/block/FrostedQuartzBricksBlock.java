...
public class FrostedQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_quartz_bricks")
	public static final Block block = null;
	public FrostedQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2008);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_quartz_bricks");
		}
