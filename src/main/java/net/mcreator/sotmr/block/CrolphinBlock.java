...
public class CrolphinBlock extends SotmModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(CarbonSandBlock.block.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 23)).range(125).square().func_242731_b(20));
	}
}
