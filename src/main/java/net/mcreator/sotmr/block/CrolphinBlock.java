...
public class CrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crolphin")
	public static final Block block = null;
	public CrolphinBlock(SotmModElements instance) {
		super(instance, 127);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrolphinBallItem.block, (int) (4)));
		}
	}
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == CarbonSandBlock.block.getDefaultState().getBlock())
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:crolphin_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("crolphin"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:crolphin"), configuredFeature);
		}
	}
	@SubscribeEvent
