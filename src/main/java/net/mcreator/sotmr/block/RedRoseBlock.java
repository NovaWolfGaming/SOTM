...
public class RedRoseBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_rose")
	public static final Block block = null;
	public RedRoseBlock(SotmModElements instance) {
		super(instance, 266);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_rose"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:red_rose"), configuredFeature);
		}
	}
	@SubscribeEvent
