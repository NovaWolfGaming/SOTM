...
public class NetherstoneSmoothSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:netherstone_smooth_slab")
	public static final Block block = null;
	public NetherstoneSmoothSlabBlock(SotmModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("netherstone_smooth_slab");
		}
