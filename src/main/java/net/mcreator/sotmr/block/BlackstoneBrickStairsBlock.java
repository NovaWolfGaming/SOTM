...
public class BlackstoneBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstonebrickstairs")
	public static final Block block = null;
	public BlackstoneBrickStairsBlock(SotmModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstonebrickstairs");
		}
