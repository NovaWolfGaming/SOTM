...
public class LimeCrolphinBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lime_crolphin_bricks")
	public static final Block block = null;
	public LimeCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2313);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lime_crolphin_bricks");
		}
