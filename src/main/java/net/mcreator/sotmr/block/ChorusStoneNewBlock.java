...
public class ChorusStoneNewBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone_new")
	public static final Block block = null;
	public ChorusStoneNewBlock(SotmModElements instance) {
		super(instance, 1373);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chorus_stone_new");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:chorus_stone_new_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("chorus_stone_new"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:chorus_stone_new"), configuredFeature);
		}
	}
	@SubscribeEvent
