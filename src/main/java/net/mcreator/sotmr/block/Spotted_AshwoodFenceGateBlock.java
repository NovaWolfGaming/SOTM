...
public class Spotted_AshwoodFenceGateBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_fence_gate")
	public static final Block block = null;
	public Spotted_AshwoodFenceGateBlock(SotmModElements instance) {
		super(instance, 1419);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_fence_gate");
		}
