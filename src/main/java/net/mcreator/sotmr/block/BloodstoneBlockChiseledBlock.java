...
public class BloodstoneBlockChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bloodstoneblockchiseled")
	public static final Block block = null;
	public BloodstoneBlockChiseledBlock(SotmModElements instance) {
		super(instance, 484);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bloodstoneblockchiseled");
		}
