...
import net.mcreator.sotmr.item.TerracusItem;
...
public class TerracusBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:terracus_bush")
	public static final Block block = null;
	public TerracusBushBlock(SotmModElements instance) {
		super(instance, 310);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("terracus_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:terracus_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TerracusItem.block, (int) (2)));
		}
