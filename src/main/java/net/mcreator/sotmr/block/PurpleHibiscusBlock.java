...
public class PurpleHibiscusBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_hibiscus")
	public static final Block block = null;
	public PurpleHibiscusBlock(SotmModElements instance) {
		super(instance, 1788);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("purple_hibiscus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:purple_hibiscus"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("purple_hibiscus");
		}
