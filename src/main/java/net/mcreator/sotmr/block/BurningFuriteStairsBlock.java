...
public class BurningFuriteStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:burningfuritestairs")
	public static final Block block = null;
	public BurningFuriteStairsBlock(SotmModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("burningfuritestairs");
		}
