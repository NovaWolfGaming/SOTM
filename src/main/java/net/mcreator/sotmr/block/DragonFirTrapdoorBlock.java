...
public class DragonFirTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_trapdoor")
	public static final Block block = null;
	public DragonFirTrapdoorBlock(SotmModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_trapdoor");
		}
