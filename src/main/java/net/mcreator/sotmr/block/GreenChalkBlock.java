...
public class GreenChalkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_chalk")
	public static final Block block = null;
	public GreenChalkBlock(SotmModElements instance) {
		super(instance, 1805);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:green_chalk_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("green_chalk"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:green_chalk"), configuredFeature);
		}
	}
	@SubscribeEvent
