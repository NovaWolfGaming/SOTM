...
public class ScrapMetalBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:scrap_metal_block")
	public static final Block block = null;
	public ScrapMetalBlockBlock(SotmModElements instance) {
		super(instance, 2085);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("scrap_metal_block");
		}
