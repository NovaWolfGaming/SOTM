...
public class VibrantGreenMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:vibrant_green_marble_polished")
	public static final Block block = null;
	public VibrantGreenMarblePolishedBlock(SotmModElements instance) {
		super(instance, 564);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vibrant_green_marble_polished");
		}
