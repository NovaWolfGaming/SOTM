...
public class WalnutLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:walnut_leaves")
	public static final Block block = null;
	public WalnutLeavesBlock(SotmModElements instance) {
		super(instance, 315);
	}
