...
public class OrangeStargiteSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_stargite_smooth")
	public static final Block block = null;
	public OrangeStargiteSmoothBlock(SotmModElements instance) {
		super(instance, 2056);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_stargite_smooth");
		}
