...
public class BlueMistystStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst_stairs")
	public static final Block block = null;
	public BlueMistystStairsBlock(SotmModElements instance) {
		super(instance, 530);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_mistyst_stairs");
		}
