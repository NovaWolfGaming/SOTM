...
public class PinkMarbleBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_marble_brick")
	public static final Block block = null;
	public PinkMarbleBrickBlock(SotmModElements instance) {
		super(instance, 1454);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_marble_brick");
		}
