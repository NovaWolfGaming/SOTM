...
public class EuaphreliaFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:euaphreliafence")
	public static final Block block = null;
	public EuaphreliaFenceBlock(SotmModElements instance) {
		super(instance, 223);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("euaphreliafence");
		}
