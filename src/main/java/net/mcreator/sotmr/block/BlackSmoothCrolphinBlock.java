...
public class BlackSmoothCrolphinBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:black_smooth_crolphin")
	public static final Block block = null;

	public BlackSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2265);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_smooth_crolphin");
		}
