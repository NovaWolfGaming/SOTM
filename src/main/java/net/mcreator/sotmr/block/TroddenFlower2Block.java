...
public class TroddenFlower2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:trodden_flower_2")
	public static final Block block = null;
	public TroddenFlower2Block(SotmModElements instance) {
		super(instance, 318);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("trodden_flower_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:trodden_flower_2"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("trodden_flower_2");
		}
