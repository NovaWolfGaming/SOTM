...
public class AssidiumWoodDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:assidium_wood_door")
	public static final Block block = null;
	public AssidiumWoodDoorBlock(SotmModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("assidium_wood_door");
		}
