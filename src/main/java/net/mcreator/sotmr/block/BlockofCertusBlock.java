...
public class BlockofCertusBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blockofcertus")
	public static final Block block = null;
	public BlockofCertusBlock(SotmModElements instance) {
		super(instance, 56);
	}
