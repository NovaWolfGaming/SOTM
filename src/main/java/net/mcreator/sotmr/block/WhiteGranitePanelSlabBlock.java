...
public class WhiteGranitePanelSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:white_granite_panel_slab")
	public static final Block block = null;
	public WhiteGranitePanelSlabBlock(SotmModElements instance) {
		super(instance, 2586);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("white_granite_panel_slab");
		}
