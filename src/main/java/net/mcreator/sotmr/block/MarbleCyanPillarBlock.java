...
public class MarbleCyanPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_cyan_pillar")
	public static final Block block = null;
	public MarbleCyanPillarBlock(SotmModElements instance) {
		super(instance, 2393);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marble_cyan_pillar");
		}
