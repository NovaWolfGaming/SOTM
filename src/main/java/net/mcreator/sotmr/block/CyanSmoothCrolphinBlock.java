...
public class CyanSmoothCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cyan_smooth_crolphin")
	public static final Block block = null;
	public CyanSmoothCrolphinBlock(SotmModElements instance) {
		super(instance, 2279);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cyan_smooth_crolphin");
		}
