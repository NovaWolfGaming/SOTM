...
public class FreesiaBlueBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:freesia_blue")
	public static final Block block = null;
	public FreesiaBlueBlock(SotmModElements instance) {
		super(instance, 1774);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("freesia_blue"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:freesia_blue"), configuredFeature);
		}
	}
	@SubscribeEvent
