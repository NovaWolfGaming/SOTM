...
public class MarbleCyanPolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_cyan_polished")
	public static final Block block = null;
	public MarbleCyanPolishedBlock(SotmModElements instance) {
		super(instance, 2390);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_cyan_polished");
		}
