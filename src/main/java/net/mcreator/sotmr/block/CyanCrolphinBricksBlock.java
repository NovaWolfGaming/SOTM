...
public class CyanCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:cyan_crolphin_bricks")
	public static final Block block = null;

	public CyanCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2311);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cyan_crolphin_bricks");
		}
