...
public class MarblePinkSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pink_smooth")
	public static final Block block = null;
	public MarblePinkSmoothBlock(SotmModElements instance) {
		super(instance, 2363);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_pink_smooth");
		}
