...
public class CoesiteGlassPaneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:coesite_glass_pane")
	public static final Block block = null;
	public CoesiteGlassPaneBlock(SotmModElements instance) {
		super(instance, 288);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("coesite_glass_pane");
		}

		@Override
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.866666666667f, 0.81568627451f, 0.81568627451f};
		}
