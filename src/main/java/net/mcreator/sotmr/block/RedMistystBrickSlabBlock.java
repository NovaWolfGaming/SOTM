...
public class RedMistystBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst_brick_slab")
	public static final Block block = null;
	public RedMistystBrickSlabBlock(SotmModElements instance) {
		super(instance, 2702);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("red_mistyst_brick_slab");
		}
