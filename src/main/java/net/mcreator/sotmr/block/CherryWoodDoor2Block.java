...
public class CherryWoodDoor2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_wood_door_2")
	public static final Block block = null;
	public CherryWoodDoor2Block(SotmModElements instance) {
		super(instance, 307);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("cherry_wood_door_2");
		}
