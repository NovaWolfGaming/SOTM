...
public class LuminariaBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:luminaria")
	public static final Block block = null;
	public LuminariaBlock(SotmModElements instance) {
		super(instance, 1831);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("luminaria"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:luminaria"), configuredFeature);
		}
	}
	@SubscribeEvent
