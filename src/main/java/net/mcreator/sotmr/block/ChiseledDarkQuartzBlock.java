...
public class ChiseledDarkQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseleddarkquartz")
	public static final Block block = null;
	public ChiseledDarkQuartzBlock(SotmModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseleddarkquartz");
		}
