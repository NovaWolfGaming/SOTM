...
public class DewYellowMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble_pillar")
	public static final Block block = null;
	public DewYellowMarblePillarBlock(SotmModElements instance) {
		super(instance, 2519);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble_pillar");
		}
