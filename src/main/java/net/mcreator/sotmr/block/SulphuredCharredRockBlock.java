...
public class SulphuredCharredRockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphured_charred_rock")
	public static final Block block = null;
	public SulphuredCharredRockBlock(SotmModElements instance) {
		super(instance, 525);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sulphured_charred_rock");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:sulphured_charred_rock_match"),
			...
			event.getRegistry().register(feature.setRegistryName("sulphured_charred_rock"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sulphured_charred_rock"), configuredFeature);
		}
	}
	@SubscribeEvent
