...
public class MarblePinkyRedBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red_brick")
	public static final Block block = null;
	public MarblePinkyRedBrickBlock(SotmModElements instance) {
		super(instance, 2420);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red_brick");
		}
