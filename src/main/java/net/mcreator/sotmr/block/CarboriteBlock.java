...
public class CarboriteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carborite")
	public static final Block block = null;
	public CarboriteBlock(SotmModElements instance) {
		super(instance, 487);
	}
