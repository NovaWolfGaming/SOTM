...
public class AmberQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amber_quartz_slab")
	public static final Block block = null;
	public AmberQuartzSlabBlock(SotmModElements instance) {
		super(instance, 292);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("amber_quartz_slab");
		}
