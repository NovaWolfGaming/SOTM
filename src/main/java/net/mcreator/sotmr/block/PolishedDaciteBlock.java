...
public class PolishedDaciteBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polished_dacite")
	public static final Block block = null;
	public PolishedDaciteBlock(SotmModElements instance) {
		super(instance, 593);
	}
