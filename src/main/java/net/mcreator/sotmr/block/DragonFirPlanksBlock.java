...
public class DragonFirPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_planks")
	public static final Block block = null;
	public DragonFirPlanksBlock(SotmModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_planks");
		}
