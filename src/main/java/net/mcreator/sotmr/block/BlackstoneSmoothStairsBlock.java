...
public class BlackstoneSmoothStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstonesmoothstairs")
	public static final Block block = null;
	public BlackstoneSmoothStairsBlock(SotmModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstonesmoothstairs");
		}
