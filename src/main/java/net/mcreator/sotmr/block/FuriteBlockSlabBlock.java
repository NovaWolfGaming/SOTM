...
public class FuriteBlockSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:furiteblockslab")
	public static final Block block = null;
	public FuriteBlockSlabBlock(SotmModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("furiteblockslab");
		}
