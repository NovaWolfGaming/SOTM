...
public class PolishedCarboriteStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedcarboritestairs")
	public static final Block block = null;
	public PolishedCarboriteStairsBlock(SotmModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedcarboritestairs");
		}
