...
public class DolomiteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dolomite_brick")
	public static final Block block = null;
	public DolomiteBrickBlock(SotmModElements instance) {
		super(instance, 1703);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dolomite_brick");
		}
