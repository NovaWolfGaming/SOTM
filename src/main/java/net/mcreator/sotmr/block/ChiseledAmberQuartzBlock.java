...
public class ChiseledAmberQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_amber_quartz")
	public static final Block block = null;
	public ChiseledAmberQuartzBlock(SotmModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_amber_quartz");
		}
