...
public class GreenMistystChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_mistyst_chiseled")
	public static final Block block = null;
	public GreenMistystChiseledBlock(SotmModElements instance) {
		super(instance, 541);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_mistyst_chiseled");
		}
