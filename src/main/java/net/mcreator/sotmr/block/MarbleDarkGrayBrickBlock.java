...
public class MarbleDarkGrayBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dark_gray_brick")
	public static final Block block = null;
	public MarbleDarkGrayBrickBlock(SotmModElements instance) {
		super(instance, 2490);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_dark_gray_brick");
		}
