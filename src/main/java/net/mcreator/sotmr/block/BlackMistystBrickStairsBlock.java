...
public class BlackMistystBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mistyst_brick_stairs")
	public static final Block block = null;
	public BlackMistystBrickStairsBlock(SotmModElements instance) {
		super(instance, 2716);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mistyst_brick_stairs");
		}
