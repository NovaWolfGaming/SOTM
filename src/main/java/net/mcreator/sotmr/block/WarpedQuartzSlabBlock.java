...
public class WarpedQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:warped_quartz_slab")
	public static final Block block = null;
	public WarpedQuartzSlabBlock(SotmModElements instance) {
		super(instance, 298);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_quartz_slab");
		}
