...
public class PhantomChorusStoneTilesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:phantom_chorus_stone_tiles")
	public static final Block block = null;
	public PhantomChorusStoneTilesBlock(SotmModElements instance) {
		super(instance, 1752);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("phantom_chorus_stone_tiles");
		}
