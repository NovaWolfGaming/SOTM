...
public class MarbleDirtyWhiteStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dirty_white_stairs")
	public static final Block block = null;
	public MarbleDirtyWhiteStairsBlock(SotmModElements instance) {
		super(instance, 2408);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_dirty_white_stairs");
		}
