...
public class PurpleMarbleStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_marble_stairs")
	public static final Block block = null;
	public PurpleMarbleStairsBlock(SotmModElements instance) {
		super(instance, 1485);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_marble_stairs");
		}
