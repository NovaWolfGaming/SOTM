...
public class FrostedCrystalinePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_crystaline_pillar")
	public static final Block block = null;
	public FrostedCrystalinePillarBlock(SotmModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_crystaline_pillar");
		}
