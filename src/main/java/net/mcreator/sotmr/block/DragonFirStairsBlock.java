...
public class DragonFirStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragon_fir_stairs")
	public static final Block block = null;
	public DragonFirStairsBlock(SotmModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_fir_stairs");
		}
