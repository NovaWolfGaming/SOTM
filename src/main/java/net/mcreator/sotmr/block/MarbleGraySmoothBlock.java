...
public class MarbleGraySmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_gray_smooth")
	public static final Block block = null;
	public MarbleGraySmoothBlock(SotmModElements instance) {
		super(instance, 2447);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_gray_smooth");
		}
