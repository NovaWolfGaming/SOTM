...
public class BlueStarClusterBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_star_cluster")
	public static final Block block = null;
	public BlueStarClusterBlock(SotmModElements instance) {
		super(instance, 1879);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blue_star_cluster"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blue_star_cluster"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blue_star_cluster");
		}
