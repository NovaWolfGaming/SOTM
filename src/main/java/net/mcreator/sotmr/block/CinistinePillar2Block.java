...
public class CinistinePillar2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cinistinepillar2")
	public static final Block block = null;
	public CinistinePillar2Block(SotmModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cinistinepillar2");
		}
