...
public class UaphreliaLogBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:uaphrelialog")
	public static final Block block = null;
	public UaphreliaLogBlock(SotmModElements instance) {
		super(instance, 59);
	}
