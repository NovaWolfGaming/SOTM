...
public class OrangeMarble2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_2")
	public static final Block block = null;
	public OrangeMarble2Block(SotmModElements instance) {
		super(instance, 1443);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_2");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:orange_marble_2_match"), () -> CustomRuleTest.codec);
