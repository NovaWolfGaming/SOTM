...
public class MarbleDirtyWhiteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dirty_white_slab")
	public static final Block block = null;
	public MarbleDirtyWhiteSlabBlock(SotmModElements instance) {
		super(instance, 2409);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_dirty_white_slab");
		}
