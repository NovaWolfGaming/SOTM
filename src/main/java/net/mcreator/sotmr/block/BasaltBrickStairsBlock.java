...
public class BasaltBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basaltbrickstairs")
	public static final Block block = null;
	public BasaltBrickStairsBlock(SotmModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("basaltbrickstairs");
		}
