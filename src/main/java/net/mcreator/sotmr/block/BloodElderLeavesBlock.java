...
public class BloodElderLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder_leaves")
	public static final Block block = null;
	public BloodElderLeavesBlock(SotmModElements instance) {
		super(instance, 206);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blood_elder_leaves");
		}
