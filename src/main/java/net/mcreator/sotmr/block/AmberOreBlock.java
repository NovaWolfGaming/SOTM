...
import net.mcreator.sotmr.item.AmberGemItem;
...
public class AmberOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amberore")
	public static final Block block = null;
	public AmberOreBlock(SotmModElements instance) {
		super(instance, 8);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AmberGemItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:amberore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("amberore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:amberore"), configuredFeature);
		}
	}
	@SubscribeEvent
