...
public class MossyBloodAlderPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_blood_alder_planks")
	public static final Block block = null;
	public MossyBloodAlderPlanksBlock(SotmModElements instance) {
		super(instance, 2665);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_blood_alder_planks");
		}
