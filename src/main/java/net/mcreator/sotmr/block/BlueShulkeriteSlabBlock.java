...
public class BlueShulkeriteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_shulkerite_slab")
	public static final Block block = null;
	public BlueShulkeriteSlabBlock(SotmModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_shulkerite_slab");
		}
