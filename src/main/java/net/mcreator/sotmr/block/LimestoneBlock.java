...
public class LimestoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:limestone")
	public static final Block block = null;
	public LimestoneBlock(SotmModElements instance) {
		super(instance, 507);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:limestone_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:limestone"), configuredFeature);
		}
	}
	@SubscribeEvent
