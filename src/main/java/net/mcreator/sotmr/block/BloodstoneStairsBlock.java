...
public class BloodstoneStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bloodstonestairs")
	public static final Block block = null;
	public BloodstoneStairsBlock(SotmModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodstonestairs");
		}
