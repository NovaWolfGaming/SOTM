...
public class YellowTulipBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_tulip")
	public static final Block block = null;
	public YellowTulipBlock(SotmModElements instance) {
		super(instance, 629);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:yellow_tulip"), configuredFeature);
		}
	}
	@SubscribeEvent
