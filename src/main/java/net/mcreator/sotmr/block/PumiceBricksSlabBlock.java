...
public class PumiceBricksSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pumice_bricks_slab")
	public static final Block block = null;
	public PumiceBricksSlabBlock(SotmModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pumice_bricks_slab");
		}
