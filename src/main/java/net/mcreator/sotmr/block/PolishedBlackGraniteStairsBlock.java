...
public class PolishedBlackGraniteStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedblackgranitestairs")
	public static final Block block = null;
	public PolishedBlackGraniteStairsBlock(SotmModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedblackgranitestairs");
		}
