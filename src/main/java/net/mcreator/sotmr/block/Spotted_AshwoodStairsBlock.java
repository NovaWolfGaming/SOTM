...
public class Spotted_AshwoodStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_stairs")
	public static final Block block = null;
	public Spotted_AshwoodStairsBlock(SotmModElements instance) {
		super(instance, 1416);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_stairs");
		}
