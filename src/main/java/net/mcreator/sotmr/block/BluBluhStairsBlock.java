...
public class BluBluhStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blu_bluh_stairs")
	public static final Block block = null;
	public BluBluhStairsBlock(SotmModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blu_bluh_stairs");
		}
