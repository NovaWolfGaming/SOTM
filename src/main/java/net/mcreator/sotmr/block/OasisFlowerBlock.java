...
public class OasisFlowerBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:oasis_flower")
	public static final Block block = null;
	public OasisFlowerBlock(SotmModElements instance) {
		super(instance, 323);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("oasis_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:oasis_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
