...
public class MarblePinkyRedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_pinky_red")
	public static final Block block = null;
	public MarblePinkyRedBlock(SotmModElements instance) {
		super(instance, 2417);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_pinky_red");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_pinky_red_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_pinky_red"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_pinky_red"), configuredFeature);
		}
	}
	@SubscribeEvent
