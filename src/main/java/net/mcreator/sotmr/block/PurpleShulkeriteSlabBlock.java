...
public class PurpleShulkeriteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_shulkerite_slab")
	public static final Block block = null;
	public PurpleShulkeriteSlabBlock(SotmModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_shulkerite_slab");
		}
