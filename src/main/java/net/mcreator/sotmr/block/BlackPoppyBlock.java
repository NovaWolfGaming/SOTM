...
public class BlackPoppyBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackpoppy")
	public static final Block block = null;
	public BlackPoppyBlock(SotmModElements instance) {
		super(instance, 282);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blackpoppy"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:blackpoppy"), configuredFeature);
		}
	}
	@SubscribeEvent
