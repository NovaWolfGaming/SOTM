...
public class GreenMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_marble_polished")
	public static final Block block = null;
	public GreenMarblePolishedBlock(SotmModElements instance) {
		super(instance, 555);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_marble_polished");
		}
