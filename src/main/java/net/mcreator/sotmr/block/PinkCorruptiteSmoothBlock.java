...
public class PinkCorruptiteSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_corruptite_smooth")
	public static final Block block = null;
	public PinkCorruptiteSmoothBlock(SotmModElements instance) {
		super(instance, 2725);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_corruptite_smooth");
		}
