...
public class PineappleBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pineapple_bush")
	public static final Block block = null;
	public PineappleBushBlock(SotmModElements instance) {
		super(instance, 1896);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pineapple_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pineapple_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("pineapple_bush");
		}
