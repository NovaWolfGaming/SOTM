...
public class BambooFenceGateBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bamboo_fence_gate")
	public static final Block block = null;
	public BambooFenceGateBlock(SotmModElements instance) {
		super(instance, 1682);
	}
