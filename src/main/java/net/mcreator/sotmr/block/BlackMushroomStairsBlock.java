...
public class BlackMushroomStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom_stairs")
	public static final Block block = null;
	public BlackMushroomStairsBlock(SotmModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_mushroom_stairs");
		}
