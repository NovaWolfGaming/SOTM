...
public class BukraltTilesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bukralt_tiles")
	public static final Block block = null;
	public BukraltTilesBlock(SotmModElements instance) {
		super(instance, 527);
	}
