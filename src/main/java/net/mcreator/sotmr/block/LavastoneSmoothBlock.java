...
public class LavastoneSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lavastone_smooth")
	public static final Block block = null;
	public LavastoneSmoothBlock(SotmModElements instance) {
		super(instance, 518);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lavastone_smooth");
		}
