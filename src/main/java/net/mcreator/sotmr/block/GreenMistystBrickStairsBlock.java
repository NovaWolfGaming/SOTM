...
public class GreenMistystBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_mistyst_brick_stairs")
	public static final Block block = null;
	public GreenMistystBrickStairsBlock(SotmModElements instance) {
		super(instance, 2690);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_mistyst_brick_stairs");
		}
