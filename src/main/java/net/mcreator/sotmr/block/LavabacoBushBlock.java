...
import net.mcreator.sotmr.item.LavabacoItem;
...
public class LavabacoBushBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lavabaco_bush")
	public static final Block block = null;
	public LavabacoBushBlock(SotmModElements instance) {
		super(instance, 1521);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lavabaco_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:lavabaco_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LavabacoItem.block, (int) (2)));
		}
