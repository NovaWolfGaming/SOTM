...
public class OrangeyRedMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orangey_red_marble_pillar")
	public static final Block block = null;
	public OrangeyRedMarblePillarBlock(SotmModElements instance) {
		super(instance, 2533);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orangey_red_marble_pillar");
		}
