...
public class VenorumQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_quartz_block")
	public static final Block block = null;
	public VenorumQuartzBlockBlock(SotmModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("venorum_quartz_block");
		}
