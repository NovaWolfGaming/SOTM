...
public class TwistedMapleFenceBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_fence")
	public static final Block block = null;
	public TwistedMapleFenceBlock(SotmModElements instance) {
		super(instance, 219);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_fence");
		}
