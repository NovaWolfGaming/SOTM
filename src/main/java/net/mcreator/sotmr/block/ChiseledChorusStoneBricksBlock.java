...
public class ChiseledChorusStoneBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_chorus_stone_bricks")
	public static final Block block = null;
	public ChiseledChorusStoneBricksBlock(SotmModElements instance) {
		super(instance, 1377);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_chorus_stone_bricks");
		}
