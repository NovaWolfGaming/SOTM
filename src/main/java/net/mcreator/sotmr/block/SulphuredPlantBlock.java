...
public class SulphuredPlantBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphured_plant")
	public static final Block block = null;
	public SulphuredPlantBlock(SotmModElements instance) {
		super(instance, 258);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sulphured_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sulphured_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("sulphured_plant");
		}
