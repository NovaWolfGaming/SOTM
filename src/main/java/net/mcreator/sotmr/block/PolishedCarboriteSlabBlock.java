...
public class PolishedCarboriteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:polishedcarboriteslab")
	public static final Block block = null;
	public PolishedCarboriteSlabBlock(SotmModElements instance) {
		super(instance, 170);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedcarboriteslab");
		}
