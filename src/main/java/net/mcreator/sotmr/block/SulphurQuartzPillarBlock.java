...
public class SulphurQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sulphur_quartz_pillar")
	public static final Block block = null;
	public SulphurQuartzPillarBlock(SotmModElements instance) {
		super(instance, 86);
	}
