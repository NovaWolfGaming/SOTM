...
public class MarbleGrayBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_gray_brick")
	public static final Block block = null;
	public MarbleGrayBrickBlock(SotmModElements instance) {
		super(instance, 2448);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_gray_brick");
		}
