...
public class DewYellowMarbleSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dew_yellow_marble_smooth")
	public static final Block block = null;
	public DewYellowMarbleSmoothBlock(SotmModElements instance) {
		super(instance, 2517);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dew_yellow_marble_smooth");
		}
