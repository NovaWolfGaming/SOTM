...
public class BauxiteBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bauxite_brick_slab")
	public static final Block block = null;
	public BauxiteBrickSlabBlock(SotmModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bauxite_brick_slab");
		}
