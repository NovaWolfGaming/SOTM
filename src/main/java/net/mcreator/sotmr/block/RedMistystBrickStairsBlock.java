...
public class RedMistystBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:red_mistyst_brick_stairs")
	public static final Block block = null;
	public RedMistystBrickStairsBlock(SotmModElements instance) {
		super(instance, 2703);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_mistyst_brick_stairs");
		}
