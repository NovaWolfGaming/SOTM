...
public class ReniteTilesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:renite_tiles")
	public static final Block block = null;
	public ReniteTilesBlock(SotmModElements instance) {
		super(instance, 587);
	}
