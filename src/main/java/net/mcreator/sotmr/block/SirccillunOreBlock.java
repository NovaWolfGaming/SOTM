...
import net.mcreator.sotmr.item.SirccillunItem;
...
public class SirccillunOreBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:sirccillun_ore")
	public static final Block block = null;
	public SirccillunOreBlock(SotmModElements instance) {
		super(instance, 1712);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sirccillun_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SirccillunItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:sirccillun_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("sirccillun_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:sirccillun_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
