...
public class YellowMushroomShellBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:yellow_mushroom_shell")
	public static final Block block = null;
	public YellowMushroomShellBlock(SotmModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom_shell");
		}
