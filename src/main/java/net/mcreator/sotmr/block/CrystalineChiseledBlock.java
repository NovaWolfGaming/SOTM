...
public class CrystalineChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crystalinechiseled")
	public static final Block block = null;
	public CrystalineChiseledBlock(SotmModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystalinechiseled");
		}
