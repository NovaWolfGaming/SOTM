...
public class RoseQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:rose_quartz_bricks")
	public static final Block block = null;
	public RoseQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2004);
	}
