...
public class ChorusStoneBrickSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chorus_stone_brick_slab")
	public static final Block block = null;
	public ChorusStoneBrickSlabBlock(SotmModElements instance) {
		super(instance, 1378);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chorus_stone_brick_slab");
		}
