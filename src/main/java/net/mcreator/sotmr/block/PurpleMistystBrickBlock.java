...
public class PurpleMistystBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_brick")
	public static final Block block = null;
	public PurpleMistystBrickBlock(SotmModElements instance) {
		super(instance, 537);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_brick");
		}
