...
public class LightOakTrapdoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:light_oak_trapdoor")
	public static final Block block = null;
	public LightOakTrapdoorBlock(SotmModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("light_oak_trapdoor");
		}
