...
public class CyanRose2Block extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cyan_rose_2")
	public static final Block block = null;
	public CyanRose2Block(SotmModElements instance) {
		super(instance, 1867);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cyan_rose_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:cyan_rose_2"), configuredFeature);
		}
	}
	@SubscribeEvent
