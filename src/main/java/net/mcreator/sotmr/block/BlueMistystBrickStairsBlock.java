...
public class BlueMistystBrickStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_mistyst_brick_stairs")
	public static final Block block = null;
	public BlueMistystBrickStairsBlock(SotmModElements instance) {
		super(instance, 2686);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_mistyst_brick_stairs");
		}
