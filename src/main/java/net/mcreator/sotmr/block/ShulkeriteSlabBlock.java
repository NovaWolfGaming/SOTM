...
public class ShulkeriteSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:shulkeriteslab")
	public static final Block block = null;
	public ShulkeriteSlabBlock(SotmModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("shulkeriteslab");
		}
