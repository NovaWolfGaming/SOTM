...
public class NetherstoneChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:netherstone_chiseled")
	public static final Block block = null;
	public NetherstoneChiseledBlock(SotmModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("netherstone_chiseled");
		}
