...
public class CarbonSmoothedSandstoneBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carbon_smoothed_sandstone")
	public static final Block block = null;
	public CarbonSmoothedSandstoneBlock(SotmModElements instance) {
		super(instance, 290);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carbon_smoothed_sandstone");
		}
