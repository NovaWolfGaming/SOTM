...
public class FuriteChiseledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:furitechiseled")
	public static final Block block = null;
	public FuriteChiseledBlock(SotmModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("furitechiseled");
		}
