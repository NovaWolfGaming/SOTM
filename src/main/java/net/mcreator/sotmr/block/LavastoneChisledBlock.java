...
public class LavastoneChisledBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lavastone_chisled")
	public static final Block block = null;
	public LavastoneChisledBlock(SotmModElements instance) {
		super(instance, 519);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lavastone_chisled");
		}
