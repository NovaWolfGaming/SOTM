...
public class MarbleYellowStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow_stairs")
	public static final Block block = null;
	public MarbleYellowStairsBlock(SotmModElements instance) {
		super(instance, 2380);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_yellow_stairs");
		}
