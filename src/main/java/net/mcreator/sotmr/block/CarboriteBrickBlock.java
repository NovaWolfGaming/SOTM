...
public class CarboriteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:carboritebrick")
	public static final Block block = null;
	public CarboriteBrickBlock(SotmModElements instance) {
		super(instance, 489);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carboritebrick");
		}
