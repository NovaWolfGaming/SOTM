...
public class BrownCrolphinBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:brown_crolphin")
	public static final Block block = null;
	public BrownCrolphinBlock(SotmModElements instance) {
		super(instance, 2257);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brown_crolphin");
		}
