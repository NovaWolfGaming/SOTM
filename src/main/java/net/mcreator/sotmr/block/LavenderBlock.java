...
public class LavenderBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:lavender")
	public static final Block block = null;
	public LavenderBlock(SotmModElements instance) {
		super(instance, 1792);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lavender"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:lavender"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("sotm:lavender_fields").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
