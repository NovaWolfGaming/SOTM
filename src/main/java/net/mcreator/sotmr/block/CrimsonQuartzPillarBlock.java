...
public class CrimsonQuartzPillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:crimson_quartz_pillar")
	public static final Block block = null;
	public CrimsonQuartzPillarBlock(SotmModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crimson_quartz_pillar");
		}
