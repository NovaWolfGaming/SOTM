...
public class BlackstoneBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstonebrick")
	public static final Block block = null;
	public BlackstoneBrickBlock(SotmModElements instance) {
		super(instance, 497);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blackstonebrick");
		}
