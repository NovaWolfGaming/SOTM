...
public class BambooPlanksSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:bamboo_planks_slab")
	public static final Block block = null;
	public BambooPlanksSlabBlock(SotmModElements instance) {
		super(instance, 1676);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_planks_slab");
		}
