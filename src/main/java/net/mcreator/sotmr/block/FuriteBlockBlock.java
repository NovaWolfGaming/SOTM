...
public class FuriteBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:furiteblock")
	public static final Block block = null;
	public FuriteBlockBlock(SotmModElements instance) {
		super(instance, 75);
	}
