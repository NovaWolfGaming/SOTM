...
public class MossyMushroomBlackPlanksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:mossy_mushroom_black_planks")
	public static final Block block = null;

	public MossyMushroomBlackPlanksBlock(SotmModElements instance) {
		super(instance, 2645);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mossy_mushroom_black_planks");
		}
