...
public class GlowingObsidianBlock extends SotmModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.15f, 15.5f).setLightLevel(s -> 0)
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 3; ++l) {
					...
					world.addParticle(RedGlowingOrParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 6)).range(64).square().func_242731_b(12));
	}
}
