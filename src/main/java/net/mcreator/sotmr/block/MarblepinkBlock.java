...
public class MarblepinkBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marblepink")
	public static final Block block = null;
	public MarblepinkBlock(SotmModElements instance) {
		super(instance, 2361);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marblepink_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marblepink"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marblepink"), configuredFeature);
		}
	}
	@SubscribeEvent
