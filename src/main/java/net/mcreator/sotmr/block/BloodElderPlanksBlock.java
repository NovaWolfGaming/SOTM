...
public class BloodElderPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blood_elder_planks")
	public static final Block block = null;
	public BloodElderPlanksBlock(SotmModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blood_elder_planks");
		}
