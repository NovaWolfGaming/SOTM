...
public class MarbleLimeSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_lime_slab")
	public static final Block block = null;
	public MarbleLimeSlabBlock(SotmModElements instance) {
		super(instance, 2479);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_lime_slab");
		}
