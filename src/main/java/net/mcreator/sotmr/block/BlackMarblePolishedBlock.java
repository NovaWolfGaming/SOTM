...
public class BlackMarblePolishedBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_marble_polished")
	public static final Block block = null;
	public BlackMarblePolishedBlock(SotmModElements instance) {
		super(instance, 547);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_marble_polished");
		}
