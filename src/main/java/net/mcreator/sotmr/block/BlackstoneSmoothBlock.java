...
public class BlackstoneSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blackstonesmooth")
	public static final Block block = null;
	public BlackstoneSmoothBlock(SotmModElements instance) {
		super(instance, 496);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blackstonesmooth");
		}
