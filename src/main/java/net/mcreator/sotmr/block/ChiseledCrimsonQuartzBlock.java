...
public class ChiseledCrimsonQuartzBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chiseled_crimson_quartz")
	public static final Block block = null;
	public ChiseledCrimsonQuartzBlock(SotmModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_crimson_quartz");
		}
