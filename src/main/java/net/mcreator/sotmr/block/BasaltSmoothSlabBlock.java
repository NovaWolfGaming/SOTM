...
public class BasaltSmoothSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:basaltsmoothslab")
	public static final Block block = null;
	public BasaltSmoothSlabBlock(SotmModElements instance) {
		super(instance, 493);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("basaltsmoothslab");
		}
