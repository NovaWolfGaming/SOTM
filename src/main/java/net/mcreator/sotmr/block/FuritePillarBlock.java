...
public class FuritePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:furitepillar")
	public static final Block block = null;
	public FuritePillarBlock(SotmModElements instance) {
		super(instance, 77);
	}
