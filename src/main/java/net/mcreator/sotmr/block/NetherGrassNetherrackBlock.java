...
public class NetherGrassNetherrackBlock extends SotmModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(Blocks.CRIMSON_NYLIUM.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 32)).range(255).square().func_242731_b(32));
	}
}
