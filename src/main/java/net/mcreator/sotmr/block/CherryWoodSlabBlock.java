...
public class CherryWoodSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cherry_wood_slab")
	public static final Block block = null;
	public CherryWoodSlabBlock(SotmModElements instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cherry_wood_slab");
		}
