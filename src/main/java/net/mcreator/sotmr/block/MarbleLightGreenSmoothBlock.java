...
public class MarbleLightGreenSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green_smooth")
	public static final Block block = null;
	public MarbleLightGreenSmoothBlock(SotmModElements instance) {
		super(instance, 2461);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_green_smooth");
		}
