...
public class GreenChalkBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_chalk_brick")
	public static final Block block = null;
	public GreenChalkBrickBlock(SotmModElements instance) {
		super(instance, 1806);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_chalk_brick");
		}
