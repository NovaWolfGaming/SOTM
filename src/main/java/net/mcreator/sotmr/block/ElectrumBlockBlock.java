...
public class ElectrumBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:electrum_block")
	public static final Block block = null;
	public ElectrumBlockBlock(SotmModElements instance) {
		super(instance, 1940);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("electrum_block");
		}
