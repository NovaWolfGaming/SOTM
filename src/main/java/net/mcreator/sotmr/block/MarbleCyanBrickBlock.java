...
public class MarbleCyanBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_cyan_brick")
	public static final Block block = null;
	public MarbleCyanBrickBlock(SotmModElements instance) {
		super(instance, 2392);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_cyan_brick");
		}
