...
public class BlueShulkeriteBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_shulkerite_brick")
	public static final Block block = null;
	public BlueShulkeriteBrickBlock(SotmModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_shulkerite_brick");
		}
