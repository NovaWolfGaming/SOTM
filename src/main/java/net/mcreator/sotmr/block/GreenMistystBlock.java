...
public class GreenMistystBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_mistyst")
	public static final Block block = null;
	public GreenMistystBlock(SotmModElements instance) {
		super(instance, 532);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:green_mistyst_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("green_mistyst"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:green_mistyst"), configuredFeature);
		}
	}
	@SubscribeEvent
