...
public class VenorumQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venorum_quartz_bricks")
	public static final Block block = null;
	public VenorumQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2012);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("venorum_quartz_bricks");
		}
