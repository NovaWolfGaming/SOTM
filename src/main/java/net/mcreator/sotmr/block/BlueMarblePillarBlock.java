...
public class BlueMarblePillarBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:blue_marble_pillar")
	public static final Block block = null;
	public BlueMarblePillarBlock(SotmModElements instance) {
		super(instance, 1467);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_marble_pillar");
		}
