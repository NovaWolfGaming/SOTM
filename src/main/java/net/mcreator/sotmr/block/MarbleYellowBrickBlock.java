...
public class MarbleYellowBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_yellow_brick")
	public static final Block block = null;
	public MarbleYellowBrickBlock(SotmModElements instance) {
		super(instance, 2378);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_yellow_brick");
		}
