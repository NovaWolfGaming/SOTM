...
public class SmoothGreenMarbleBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:smooth_green_marble")
	public static final Block block = null;
	public SmoothGreenMarbleBlock(SotmModElements instance) {
		super(instance, 556);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_green_marble");
		}
