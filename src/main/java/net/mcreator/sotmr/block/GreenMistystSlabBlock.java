...
public class GreenMistystSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:green_mistyst_slab")
	public static final Block block = null;
	public GreenMistystSlabBlock(SotmModElements instance) {
		super(instance, 535);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("green_mistyst_slab");
		}
