...
public class SilverPanelBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:silver_panel_block")
	public static final Block block = null;
	public SilverPanelBlockBlock(SotmModElements instance) {
		super(instance, 1561);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("silver_panel_block");
		}
