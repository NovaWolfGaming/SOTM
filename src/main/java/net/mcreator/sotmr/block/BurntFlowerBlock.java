...
public class BurntFlowerBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:burnt_flower")
	public static final Block block = null;
	public BurntFlowerBlock(SotmModElements instance) {
		super(instance, 261);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("burnt_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:burnt_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
