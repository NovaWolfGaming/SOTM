...
public class TwistedMapleDoorBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:twisted_maple_door")
	public static final Block block = null;
	public TwistedMapleDoorBlock(SotmModElements instance) {
		super(instance, 470);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("twisted_maple_door");
		}
