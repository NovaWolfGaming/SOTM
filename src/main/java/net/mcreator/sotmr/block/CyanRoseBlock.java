...
public class CyanRoseBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:cyan_rose")
	public static final Block block = null;
	public CyanRoseBlock(SotmModElements instance) {
		super(instance, 265);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cyan_rose"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:cyan_rose"), configuredFeature);
		}
	}
	@SubscribeEvent
