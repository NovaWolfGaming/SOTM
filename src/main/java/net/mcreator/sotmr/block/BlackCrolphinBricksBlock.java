...
public class BlackCrolphinBricksBlock extends SotmModElements.ModElement {

	@ObjectHolder("sotm:black_crolphin_bricks")
	public static final Block block = null;

	public BlackCrolphinBricksBlock(SotmModElements instance) {
		super(instance, 2297);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_crolphin_bricks");
		}
