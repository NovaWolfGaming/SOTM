...
public class MarbleDarkGrayStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_dark_gray_stairs")
	public static final Block block = null;
	public MarbleDarkGrayStairsBlock(SotmModElements instance) {
		super(instance, 2492);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_dark_gray_stairs");
		}
