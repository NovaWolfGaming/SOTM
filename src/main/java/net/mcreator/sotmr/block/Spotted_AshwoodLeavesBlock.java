...
public class Spotted_AshwoodLeavesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:spotted_ashwood_leaves")
	public static final Block block = null;
	public Spotted_AshwoodLeavesBlock(SotmModElements instance) {
		super(instance, 1415);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spotted_ashwood_leaves");
		}
