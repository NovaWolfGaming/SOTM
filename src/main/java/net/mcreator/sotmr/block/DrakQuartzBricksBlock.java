...
public class DrakQuartzBricksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:drak_quartz_bricks")
	public static final Block block = null;
	public DrakQuartzBricksBlock(SotmModElements instance) {
		super(instance, 2000);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("drak_quartz_bricks");
		}
