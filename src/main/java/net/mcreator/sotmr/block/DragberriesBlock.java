...
import net.mcreator.sotmr.item.DregberriesItem;
...
public class DragberriesBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:dragberries")
	public static final Block block = null;
	public DragberriesBlock(SotmModElements instance) {
		super(instance, 1849);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dragberries"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:dragberries"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DregberriesItem.block, (int) (2)));
		}
