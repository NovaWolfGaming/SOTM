...
public class VenomiteOreOreBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:venomite_ore_ore_block")
	public static final Block block = null;
	public VenomiteOreOreBlockBlock(SotmModElements instance) {
		super(instance, 469);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("venomite_ore_ore_block");
		}
