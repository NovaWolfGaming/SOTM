...
public class DarkQuartzSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:darkquartzslab")
	public static final Block block = null;
	public DarkQuartzSlabBlock(SotmModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("darkquartzslab");
		}
