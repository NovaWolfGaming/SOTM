...
public class AmberQuartzBlockBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:amber_quartz_block")
	public static final Block block = null;
	public AmberQuartzBlockBlock(SotmModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amber_quartz_block");
		}
