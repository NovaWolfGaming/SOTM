...
public class PinkStarClusterBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:pink_star_cluster")
	public static final Block block = null;
	public PinkStarClusterBlock(SotmModElements instance) {
		super(instance, 1877);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pink_star_cluster"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:pink_star_cluster"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("pink_star_cluster");
		}
