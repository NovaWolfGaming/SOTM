...
public class ChippedWarpedPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:chipped_warped_planks")
	public static final Block block = null;
	public ChippedWarpedPlanksBlock(SotmModElements instance) {
		super(instance, 2619);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chipped_warped_planks");
		}
