...
public class CertusStairsBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:certusstairs")
	public static final Block block = null;
	public CertusStairsBlock(SotmModElements instance) {
		super(instance, 486);
	}
