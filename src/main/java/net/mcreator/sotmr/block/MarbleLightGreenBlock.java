...
public class MarbleLightGreenBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_green")
	public static final Block block = null;
	public MarbleLightGreenBlock(SotmModElements instance) {
		super(instance, 2459);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_light_green");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sotm:marble_light_green_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble_light_green"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:marble_light_green"), configuredFeature);
		}
	}
	@SubscribeEvent
