...
import net.mcreator.sotmr.item.MushroomblackitemItem;
...
public class BlackMushroomBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:black_mushroom")
	public static final Block block = null;
	public BlackMushroomBlock(SotmModElements instance) {
		super(instance, 270);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("black_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:black_mushroom"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("black_mushroom");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MushroomblackitemItem.block, (int) (1)));
		}
