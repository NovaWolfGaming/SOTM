...
public class OrangeMarbleSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:orange_marble_slab")
	public static final Block block = null;
	public OrangeMarbleSlabBlock(SotmModElements instance) {
		super(instance, 1488);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_marble_slab");
		}
