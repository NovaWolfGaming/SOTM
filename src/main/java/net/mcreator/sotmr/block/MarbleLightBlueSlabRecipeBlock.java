...
public class MarbleLightBlueSlabRecipeBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:marble_light_blue_slab_recipe")
	public static final Block block = null;
	public MarbleLightBlueSlabRecipeBlock(SotmModElements instance) {
		super(instance, 2437);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_light_blue_slab_recipe");
		}
