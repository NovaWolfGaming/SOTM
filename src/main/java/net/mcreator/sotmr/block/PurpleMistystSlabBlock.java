...
public class PurpleMistystSlabBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:purple_mistyst_slab")
	public static final Block block = null;
	public PurpleMistystSlabBlock(SotmModElements instance) {
		super(instance, 539);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_mistyst_slab");
		}
