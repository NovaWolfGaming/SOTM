...
public class MossyBambooPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:mossy_bamboo_planks")
	public static final Block block = null;
	public MossyBambooPlanksBlock(SotmModElements instance) {
		super(instance, 2657);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_bamboo_planks");
		}
