...
import net.mcreator.sotmr.item.FourLeafCloverItemItem;
...
public class FourLeafCloverBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:four_leaf_clover")
	public static final Block block = null;
	public FourLeafCloverBlock(SotmModElements instance) {
		super(instance, 321);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("four_leaf_clover"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:four_leaf_clover"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("four_leaf_clover");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FourLeafCloverItemItem.block, (int) (1)));
		}
