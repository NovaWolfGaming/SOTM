...
public class UaphreliaPlanksBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:uaphreliaplanks")
	public static final Block block = null;
	public UaphreliaPlanksBlock(SotmModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uaphreliaplanks");
		}
