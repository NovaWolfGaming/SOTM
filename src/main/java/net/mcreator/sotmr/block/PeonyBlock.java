...
public class PeonyBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:peony")
	public static final Block block = null;
	public PeonyBlock(SotmModElements instance) {
		super(instance, 1762);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("peony"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sotm:peony"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("sotm:peony_fields").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
