...
public class FrostedRockBrickBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:frosted_rock_brick")
	public static final Block block = null;
	public FrostedRockBrickBlock(SotmModElements instance) {
		super(instance, 550);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frosted_rock_brick");
		}
