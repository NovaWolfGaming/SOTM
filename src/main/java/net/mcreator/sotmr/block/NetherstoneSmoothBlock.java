...
public class NetherstoneSmoothBlock extends SotmModElements.ModElement {
	@ObjectHolder("sotm:netherstone_smooth")
	public static final Block block = null;
	public NetherstoneSmoothBlock(SotmModElements instance) {
		super(instance, 515);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("netherstone_smooth");
		}
